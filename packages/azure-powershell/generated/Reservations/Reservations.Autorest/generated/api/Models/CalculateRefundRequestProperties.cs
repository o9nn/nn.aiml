...
namespace Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models
{
    ...
    public partial class CalculateRefundRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal
    {

        /// <summary>Internal Acessors for ReservationToReturn</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ICalculateRefundRequestPropertiesInternal.ReservationToReturn { get => (this._reservationToReturn = this._reservationToReturn ?? new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ReservationToReturn()); set { {_reservationToReturn = value;} } }

        /// <summary>Backing field for <see cref="ReservationToReturn" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn _reservationToReturn;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturn ReservationToReturn { get => (this._reservationToReturn = this._reservationToReturn ?? new Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.ReservationToReturn()); set => this._reservationToReturn = value; }
        ...
        public int? ReservationToReturnQuantity { get => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturnInternal)ReservationToReturn).Quantity; set => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturnInternal)ReservationToReturn).Quantity = value ?? default(int); }

        /// <summary>Fully qualified identifier of the reservation being returned</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Reservations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Reservations.PropertyOrigin.Inlined)]
        public string ReservationToReturnReservationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturnInternal)ReservationToReturn).ReservationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Reservations.Models.IReservationToReturnInternal)ReservationToReturn).ReservationId = value ?? null; }
