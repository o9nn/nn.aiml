...
{
    using Microsoft.Azure.PowerShell.Cmdlets.Reservations.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.Reservations" : @"";
