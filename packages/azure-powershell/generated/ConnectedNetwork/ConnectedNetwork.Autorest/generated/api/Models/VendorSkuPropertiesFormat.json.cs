...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models
{
    ...
    public partial class VendorSkuPropertiesFormat
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorSkuPropertiesFormat.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorSkuPropertiesFormat.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.IVendorSkuPropertiesFormat FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonNode node)
        {
        ...
        internal VendorSkuPropertiesFormat(Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonObject json)
        {
            ...
            {_networkFunctionTemplate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonObject>("networkFunctionTemplate"), out var __jsonNetworkFunctionTemplate) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.NetworkFunctionTemplate.FromJson(__jsonNetworkFunctionTemplate) : _networkFunctionTemplate;}
            ...
            {_deploymentMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonString>("deploymentMode"), out var __jsonDeploymentMode) ? (string)__jsonDeploymentMode : (string)_deploymentMode;}
            {_networkFunctionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonString>("networkFunctionType"), out var __jsonNetworkFunctionType) ? (string)__jsonNetworkFunctionType : (string)_networkFunctionType;}
            {_preview = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonBoolean>("preview"), out var __jsonPreview) ? (bool?)__jsonPreview : _preview;}
            {_managedApplicationParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonObject>("managedApplicationParameters"), out var __jsonManagedApplicationParameters) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.VendorSkuPropertiesFormatManagedApplicationParameters.FromJson(__jsonManagedApplicationParameters) : _managedApplicationParameter;}
            {_managedApplicationTemplate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Runtime.Json.JsonObject>("managedApplicationTemplate"), out var __jsonManagedApplicationTemplate) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedNetwork.Models.VendorSkuPropertiesFormatManagedApplicationTemplate.FromJson(__jsonManagedApplicationTemplate) : _managedApplicationTemplate;}
            AfterFromJson(json);
        }
    }
}