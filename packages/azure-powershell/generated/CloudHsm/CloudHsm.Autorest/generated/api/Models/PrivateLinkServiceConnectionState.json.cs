...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models
{
    ...
    public partial class PrivateLinkServiceConnectionState
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IPrivateLinkServiceConnectionState.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IPrivateLinkServiceConnectionState.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Models.IPrivateLinkServiceConnectionState FromJson(Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject json ? new PrivateLinkServiceConnectionState(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject into a new instance of <see cref="PrivateLinkServiceConnectionState" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PrivateLinkServiceConnectionState(Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject json)
        {
            ...
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonString>("description"), out var __jsonDescription) ? (string)__jsonDescription : (string)_description;}
            {_actionsRequired = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonString>("actionsRequired"), out var __jsonActionsRequired) ? (string)__jsonActionsRequired : (string)_actionsRequired;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PrivateLinkServiceConnectionState" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PrivateLinkServiceConnectionState" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._description)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonString(this._description.ToString()) : null, "description" ,container.Add );
            AddIf( null != (((object)this._actionsRequired)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CloudHsm.Runtime.Json.JsonString(this._actionsRequired.ToString()) : null, "actionsRequired" ,container.Add );
