...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
    ...
    public partial class Disk
    {
        ...
        internal Disk(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject json)
        {
            ...
            {_sizeGb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNumber>("diskSizeGB"), out var __jsonDiskSizeGb) ? (int?)__jsonDiskSizeGb : _sizeGb;}
            {_lun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNumber>("lun"), out var __jsonLun) ? (int?)__jsonLun : _lun;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisk.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IDisk.</returns>
