...
namespace Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models
{
    ...
    public partial class Result
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IResult.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Models.IResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode node)
        {
        ...
        internal Result(Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonObject json)
        {
            ...
            {_sampleProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonString>("sampleProperty"), out var __jsonSampleProperty) ? (string)__jsonSampleProperty : (string)_sampleProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Result" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Result" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BareMetal.Runtime.Json.JsonNode" />.
        /// </returns>
