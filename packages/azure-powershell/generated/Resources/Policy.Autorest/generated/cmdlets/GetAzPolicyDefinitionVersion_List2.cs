...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyDefinitionVersion_List2")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation retrieves a list of all the policy definition versions for the given policy definition.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policyDefinitions/{policyDefinitionName}/versions", ApiVersion = "2023-04-01")]
    public partial class GetAzPolicyDefinitionVersion_List2 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPolicyDefinitionVersion_List2" /> cmdlet class.
        /// </summary>
        public GetAzPolicyDefinitionVersion_List2()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PolicyDefinitionVersionsList(SubscriptionId, PolicyDefinitionName, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicyDefinitionVersionsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
