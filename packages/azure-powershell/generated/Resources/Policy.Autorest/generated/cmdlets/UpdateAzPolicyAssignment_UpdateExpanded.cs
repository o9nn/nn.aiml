...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
    ...
    /// <summary>
    /// This operation update the policy assignment with the given ID. Policy assignments made on a scope apply to all resources
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetById=>GET:"/{policyAssignmentId}"
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Policy.Description(@"This operation update the policy assignment with the given ID. Policy assignments made on a scope apply to all resources contained in that scope. For example, when you assign a policy to a resource group that policy applies to all resources in the group. Policy assignment IDs have this format: '{scope}/providers/Microsoft.Authorization/policyAssignments/{policyAssignmentName}'. Valid scopes are: management group (format: '/providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: '/subscriptions/{subscriptionId}'), resource group (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}', or resource (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/[{parentResourcePath}/]{resourceType}/{resourceName}'.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzPolicyAssignment_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzPolicyAssignment_UpdateExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EnforcementMode")))
            {
                this.EnforcementMode = (string)(this.MyInvocation?.BoundParameters["EnforcementMode"]);
            }
            ...
            {
                this.NotScope = (string[])(this.MyInvocation?.BoundParameters["NotScope"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ParameterTable")))
            {
                this.ParameterTable = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IParameterValues)(this.MyInvocation?.BoundParameters["ParameterTable"]);
            }
            ...
            {
                this.MetadataTable = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IPolicyAssignmentPropertiesMetadata)(this.MyInvocation?.BoundParameters["MetadataTable"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("NonComplianceMessageTable")))
            {
                this.NonComplianceMessageTable = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.INonComplianceMessage[])(this.MyInvocation?.BoundParameters["NonComplianceMessageTable"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ResourceSelector")))
            {
                this.ResourceSelector = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IResourceSelector[])(this.MyInvocation?.BoundParameters["ResourceSelector"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Override")))
            {
                this.Override = (Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.IOverride[])(this.MyInvocation?.BoundParameters["Override"]);
            }
        }
