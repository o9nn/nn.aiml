...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class RunCommandManagedIdentity
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IRunCommandManagedIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IRunCommandManagedIdentity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IRunCommandManagedIdentity FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json ? new RunCommandManagedIdentity(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject into a new instance of <see cref="RunCommandManagedIdentity" />.
        /// </summary>
        ...
        internal RunCommandManagedIdentity(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json)
        {
            ...
            {_clientId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonString>("clientId"), out var __jsonClientId) ? (string)__jsonClientId : (string)_clientId;}
            {_objectId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonString>("objectId"), out var __jsonObjectId) ? (string)__jsonObjectId : (string)_objectId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RunCommandManagedIdentity" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RunCommandManagedIdentity" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._clientId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonString(this._clientId.ToString()) : null, "clientId" ,container.Add );
            AddIf( null != (((object)this._objectId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonString(this._objectId.ToString()) : null, "objectId" ,container.Add );
