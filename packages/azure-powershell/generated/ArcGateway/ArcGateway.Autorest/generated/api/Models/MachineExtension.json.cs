...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class MachineExtension
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IMachineExtension.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IMachineExtension.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.IMachineExtension FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json ? new MachineExtension(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject into a new instance of <see cref="MachineExtension" />.
        /// </summary>
        ...
        internal MachineExtension(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.MachineExtensionProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MachineExtension" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MachineExtension" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </returns>
