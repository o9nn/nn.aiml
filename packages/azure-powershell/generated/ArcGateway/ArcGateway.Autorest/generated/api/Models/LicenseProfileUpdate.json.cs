...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class LicenseProfileUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicenseProfileUpdate.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicenseProfileUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicenseProfileUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json ? new LicenseProfileUpdate(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject into a new instance of <see cref="LicenseProfileUpdate" />.
        /// </summary>
        ...
        internal LicenseProfileUpdate(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.LicenseProfileUpdateProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LicenseProfileUpdate" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LicenseProfileUpdate" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </returns>
