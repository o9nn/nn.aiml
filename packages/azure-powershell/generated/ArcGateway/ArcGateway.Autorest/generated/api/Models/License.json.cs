...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models
{
    ...
    public partial class License
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicense.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicense.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.ILicense FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json ? new License(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject into a new instance of <see cref="License" />.
        /// </summary>
        ...
        internal License(Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Models.LicenseProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="License" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="License" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcGateway.Runtime.Json.JsonNode" />.
        /// </returns>
