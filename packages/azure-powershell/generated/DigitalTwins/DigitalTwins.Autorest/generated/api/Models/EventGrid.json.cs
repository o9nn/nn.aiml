...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models
{
    ...
    public partial class EventGrid
    {
        ...
        internal EventGrid(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonObject json)
        {
            ...
            {_topicEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonString>("TopicEndpoint"), out var __jsonTopicEndpoint) ? (string)__jsonTopicEndpoint : (string)_topicEndpoint;}
            {_accessKey1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonString>("accessKey1"), out var __jsonAccessKey1) ? (string)__jsonAccessKey1 : (string)_accessKey1;}
            {_accessKey2 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonString>("accessKey2"), out var __jsonAccessKey2) ? (string)__jsonAccessKey2 : (string)_accessKey2;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IEventGrid.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IEventGrid.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.IEventGrid FromJson(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Json.JsonNode node)
        {
