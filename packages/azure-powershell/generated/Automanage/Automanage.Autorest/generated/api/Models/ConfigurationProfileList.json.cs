...
namespace Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models
{
    ...
    public partial class ConfigurationProfileList
    {
        ...
        internal ConfigurationProfileList(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.IConfigurationProfile>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.IConfigurationProfile) (Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.ConfigurationProfile.FromJson(__u) )) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.IConfigurationProfileList.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.IConfigurationProfileList.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.IConfigurationProfileList FromJson(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode node)
        {
