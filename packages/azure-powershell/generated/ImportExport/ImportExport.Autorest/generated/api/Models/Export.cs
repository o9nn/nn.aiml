...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models
{
    ...
    public partial class Export :
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExport,
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportInternal
    {

        /// <summary>Backing field for <see cref="BlobList" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobList _blobList;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobList BlobList { get => (this._blobList = this._blobList ?? new Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.ExportBlobList()); set => this._blobList = value; }
        ...
        public System.Collections.Generic.List<string> BlobListBlobPathPrefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobListInternal)BlobList).BlobPathPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobListInternal)BlobList).BlobPathPrefix = value ?? null /* arrayOf */; }

        /// <summary>A collection of blob-path strings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImportExport.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> BlobPath { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobListInternal)BlobList).BlobPath; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobListInternal)BlobList).BlobPath = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for BlobList</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobList Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportInternal.BlobList { get => (this._blobList = this._blobList ?? new Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.ExportBlobList()); set { {_blobList = value;} } }
    ...
    {
        /// <summary>A list of the blobs to be exported.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImportExport.Models.IExportBlobList BlobList { get; set; }
        /// <summary>
        /// The relative URI to the block blob that contains the list of blob paths or blob path prefixes as defined above, beginning
        /// with the container name. If the blob is in root container, the URI must begin with $root.
        /// </summary>
