...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dns.Models
{
    ...
    public partial class DnsResourceReferenceRequest
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject into a new instance of <see cref="DnsResourceReferenceRequest" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal DnsResourceReferenceRequest(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.DnsResourceReferenceRequestProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDnsResourceReferenceRequest.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDnsResourceReferenceRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dns.Models.IDnsResourceReferenceRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonObject json ? new DnsResourceReferenceRequest(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DnsResourceReferenceRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DnsResourceReferenceRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dns.Runtime.Json.JsonNode" />.
        /// </returns>
