...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class PeeringSku
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringSku.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringSku.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IPeeringSku FromJson(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject json ? new PeeringSku(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject into a new instance of <see cref="PeeringSku" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PeeringSku(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject json)
        {
            ...
            {_tier = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("tier"), out var __jsonTier) ? (string)__jsonTier : (string)_tier;}
            {_family = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("family"), out var __jsonFamily) ? (string)__jsonFamily : (string)_family;}
            {_size = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString>("size"), out var __jsonSize) ? (string)__jsonSize : (string)_size;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PeeringSku" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PeeringSku" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._tier)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString(this._tier.ToString()) : null, "tier" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._family)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString(this._family.ToString()) : null, "family" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._size)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonString(this._size.ToString()) : null, "size" ,container.Add );
            }
