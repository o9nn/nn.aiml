...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class OperationDisplayInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfoInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfoInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfoInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfoInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.IOperationDisplayInfoInternal.Resource { get => this._resource; set { {_resource = value;} } }
