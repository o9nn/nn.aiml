...
namespace Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListDownloadUri=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations/{name}/images/{imageName}/listDownloadUri"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDisconnectedOperationsImageDownloadUri_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Description(@"Get the URI to download the image.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/disconnectedOperations/{name}/images/{imageName}/listDownloadUri", ApiVersion = "2025-06-01-preview")]
    public partial class GetAzDisconnectedOperationsImageDownloadUri_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult">Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDisconnectedOperationsImageDownloadUri_List" /> cmdlet class.
        /// </summary>
        public GetAzDisconnectedOperationsImageDownloadUri_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ImagesListDownloadUri' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ImagesListDownloadUri(SubscriptionId, ResourceGroupName, Name, ImageName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,ImageName=ImageName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DisconnectedOperations.Models.IImageDownloadResult
