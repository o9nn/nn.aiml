...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Description(@"List all traffic filters associated with your Elastic monitor resource, helping you manage network traffic control.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Elastic.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/listAssociatedTrafficFilters", ApiVersion = "2025-06-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse">Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzElasticListAssociatedTrafficFilter_List" /> cmdlet class.
        /// </summary>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticTrafficFilterResponse
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / rulesets / <none>
                if (null != result.Ruleset)
                {
                    if (0 == _responseSize && 1 == result.Ruleset.Count)
                    {
                        _firstResponse = result.Ruleset[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.Ruleset )
                        {
