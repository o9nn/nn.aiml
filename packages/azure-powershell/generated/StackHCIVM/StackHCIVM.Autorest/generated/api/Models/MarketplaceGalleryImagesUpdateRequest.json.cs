...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models
{
    ...
    public partial class MarketplaceGalleryImagesUpdateRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.IMarketplaceGalleryImagesUpdateRequest.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.IMarketplaceGalleryImagesUpdateRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.IMarketplaceGalleryImagesUpdateRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonObject json ? new MarketplaceGalleryImagesUpdateRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonObject into a new instance of <see cref="MarketplaceGalleryImagesUpdateRequest" />.
        /// </summary>
        ...
        internal MarketplaceGalleryImagesUpdateRequest(Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonObject json)
        {
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Models.MarketplaceGalleryImagesUpdateRequestTags.FromJson(__jsonTags) : _tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MarketplaceGalleryImagesUpdateRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MarketplaceGalleryImagesUpdateRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.Json.JsonNode" />.
        /// </returns>
