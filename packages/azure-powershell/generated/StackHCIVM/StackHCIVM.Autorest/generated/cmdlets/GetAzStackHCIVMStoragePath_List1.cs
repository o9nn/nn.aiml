...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/storageContainers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStackHCIVMStoragePath_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Description(@"Lists all of the storage containers in the specified subscription. Use the nextLink property in the response to get the next page of storage containers.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/storageContainers", ApiVersion = "2024-01-01")]
    public partial class GetAzStackHCIVMStoragePath_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHCIVM.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStackHCIVMStoragePath_List1" /> cmdlet class.
        /// </summary>
        public GetAzStackHCIVMStoragePath_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StorageContainersListAll(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.StorageContainersListAll_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
