...
namespace Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models
{
    ...
    public partial class ManagedServiceIdentity
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentity FromJson(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json ? new ManagedServiceIdentity(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject into a new instance of <see cref="ManagedServiceIdentity" />.
        /// </summary>
        ...
        internal ManagedServiceIdentity(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ManagedServiceIdentity" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ManagedServiceIdentity" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._tenantId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonString(this._tenantId.ToString()) : null, "tenantId" ,container.Add );
            }
