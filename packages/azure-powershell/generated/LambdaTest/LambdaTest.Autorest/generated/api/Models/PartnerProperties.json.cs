...
namespace Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models
{
    ...
    public partial class PartnerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IPartnerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IPartnerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IPartnerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json ? new PartnerProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject into a new instance of <see cref="PartnerProperties" />.
        /// </summary>
        ...
        internal PartnerProperties(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json)
        {
            ...
            {_licensesSubscribed = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNumber>("licensesSubscribed"), out var __jsonLicensesSubscribed) ? (int)__jsonLicensesSubscribed : _licensesSubscribed;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PartnerProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PartnerProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNumber(this._licensesSubscribed), "licensesSubscribed" ,container.Add );
