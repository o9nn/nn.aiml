...
.Link
https://learn.microsoft.com/powershell/module/az.lambdatest/get-azlambdatestoperation
#>
function Get-AzLambdaTestOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.LambdaTest.private\Get-AzLambdaTestOperation_List';
        }
