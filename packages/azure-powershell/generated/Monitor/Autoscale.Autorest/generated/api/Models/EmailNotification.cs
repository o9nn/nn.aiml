...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models
{
    ...
    public partial class EmailNotification :
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IEmailNotification,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IEmailNotificationInternal
    {

        /// <summary>Backing field for <see cref="CustomEmail" /> property.</summary>
        private System.Collections.Generic.List<string> _customEmail;
        ...
        public System.Collections.Generic.List<string> CustomEmail { get => this._customEmail; set => this._customEmail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> CustomEmail { get; set; }
        /// <summary>a value indicating whether to send email to subscription administrator.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Info(
        Required = false,
        ReadOnly = false,
