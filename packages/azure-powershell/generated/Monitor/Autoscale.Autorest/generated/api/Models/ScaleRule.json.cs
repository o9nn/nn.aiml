...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models
{
    ...
    public partial class ScaleRule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IScaleRule.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IScaleRule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IScaleRule FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonNode node)
        {
        ...
        internal ScaleRule(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonObject json)
        {
            ...
            {_metricTrigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonObject>("metricTrigger"), out var __jsonMetricTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.MetricTrigger.FromJson(__jsonMetricTrigger) : _metricTrigger;}
            {_scaleAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonObject>("scaleAction"), out var __jsonScaleAction) ? Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.ScaleAction.FromJson(__jsonScaleAction) : _scaleAction;}
            AfterFromJson(json);
        }
