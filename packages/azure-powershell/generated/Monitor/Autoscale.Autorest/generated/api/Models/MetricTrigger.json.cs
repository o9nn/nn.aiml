...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models
{
    ...
    public partial class MetricTrigger
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IMetricTrigger.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IMetricTrigger.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IMetricTrigger FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonNode node)
        {
        ...
        internal MetricTrigger(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonObject json)
        {
            ...
            {_metricNamespace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("metricNamespace"), out var __jsonMetricNamespace) ? (string)__jsonMetricNamespace : (string)_metricNamespace;}
            {_metricResourceUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("metricResourceUri"), out var __jsonMetricResourceUri) ? (string)__jsonMetricResourceUri : (string)_metricResourceUri;}
            {_metricResourceLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("metricResourceLocation"), out var __jsonMetricResourceLocation) ? (string)__jsonMetricResourceLocation : (string)_metricResourceLocation;}
            {_timeGrain = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("timeGrain"), out var __jsonTimeGrain) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonTimeGrain ) : _timeGrain;}
            {_statistic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("statistic"), out var __jsonStatistic) ? (string)__jsonStatistic : (string)_statistic;}
            {_timeWindow = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("timeWindow"), out var __jsonTimeWindow) ? global::System.Xml.XmlConvert.ToTimeSpan( __jsonTimeWindow ) : _timeWindow;}
            {_timeAggregation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonString>("timeAggregation"), out var __jsonTimeAggregation) ? (string)__jsonTimeAggregation : (string)_timeAggregation;}
            ...
            {_threshold = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonNumber>("threshold"), out var __jsonThreshold) ? (double)__jsonThreshold : _threshold;}
            {_dimension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonArray>("dimensions"), out var __jsonDimensions) ? If( __jsonDimensions as Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IScaleRuleMetricDimension>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.IScaleRuleMetricDimension) (Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Models.ScaleRuleMetricDimension.FromJson(__u) )) ))() : null : _dimension;}
            {_dividePerInstance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Autoscale.Runtime.Json.JsonBoolean>("dividePerInstance"), out var __jsonDividePerInstance) ? (bool?)__jsonDividePerInstance : _dividePerInstance;}
            AfterFromJson(json);
        }
