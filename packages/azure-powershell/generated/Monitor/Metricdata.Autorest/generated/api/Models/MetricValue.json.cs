...
namespace Microsoft.Azure.PowerShell.Cmdlets.Metric.Models
{
    ...
    public partial class MetricValue
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IMetricValue.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Metric.Models.IMetricValue.</returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject into a new instance of <see cref="MetricValue" />.
        /// </summary>
        ...
        internal MetricValue(Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonObject json)
        {
            ...
            {_timeStamp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonString>("timeStamp"), out var __jsonTimeStamp) ? global::System.DateTime.TryParse((string)__jsonTimeStamp, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTimeStampValue) ? __jsonTimeStampValue : _timeStamp : _timeStamp;}
            {_average = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNumber>("average"), out var __jsonAverage) ? (double?)__jsonAverage : _average;}
            {_minimum = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNumber>("minimum"), out var __jsonMinimum) ? (double?)__jsonMinimum : _minimum;}
            {_maximum = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNumber>("maximum"), out var __jsonMaximum) ? (double?)__jsonMaximum : _maximum;}
            {_total = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNumber>("total"), out var __jsonTotal) ? (double?)__jsonTotal : _total;}
            {_count = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNumber>("count"), out var __jsonCount) ? (double?)__jsonCount : _count;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MetricValue" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MetricValue" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Metric.Runtime.Json.JsonNode" />.
        /// </returns>
