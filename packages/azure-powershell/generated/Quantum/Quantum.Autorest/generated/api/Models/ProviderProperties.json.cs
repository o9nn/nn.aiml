...
namespace Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models
{
    ...
    public partial class ProviderProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IProviderProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IProviderProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IProviderProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonNode node)
        {
        ...
        internal ProviderProperties(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject json)
        {
            ...
            {_aad = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject>("aad"), out var __jsonAad) ? Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ProviderPropertiesAad.FromJson(__jsonAad) : _aad;}
            {_managedApplication = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonObject>("managedApplication"), out var __jsonManagedApplication) ? Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ProviderPropertiesManagedApplication.FromJson(__jsonManagedApplication) : _managedApplication;}
            ...
            {_providerType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonString>("providerType"), out var __jsonProviderType) ? (string)__jsonProviderType : (string)_providerType;}
            {_company = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonString>("company"), out var __jsonCompany) ? (string)__jsonCompany : (string)_company;}
            {_defaultEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonString>("defaultEndpoint"), out var __jsonDefaultEndpoint) ? (string)__jsonDefaultEndpoint : (string)_defaultEndpoint;}
            {_target = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray>("targets"), out var __jsonTargets) ? If( __jsonTargets as Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ITargetDescription>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ITargetDescription) (Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.TargetDescription.FromJson(__u) )) ))() : null : _target;}
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray>("skus"), out var __jsonSkus) ? If( __jsonSkus as Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ISkuDescription>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.ISkuDescription) (Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.SkuDescription.FromJson(__p) )) ))() : null : _sku;}
            {_quotaDimension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray>("quotaDimensions"), out var __jsonQuotaDimensions) ? If( __jsonQuotaDimensions as Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IQuotaDimension>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IQuotaDimension) (Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.QuotaDimension.FromJson(__k) )) ))() : null : _quotaDimension;}
            {_pricingDimension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray>("pricingDimensions"), out var __jsonPricingDimensions) ? If( __jsonPricingDimensions as Microsoft.Azure.PowerShell.Cmdlets.Quantum.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IPricingDimension>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.IPricingDimension) (Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.PricingDimension.FromJson(__f) )) ))() : null : _pricingDimension;}
            AfterFromJson(json);
        }
