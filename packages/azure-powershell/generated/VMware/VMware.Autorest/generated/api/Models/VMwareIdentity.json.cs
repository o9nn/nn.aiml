...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class VMwareIdentity
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._hostId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._hostId.ToString()) : null, "hostId" ,container.Add );
            ...
            AddIf( null != (((object)this._provisionedNetworkName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._provisionedNetworkName.ToString()) : null, "provisionedNetworkName" ,container.Add );
            AddIf( null != (((object)this._storagePolicyName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString(this._storagePolicyName.ToString()) : null, "storagePolicyName" ,container.Add );
        ...
        internal VMwareIdentity(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
            ...
            {_hostId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("hostId"), out var __jsonHostId) ? (string)__jsonHostId : (string)_hostId;}
            ...
            {_provisionedNetworkName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("provisionedNetworkName"), out var __jsonProvisionedNetworkName) ? (string)__jsonProvisionedNetworkName : (string)_provisionedNetworkName;}
            {_storagePolicyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("storagePolicyName"), out var __jsonStoragePolicyName) ? (string)__jsonStoragePolicyName : (string)_storagePolicyName;}
