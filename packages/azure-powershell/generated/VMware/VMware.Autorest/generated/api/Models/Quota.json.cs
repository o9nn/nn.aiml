...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class Quota
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IQuota.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IQuota.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IQuota FromJson(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonNode node)
        {
        ...
        internal Quota(Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject json)
        {
            ...
            {_hostsRemaining = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonObject>("hostsRemaining"), out var __jsonHostsRemaining) ? Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.QuotaHostsRemaining.FromJson(__jsonHostsRemaining) : _hostsRemaining;}
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Json.JsonString>("quotaEnabled"), out var __jsonQuotaEnabled) ? (string)__jsonQuotaEnabled : (string)_enabled;}
            AfterFromJson(json);
        }
