...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class Circuit :
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuit,
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuitInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuitInternal.ExpressRouteId { get => this._expressRouteId; set { {_expressRouteId = value;} } }

        /// <summary>Internal Acessors for ExpressRoutePrivatePeeringId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuitInternal.ExpressRoutePrivatePeeringId { get => this._expressRoutePrivatePeeringId; set { {_expressRoutePrivatePeeringId = value;} } }

        /// <summary>Internal Acessors for PrimarySubnet</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuitInternal.PrimarySubnet { get => this._primarySubnet; set { {_primarySubnet = value;} } }

        /// <summary>Internal Acessors for SecondarySubnet</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ICircuitInternal.SecondarySubnet { get => this._secondarySubnet; set { {_secondarySubnet = value;} } }
