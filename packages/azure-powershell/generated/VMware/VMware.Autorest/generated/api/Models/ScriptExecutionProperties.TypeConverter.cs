...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Models
{
    ...
    public partial class ScriptExecutionPropertiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="ScriptExecutionProperties"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="ScriptExecutionProperties" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="ScriptExecutionProperties" />.</param>
        /// <returns>
        /// an instance of <see cref="ScriptExecutionProperties" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionProperties ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionProperties).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
