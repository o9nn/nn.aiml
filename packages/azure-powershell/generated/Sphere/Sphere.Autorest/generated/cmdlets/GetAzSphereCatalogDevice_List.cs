...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListDevices=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/listDevices"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSphereCatalogDevice_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Sphere.Models.IDevice))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Description(@"Lists devices for catalog.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sphere.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/listDevices", ApiVersion = "2024-04-01")]
    public partial class GetAzSphereCatalogDevice_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSphereCatalogDevice_List" /> cmdlet class.
        /// </summary>
        public GetAzSphereCatalogDevice_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CatalogsListDevices' operation"))
                {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.CatalogsListDevices_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
