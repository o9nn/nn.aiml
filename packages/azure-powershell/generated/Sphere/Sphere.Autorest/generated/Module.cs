...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere
{
    ...
    public partial class Module
    {
        ...
        private static Microsoft.Azure.PowerShell.Cmdlets.Sphere.Module _instance;

        /// <summary>the ISendAsync pipeline instance</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Sphere.Sphere ClientAPI { get; set; }
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Sphere.Module Instance { get { if (_instance == null) { lock (_singletonLock) { if (_instance == null) { _instance = new Module(); }}} return _instance; } }

        /// <summary>The Name of this module</summary>
        public string Name => @"Az.Sphere";
        ...
        public string ResourceId => @"Az.Sphere";
        ...
        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline for the remote call.</returns>
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline pipeline = null;
        ...
        {
            // constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.Sphere.Sphere();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
