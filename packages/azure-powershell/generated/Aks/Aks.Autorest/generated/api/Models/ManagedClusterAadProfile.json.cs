...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class ManagedClusterAadProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAadProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAadProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAadProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedClusterAadProfile(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_managed = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("managed"), out var __jsonManaged) ? (bool?)__jsonManaged : _managed;}
            {_enableAzureRbac = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("enableAzureRBAC"), out var __jsonEnableAzureRbac) ? (bool?)__jsonEnableAzureRbac : _enableAzureRbac;}
            {_adminGroupObjectID = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray>("adminGroupObjectIDs"), out var __jsonAdminGroupObjectIDs) ? If( __jsonAdminGroupObjectIDs as Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _adminGroupObjectID;}
            {_clientAppId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("clientAppID"), out var __jsonClientAppId) ? (string)__jsonClientAppId : (string)_clientAppId;}
            {_serverAppId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("serverAppID"), out var __jsonServerAppId) ? (string)__jsonServerAppId : (string)_serverAppId;}
            {_serverAppSecret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("serverAppSecret"), out var __jsonServerAppSecret) ? (string)__jsonServerAppSecret : (string)_serverAppSecret;}
