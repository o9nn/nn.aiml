...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class ManagedClusterAddonProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAddonProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAddonProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IManagedClusterAddonProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedClusterAddonProfile(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterAddonProfileIdentity.FromJson(__jsonIdentity) : _identity;}
            ...
            {_config = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("config"), out var __jsonConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ManagedClusterAddonProfileConfig.FromJson(__jsonConfig) : _config;}
            AfterFromJson(json);
        }
