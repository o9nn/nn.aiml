...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class MaintenanceConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IMaintenanceConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IMaintenanceConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.IMaintenanceConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal MaintenanceConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            __subResource = new Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.SubResource(json);
            {_systemData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("systemData"), out var __jsonSystemData) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.SystemData.FromJson(__jsonSystemData) : _systemData;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.MaintenanceConfigurationProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }
