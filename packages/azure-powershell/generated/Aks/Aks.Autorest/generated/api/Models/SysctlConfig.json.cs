...
namespace Microsoft.Azure.PowerShell.Cmdlets.Aks.Models
{
    ...
    public partial class SysctlConfig
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ISysctlConfig.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ISysctlConfig.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Aks.Models.ISysctlConfig FromJson(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNode node)
        {
        ...
        internal SysctlConfig(Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonObject json)
        {
            ...
            {_netCoreSomaxconn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreSomaxconn"), out var __jsonNetCoreSomaxconn) ? (int?)__jsonNetCoreSomaxconn : _netCoreSomaxconn;}
            {_netCoreNetdevMaxBacklog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreNetdevMaxBacklog"), out var __jsonNetCoreNetdevMaxBacklog) ? (int?)__jsonNetCoreNetdevMaxBacklog : _netCoreNetdevMaxBacklog;}
            {_netCoreRmemDefault = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreRmemDefault"), out var __jsonNetCoreRmemDefault) ? (int?)__jsonNetCoreRmemDefault : _netCoreRmemDefault;}
            {_netCoreRmemMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreRmemMax"), out var __jsonNetCoreRmemMax) ? (int?)__jsonNetCoreRmemMax : _netCoreRmemMax;}
            {_netCoreWmemDefault = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreWmemDefault"), out var __jsonNetCoreWmemDefault) ? (int?)__jsonNetCoreWmemDefault : _netCoreWmemDefault;}
            {_netCoreWmemMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreWmemMax"), out var __jsonNetCoreWmemMax) ? (int?)__jsonNetCoreWmemMax : _netCoreWmemMax;}
            {_netCoreOptmemMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netCoreOptmemMax"), out var __jsonNetCoreOptmemMax) ? (int?)__jsonNetCoreOptmemMax : _netCoreOptmemMax;}
            {_netIpv4TcpMaxSynBacklog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpMaxSynBacklog"), out var __jsonNetIpv4TcpMaxSynBacklog) ? (int?)__jsonNetIpv4TcpMaxSynBacklog : _netIpv4TcpMaxSynBacklog;}
            {_netIpv4TcpMaxTwBucket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpMaxTwBuckets"), out var __jsonNetIpv4TcpMaxTwBuckets) ? (int?)__jsonNetIpv4TcpMaxTwBuckets : _netIpv4TcpMaxTwBucket;}
            {_netIpv4TcpFinTimeout = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpFinTimeout"), out var __jsonNetIpv4TcpFinTimeout) ? (int?)__jsonNetIpv4TcpFinTimeout : _netIpv4TcpFinTimeout;}
            {_netIpv4TcpKeepaliveTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpKeepaliveTime"), out var __jsonNetIpv4TcpKeepaliveTime) ? (int?)__jsonNetIpv4TcpKeepaliveTime : _netIpv4TcpKeepaliveTime;}
            {_netIpv4TcpKeepaliveProbe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpKeepaliveProbes"), out var __jsonNetIpv4TcpKeepaliveProbes) ? (int?)__jsonNetIpv4TcpKeepaliveProbes : _netIpv4TcpKeepaliveProbe;}
            {_netIpv4TcpkeepaliveIntvl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4TcpkeepaliveIntvl"), out var __jsonNetIpv4TcpkeepaliveIntvl) ? (int?)__jsonNetIpv4TcpkeepaliveIntvl : _netIpv4TcpkeepaliveIntvl;}
            {_netIpv4TcpTwReuse = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonBoolean>("netIpv4TcpTwReuse"), out var __jsonNetIpv4TcpTwReuse) ? (bool?)__jsonNetIpv4TcpTwReuse : _netIpv4TcpTwReuse;}
            {_netIpv4IPLocalPortRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonString>("netIpv4IpLocalPortRange"), out var __jsonNetIpv4IPLocalPortRange) ? (string)__jsonNetIpv4IPLocalPortRange : (string)_netIpv4IPLocalPortRange;}
            {_netIpv4NeighDefaultGcThresh1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4NeighDefaultGcThresh1"), out var __jsonNetIpv4NeighDefaultGcThresh1) ? (int?)__jsonNetIpv4NeighDefaultGcThresh1 : _netIpv4NeighDefaultGcThresh1;}
            {_netIpv4NeighDefaultGcThresh2 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4NeighDefaultGcThresh2"), out var __jsonNetIpv4NeighDefaultGcThresh2) ? (int?)__jsonNetIpv4NeighDefaultGcThresh2 : _netIpv4NeighDefaultGcThresh2;}
            {_netIpv4NeighDefaultGcThresh3 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netIpv4NeighDefaultGcThresh3"), out var __jsonNetIpv4NeighDefaultGcThresh3) ? (int?)__jsonNetIpv4NeighDefaultGcThresh3 : _netIpv4NeighDefaultGcThresh3;}
            {_netNetfilterNfConntrackMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netNetfilterNfConntrackMax"), out var __jsonNetNetfilterNfConntrackMax) ? (int?)__jsonNetNetfilterNfConntrackMax : _netNetfilterNfConntrackMax;}
            {_netNetfilterNfConntrackBucket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("netNetfilterNfConntrackBuckets"), out var __jsonNetNetfilterNfConntrackBuckets) ? (int?)__jsonNetNetfilterNfConntrackBuckets : _netNetfilterNfConntrackBucket;}
            {_fsInotifyMaxUserWatch = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("fsInotifyMaxUserWatches"), out var __jsonFsInotifyMaxUserWatches) ? (int?)__jsonFsInotifyMaxUserWatches : _fsInotifyMaxUserWatch;}
            {_fsFileMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("fsFileMax"), out var __jsonFsFileMax) ? (int?)__jsonFsFileMax : _fsFileMax;}
            {_fsAioMaxNr = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("fsAioMaxNr"), out var __jsonFsAioMaxNr) ? (int?)__jsonFsAioMaxNr : _fsAioMaxNr;}
            {_fsNrOpen = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("fsNrOpen"), out var __jsonFsNrOpen) ? (int?)__jsonFsNrOpen : _fsNrOpen;}
            {_kernelThreadsMax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("kernelThreadsMax"), out var __jsonKernelThreadsMax) ? (int?)__jsonKernelThreadsMax : _kernelThreadsMax;}
            {_vMMaxMapCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("vmMaxMapCount"), out var __jsonVMMaxMapCount) ? (int?)__jsonVMMaxMapCount : _vMMaxMapCount;}
            {_vMSwappiness = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("vmSwappiness"), out var __jsonVMSwappiness) ? (int?)__jsonVMSwappiness : _vMSwappiness;}
            {_vMVfsCachePressure = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Aks.Runtime.Json.JsonNumber>("vmVfsCachePressure"), out var __jsonVMVfsCachePressure) ? (int?)__jsonVMVfsCachePressure : _vMVfsCachePressure;}
            AfterFromJson(json);
        }
