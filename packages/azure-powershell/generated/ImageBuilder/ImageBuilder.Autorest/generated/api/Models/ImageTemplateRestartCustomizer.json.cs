...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateRestartCustomizer
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateRestartCustomizer.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateRestartCustomizer.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.IImageTemplateRestartCustomizer FromJson(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonNode node)
        {
        ...
        internal ImageTemplateRestartCustomizer(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject json)
        {
            ...
            {_restartCommand = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonString>("restartCommand"), out var __jsonRestartCommand) ? (string)__jsonRestartCommand : (string)_restartCommand;}
            {_restartCheckCommand = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonString>("restartCheckCommand"), out var __jsonRestartCheckCommand) ? (string)__jsonRestartCheckCommand : (string)_restartCheckCommand;}
            {_restartTimeout = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonString>("restartTimeout"), out var __jsonRestartTimeout) ? (string)__jsonRestartTimeout : (string)_restartTimeout;}
            AfterFromJson(json);
        }
