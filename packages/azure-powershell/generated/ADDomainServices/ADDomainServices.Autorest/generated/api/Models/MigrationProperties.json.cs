...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models
{
    ...
    public partial class MigrationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IMigrationProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IMigrationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.IMigrationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
        ...
        internal MigrationProperties(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_migrationProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject>("migrationProgress"), out var __jsonMigrationProgress) ? Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.MigrationProgress.FromJson(__jsonMigrationProgress) : _migrationProgress;}
            {_oldSubnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("oldSubnetId"), out var __jsonOldSubnetId) ? (string)__jsonOldSubnetId : (string)_oldSubnetId;}
            {_oldVnetSiteId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("oldVnetSiteId"), out var __jsonOldVnetSiteId) ? (string)__jsonOldVnetSiteId : (string)_oldVnetSiteId;}
            AfterFromJson(json);
        }
