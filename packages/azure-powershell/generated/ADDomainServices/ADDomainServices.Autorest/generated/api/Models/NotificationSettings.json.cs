...
namespace Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models
{
    ...
    public partial class NotificationSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.INotificationSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.INotificationSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Models.INotificationSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonNode node)
        {
        ...
        internal NotificationSettings(Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_notifyGlobalAdmin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("notifyGlobalAdmins"), out var __jsonNotifyGlobalAdmins) ? (string)__jsonNotifyGlobalAdmins : (string)_notifyGlobalAdmin;}
            {_notifyDcAdmin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString>("notifyDcAdmins"), out var __jsonNotifyDcAdmins) ? (string)__jsonNotifyDcAdmins : (string)_notifyDcAdmin;}
            {_additionalRecipient = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray>("additionalRecipients"), out var __jsonAdditionalRecipients) ? If( __jsonAdditionalRecipients as Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ADDomainServices.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _additionalRecipient;}
            AfterFromJson(json);
        }
