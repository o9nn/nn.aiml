...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDeviceRegistryAsset_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzDeviceRegistryAsset_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A reference to the asset endpoint profile (connection information) used by brokers to connect to an endpoint that provides data points for this asset. Must provide asset endpoint profile name.")]
        ...
        public string AssetEndpointProfileRef { get => _resourceBody.EndpointProfileRef ?? null; set => _resourceBody.EndpointProfileRef = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IAssetPropertiesAttributes Attribute { get => _resourceBody.Attribute ?? null /* object */; set => _resourceBody.Attribute = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IDataset[] Dataset { get => _resourceBody.Dataset?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.Dataset = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IDataset>(value) : null); }
        ...
        SerializedName = @"path",
        PossibleTypes = new [] { typeof(string) })]
        public string DefaultTopicPath { get => _resourceBody.DefaultTopicPath ?? null; set => _resourceBody.DefaultTopicPath = value; }
        ...
        public string DefaultTopicRetain { get => _resourceBody.DefaultTopicRetain ?? null; set => _resourceBody.DefaultTopicRetain = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Reference to a list of discovered assets. Populated only if the asset has been created from discovery flow. Discovered asset names must be provided.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] DiscoveredAssetRef { get => _resourceBody.DiscoveredAssetRef?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.DiscoveredAssetRef = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IEvent[] Event { get => _resourceBody.Event?.ToArray() ?? null /* fixedArrayOf */; set => _resourceBody.Event = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IEvent>(value) : null); }
        ...
        /// <returns>a duplicate instance of NewAzDeviceRegistryAsset_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets.NewAzDeviceRegistryAsset_CreateExpanded Clone()
        {
            var clone = new NewAzDeviceRegistryAsset_CreateExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzDeviceRegistryAsset_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDeviceRegistryAsset_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AssetsCreateOrReplace(SubscriptionId, ResourceGroupName, Name, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.SerializationMode.IncludeCreate);
