...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/schemaRegistries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDeviceRegistrySchemaRegistry_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Description(@"List SchemaRegistry resources by resource group")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/schemaRegistries", ApiVersion = "2025-10-01")]
    public partial class GetAzDeviceRegistrySchemaRegistry_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDeviceRegistrySchemaRegistry_List1" /> cmdlet class.
        /// </summary>
        public GetAzDeviceRegistrySchemaRegistry_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SchemaRegistriesListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SchemaRegistriesListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
