...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMessageSchemaReferenceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMessageSchemaReferenceInternal.SchemaName { get => this._schemaName; set { {_schemaName = value;} } }

        /// <summary>Internal Acessors for SchemaRegistryNamespace</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMessageSchemaReferenceInternal.SchemaRegistryNamespace { get => this._schemaRegistryNamespace; set { {_schemaRegistryNamespace = value;} } }

        /// <summary>Internal Acessors for SchemaVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceMessageSchemaReferenceInternal.SchemaVersion { get => this._schemaVersion; set { {_schemaVersion = value;} } }
        ...
        /// <summary>Creates an new <see cref="NamespaceMessageSchemaReference" /> instance.</summary>
        public NamespaceMessageSchemaReference()
        {
    ...
    /// Defines the message schema reference properties.
    internal partial interface INamespaceMessageSchemaReferenceInternal
