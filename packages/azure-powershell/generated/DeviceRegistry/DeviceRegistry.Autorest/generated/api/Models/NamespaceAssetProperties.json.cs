...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models
{
    ...
    public partial class NamespaceAssetProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceAssetProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceAssetProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceAssetProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject json ? new NamespaceAssetProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject into a new instance of <see cref="NamespaceAssetProperties" />.
        /// </summary>
        ...
        internal NamespaceAssetProperties(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_deviceRef = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject>("deviceRef"), out var __jsonDeviceRef) ? Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.DeviceRef.FromJson(__jsonDeviceRef) : _deviceRef;}
            {_status = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject>("status"), out var __jsonStatus) ? Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.NamespaceAssetStatus.FromJson(__jsonStatus) : _status;}
            ...
            {_attribute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.NamespaceAssetPropertiesAttributes.FromJson(__jsonAttributes) : _attribute;}
            {_discoveredAssetRef = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("discoveredAssetRefs"), out var __jsonDiscoveredAssetRefs) ? If( __jsonDiscoveredAssetRefs as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _discoveredAssetRef;}
            ...
            {_defaultDatasetsDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("defaultDatasetsDestinations"), out var __jsonDefaultDatasetsDestinations) ? If( __jsonDefaultDatasetsDestinations as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IDatasetDestination>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IDatasetDestination) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.DatasetDestination.FromJson(__k) )) ))() : null : _defaultDatasetsDestination;}
            {_defaultEventsDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("defaultEventsDestinations"), out var __jsonDefaultEventsDestinations) ? If( __jsonDefaultEventsDestinations as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IEventDestination>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IEventDestination) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.EventDestination.FromJson(__f) )) ))() : null : _defaultEventsDestination;}
            {_defaultStreamsDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("defaultStreamsDestinations"), out var __jsonDefaultStreamsDestinations) ? If( __jsonDefaultStreamsDestinations as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStreamDestination>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IStreamDestination) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.StreamDestination.FromJson(__a) )) ))() : null : _defaultStreamsDestination;}
            {_dataset = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("datasets"), out var __jsonDatasets) ? If( __jsonDatasets as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceDataset>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___w, (___v)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceDataset) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.NamespaceDataset.FromJson(___v) )) ))() : null : _dataset;}
            {_eventGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("eventGroups"), out var __jsonEventGroups) ? If( __jsonEventGroups as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var ___r) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceEventGroup>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___r, (___q)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceEventGroup) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.NamespaceEventGroup.FromJson(___q) )) ))() : null : _eventGroup;}
            {_stream = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("streams"), out var __jsonStreams) ? If( __jsonStreams as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var ___m) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceStream>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___m, (___l)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.INamespaceStream) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.NamespaceStream.FromJson(___l) )) ))() : null : _stream;}
            {_managementGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray>("managementGroups"), out var __jsonManagementGroups) ? If( __jsonManagementGroups as Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonArray, out var ___h) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IManagementGroup>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(___h, (___g)=>(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IManagementGroup) (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.ManagementGroup.FromJson(___g) )) ))() : null : _managementGroup;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="NamespaceAssetProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NamespaceAssetProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.SerializationMode.IncludeRead)||serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.SerializationMode.IncludeCreate))
            {
                if (null != this._discoveredAssetRef)
                {
                    ...
                    foreach( var __s in this._discoveredAssetRef )
                    {
                        AddIf(null != (((object)__s)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString(__s.ToString()) : null ,__r.Add);
                    }
                    container.Add("discoveredAssetRefs",__r);
                }
            }
            ...
            if (null != this._defaultDatasetsDestination)
            {
                ...
                foreach( var __n in this._defaultDatasetsDestination )
                {
                    AddIf(__n?.ToJson(null, serializationMode) ,__m.Add);
                }
                container.Add("defaultDatasetsDestinations",__m);
            }
            if (null != this._defaultEventsDestination)
            {
                ...
                foreach( var __i in this._defaultEventsDestination )
                {
                    AddIf(__i?.ToJson(null, serializationMode) ,__h.Add);
                }
                container.Add("defaultEventsDestinations",__h);
            }
