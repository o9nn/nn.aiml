...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201
{
    ...
    public partial class ItemLevelRestoreTargetInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IItemLevelRestoreTargetInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IItemLevelRestoreTargetInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IItemLevelRestoreTargetInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        internal ItemLevelRestoreTargetInfo(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_restoreCriterion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray>("restoreCriteria"), out var __jsonRestoreCriteria) ? If( __jsonRestoreCriteria as Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IItemLevelRestoreCriteria[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.IItemLevelRestoreCriteria) (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.ItemLevelRestoreCriteria.FromJson(__u) )) ))() : null : RestoreCriterion;}
            {_datasourceInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceInfo"), out var __jsonDatasourceInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.Datasource.FromJson(__jsonDatasourceInfo) : DatasourceInfo;}
            {_datasourceSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceSetInfo"), out var __jsonDatasourceSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.DatasourceSet.FromJson(__jsonDatasourceSetInfo) : DatasourceSetInfo;}
            {_datasourceAuthCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceAuthCredentials"), out var __jsonDatasourceAuthCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250201.AuthCredentials.FromJson(__jsonDatasourceAuthCredentials) : DatasourceAuthCredentials;}
            AfterFromJson(json);
        }
