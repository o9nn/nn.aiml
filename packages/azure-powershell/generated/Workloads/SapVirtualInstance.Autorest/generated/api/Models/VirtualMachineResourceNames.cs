...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class VirtualMachineResourceNames :
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IVirtualMachineResourceNames,
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IVirtualMachineResourceNamesInternal
    {

        /// <summary>Backing field for <see cref="DataDiskName" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IVirtualMachineResourceNamesDataDiskNames _dataDiskName;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IVirtualMachineResourceNamesDataDiskNames DataDiskName { get => (this._dataDiskName = this._dataDiskName ?? new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.VirtualMachineResourceNamesDataDiskNames()); set => this._dataDiskName = value; }
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.INetworkInterfaceResourceNames> _networkInterface;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.INetworkInterfaceResourceNames> NetworkInterface { get => this._networkInterface; set => this._networkInterface = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.IVirtualMachineResourceNamesDataDiskNames DataDiskName { get; set; }
        /// <summary>
        /// The full name for virtual-machine's host (computer name). Currently, ACSS only supports host names which are less than
        /// or equal to 13 characters long. If this value is not provided, vmName will be used as host name.
        /// </summary>
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.INetworkInterfaceResourceNames> NetworkInterface { get; set; }
        /// <summary>
        /// The full name for OS disk attached to the VM. If this value is not provided, it will be named by ARM as per its default
        /// naming standards (prefixed with vm name). There is only one OS disk attached per Virtual Machine.
        /// </summary>
