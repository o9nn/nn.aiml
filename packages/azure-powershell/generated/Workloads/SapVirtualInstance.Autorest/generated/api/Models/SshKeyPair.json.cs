...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models
{
    ...
    public partial class SshKeyPair
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISshKeyPair.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISshKeyPair.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Models.ISshKeyPair FromJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject json ? new SshKeyPair(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject into a new instance of <see cref="SshKeyPair" />.
        /// </summary>
        ...
        internal SshKeyPair(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_publicKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("publicKey"), out var __jsonPublicKey) ? (string)__jsonPublicKey : (string)_publicKey;}
            {_privateKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString>("privateKey"), out var __jsonPrivateKey) ? new System.Net.NetworkCredential("",(string)__jsonPrivateKey).SecurePassword : _privateKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SshKeyPair" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SshKeyPair" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._publicKey)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString(this._publicKey.ToString()) : null, "publicKey" ,container.Add );
            AddIf( null != (((object)this._privateKey)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.Json.JsonString(System.Runtime.InteropServices.Marshal.PtrToStringBSTR(System.Runtime.InteropServices.Marshal.SecureStringToBSTR(this._privateKey))) : null, "privateKey" ,container.Add );
