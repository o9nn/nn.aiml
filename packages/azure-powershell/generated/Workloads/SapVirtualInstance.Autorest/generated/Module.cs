...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance
{
    ...
    public partial class Module
    {
        ...
        private static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Module _instance;

        /// <summary>the ISendAsync pipeline instance</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.SapVirtualInstance ClientAPI { get; set; }
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Module Instance { get { if (_instance == null) { lock (_singletonLock) { if (_instance == null) { _instance = new Module(); }}} return _instance; } }
        ...
        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline for the remote call.</returns>
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline pipeline = null;
        ...
        {
            // constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.SapVirtualInstance();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Workloads.SapVirtualInstance.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
