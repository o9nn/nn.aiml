...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models
{
    ...
    public partial class SapLandscapeMonitorSidMapping :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.ISapLandscapeMonitorSidMappingInternal
    {
        ...
        private System.Collections.Generic.List<string> _topSid;

        /// <summary>Gets or sets the list of SID's.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Origin(Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> TopSid { get => this._topSid; set => this._topSid = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> TopSid { get; set; }
