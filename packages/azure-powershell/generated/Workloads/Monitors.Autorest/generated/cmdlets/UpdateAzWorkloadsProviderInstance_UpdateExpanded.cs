...
namespace Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzWorkloadsProviderInstance_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Description(@"update a provider instance for the specified subscription, resource group, SAP monitor name, and resource name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Generated]
    public partial class UpdateAzWorkloadsProviderInstance_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.IProviderInstance _providerInstanceParameterBody = new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.ProviderInstance();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.IProviderSpecificProperties ProviderSetting { get => _providerInstanceParameterBody.ProviderSetting ?? null /* object */; set => _providerInstanceParameterBody.ProviderSetting = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzWorkloadsProviderInstance_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Cmdlets.UpdateAzWorkloadsProviderInstance_UpdateExpanded Clone()
        {
            var clone = new UpdateAzWorkloadsProviderInstance_UpdateExpanded();
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _providerInstanceParameterBody?.IdentityType?.Contains("SystemAssigned"));
            bool supportsUserAssignedIdentity = false;
            if (this.UserAssignedIdentity?.Length > 0)
            {
                // calculate UserAssignedIdentity
                _providerInstanceParameterBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _providerInstanceParameterBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.UserAssignedIdentity());
                }
            }
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _providerInstanceParameterBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _providerInstanceParameterBody.IdentityUserAssignedIdentity = null;
            }
            // calculate IdentityType
            if ((supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _providerInstanceParameterBody.IdentityType = "SystemAssigned,UserAssigned";
            }
            else if ((supportsUserAssignedIdentity && !supportsSystemAssignedIdentity))
            {
                _providerInstanceParameterBody.IdentityType = "UserAssigned";
            }
            else if ((!supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _providerInstanceParameterBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _providerInstanceParameterBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _providerInstanceParameterBody = await this.Client.ProviderInstancesGetWithResult(SubscriptionId, ResourceGroupName, MonitorName, Name, this, Pipeline);
                    this.PreProcessManagedIdentityParametersWithGetResult();
                    this.Update_providerInstanceParameterBody();
                    await this.Client.ProviderInstancesCreate(SubscriptionId, ResourceGroupName, MonitorName, Name, _providerInstanceParameterBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWorkloadsProviderInstance_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzWorkloadsProviderInstance_UpdateExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ProviderSetting")))
            {
                this.ProviderSetting = (Microsoft.Azure.PowerShell.Cmdlets.Workloads.Monitors.Models.IProviderSpecificProperties)(this.MyInvocation?.BoundParameters["ProviderSetting"]);
            }
        }
