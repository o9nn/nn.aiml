...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models
{
    ...
    public partial class ServiceCorsConfigurationInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCorsConfigurationInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCorsConfigurationInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IServiceCorsConfigurationInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
        ...
        internal ServiceCorsConfigurationInfo(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            {_origin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray>("origins"), out var __jsonOrigins) ? If( __jsonOrigins as Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _origin;}
            {_header = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray>("headers"), out var __jsonHeaders) ? If( __jsonHeaders as Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _header;}
            {_method = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray>("methods"), out var __jsonMethods) ? If( __jsonMethods as Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _method;}
            {_maxAge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNumber>("maxAge"), out var __jsonMaxAge) ? (int?)__jsonMaxAge : _maxAge;}
            {_allowCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonBoolean>("allowCredentials"), out var __jsonAllowCredentials) ? (bool?)__jsonAllowCredentials : _allowCredentials;}
            AfterFromJson(json);
        }
