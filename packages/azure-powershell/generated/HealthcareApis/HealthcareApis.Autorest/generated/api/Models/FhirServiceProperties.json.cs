...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models
{
    ...
    public partial class FhirServiceProperties
    {
        ...
        internal FhirServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject json)
        {
            ...
            {_acrConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject>("acrConfiguration"), out var __jsonAcrConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.FhirServiceAcrConfiguration.FromJson(__jsonAcrConfiguration) : _acrConfiguration;}
            {_authenticationConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject>("authenticationConfiguration"), out var __jsonAuthenticationConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.FhirServiceAuthenticationConfiguration.FromJson(__jsonAuthenticationConfiguration) : _authenticationConfiguration;}
            {_corsConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonObject>("corsConfiguration"), out var __jsonCorsConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.FhirServiceCorsConfiguration.FromJson(__jsonCorsConfiguration) : _corsConfiguration;}
            ...
            {_accessPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray>("accessPolicies"), out var __jsonAccessPolicies) ? If( __jsonAccessPolicies as Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceAccessPolicyEntry>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceAccessPolicyEntry) (Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.FhirServiceAccessPolicyEntry.FromJson(__u) )) ))() : null : _accessPolicy;}
            ...
            {_eventState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonString>("eventState"), out var __jsonEventState) ? (string)__jsonEventState : (string)_eventState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Models.IFhirServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.Json.JsonNode node)
        {
