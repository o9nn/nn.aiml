...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzHealthcareDicomService_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Description(@"update a DICOM Service resource with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Generated]
    public partial class UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Cmdlets.UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded();
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _dicomserviceBody?.IdentityType?.Contains("SystemAssigned"));
            ...
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _dicomserviceBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _dicomserviceBody.IdentityUserAssignedIdentity = null;
            }
            ...
            {
                _dicomserviceBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _dicomserviceBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _dicomserviceBody = await this.Client.DicomServicesGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_dicomserviceBody();
                        await this.Client.DicomServicesCreateOrUpdateViaIdentity(InputObject.Id, _dicomserviceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _dicomserviceBody = await this.Client.DicomServicesGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.DicomServiceName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_dicomserviceBody();
                        await this.Client.DicomServicesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.DicomServiceName ?? null, _dicomserviceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.HealthcareApis.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzHealthcareDicomService_UpdateViaIdentityExpanded()
        {

        }

        private void Update_dicomserviceBody()
        {
