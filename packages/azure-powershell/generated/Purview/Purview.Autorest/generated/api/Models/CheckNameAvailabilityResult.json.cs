...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models
{
    ...
    public partial class CheckNameAvailabilityResult
    {
        ...
        internal CheckNameAvailabilityResult(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json)
        {
            ...
            {_nameAvailable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonBoolean>("nameAvailable"), out var __jsonNameAvailable) ? (bool?)__jsonNameAvailable : _nameAvailable;}
            {_reason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString>("reason"), out var __jsonReason) ? (string)__jsonReason : (string)_reason;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICheckNameAvailabilityResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICheckNameAvailabilityResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICheckNameAvailabilityResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode node)
        {
