...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models
{
    ...
    public partial class AccessKeys
    {
        ...
        internal AccessKeys(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json)
        {
            ...
            {_atlasKafkaPrimaryEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString>("atlasKafkaPrimaryEndpoint"), out var __jsonAtlasKafkaPrimaryEndpoint) ? (string)__jsonAtlasKafkaPrimaryEndpoint : (string)_atlasKafkaPrimaryEndpoint;}
            {_atlasKafkaSecondaryEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString>("atlasKafkaSecondaryEndpoint"), out var __jsonAtlasKafkaSecondaryEndpoint) ? (string)__jsonAtlasKafkaSecondaryEndpoint : (string)_atlasKafkaSecondaryEndpoint;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IAccessKeys.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IAccessKeys.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.IAccessKeys FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode node)
        {
