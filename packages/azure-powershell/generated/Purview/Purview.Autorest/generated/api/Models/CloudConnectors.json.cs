...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models
{
    ...
    public partial class CloudConnectors
    {
        ...
        internal CloudConnectors(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json)
        {
            ...
            {_awsExternalId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString>("awsExternalId"), out var __jsonAwsExternalId) ? (string)__jsonAwsExternalId : (string)_awsExternalId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICloudConnectors.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICloudConnectors.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.ICloudConnectors FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode node)
        {
