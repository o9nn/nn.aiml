...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class ScanProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode node)
        {
        ...
        internal ScanProperties(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json)
        {
            ...
            {_collection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("collection"), out var __jsonCollection) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ScanPropertiesCollection.FromJson(__jsonCollection) : _collection;}
            {_connectedVia = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject>("connectedVia"), out var __jsonConnectedVia) ? Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.ScanPropertiesConnectedVia.FromJson(__jsonConnectedVia) : _connectedVia;}
            ...
            {_scanRulesetType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString>("scanRulesetType"), out var __jsonScanRulesetType) ? (string)__jsonScanRulesetType : (string)_scanRulesetType;}
            {_worker = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNumber>("workers"), out var __jsonWorkers) ? (int?)__jsonWorkers : _worker;}
