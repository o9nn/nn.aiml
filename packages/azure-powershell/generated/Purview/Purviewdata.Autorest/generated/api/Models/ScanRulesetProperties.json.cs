...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models
{
    ...
    public partial class ScanRulesetProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanRulesetProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanRulesetProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Models.IScanRulesetProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json ? new ScanRulesetProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject into a new instance of <see cref="ScanRulesetProperties" />.
        /// </summary>
        ...
        internal ScanRulesetProperties(Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonObject json)
        {
            ...
            {_excludedSystemClassification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("excludedSystemClassifications"), out var __jsonExcludedSystemClassifications) ? If( __jsonExcludedSystemClassifications as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _excludedSystemClassification;}
            {_includedCustomClassificationRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray>("includedCustomClassificationRuleNames"), out var __jsonIncludedCustomClassificationRuleNames) ? If( __jsonIncludedCustomClassificationRuleNames as Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Purviewdata.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : _includedCustomClassificationRuleName;}
