...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.DataReplication/replicationVaults"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMigrateVault_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Description(@"Gets the list of vaults in the given subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Migrate.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DataReplication/replicationVaults", ApiVersion = "2024-09-01")]
    public partial class GetAzMigrateVault_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMigrateVault_List" /> cmdlet class.
        /// </summary>
        public GetAzMigrateVault_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VaultListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.VaultListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
