...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901
{
    ...
    public partial class AzStackHciFabricModelCustomProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciClusterProperties _cluster;

        /// <summary>AzStackHCI cluster properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Origin(Microsoft.Azure.PowerShell.Cmdlets.Migrate.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciClusterProperties Cluster { get => (this._cluster = this._cluster ?? new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.AzStackHciClusterProperties()); set => this._cluster = value; }
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomPropertiesInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for FabricContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomPropertiesInternal.FabricContainerId { get => this._fabricContainerId; set { {_fabricContainerId = value;} } }

        /// <summary>Internal Acessors for FabricResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomPropertiesInternal.FabricResourceId { get => this._fabricResourceId; set { {_fabricResourceId = value;} } }

        /// <summary>Internal Acessors for MigrationHubUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciFabricModelCustomPropertiesInternal.MigrationHubUri { get => this._migrationHubUri; set { {_migrationHubUri = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IFabricModelCustomProperties
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciClusterProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IAzStackHciClusterProperties Cluster { get; set; }
        /// <summary>Gets or sets the fabric container Id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Info(
        Required = false,
        ReadOnly = true,
