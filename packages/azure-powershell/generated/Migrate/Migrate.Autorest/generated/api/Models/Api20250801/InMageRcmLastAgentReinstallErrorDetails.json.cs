...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class InMageRcmLastAgentReinstallErrorDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IInMageRcmLastAgentReinstallErrorDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IInMageRcmLastAgentReinstallErrorDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IInMageRcmLastAgentReinstallErrorDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json ? new InMageRcmLastAgentReinstallErrorDetails(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject into a new instance of <see cref="InMageRcmLastAgentReinstallErrorDetails" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal InMageRcmLastAgentReinstallErrorDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            {_errorMessageParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("errorMessageParameters"), out var __jsonErrorMessageParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.InMageRcmLastAgentReinstallErrorDetailsErrorMessageParameters.FromJson(__jsonErrorMessageParameters) : ErrorMessageParameter;}
            {_errorTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("errorTags"), out var __jsonErrorTags) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.InMageRcmLastAgentReinstallErrorDetailsErrorTags.FromJson(__jsonErrorTags) : ErrorTag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="InMageRcmLastAgentReinstallErrorDetails" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="InMageRcmLastAgentReinstallErrorDetails" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
