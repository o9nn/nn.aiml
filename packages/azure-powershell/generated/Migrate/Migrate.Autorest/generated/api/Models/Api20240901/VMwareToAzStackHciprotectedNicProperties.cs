...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901
{
    ...
    public partial class VMwareToAzStackHciprotectedNicProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for SelectionTypeForFailover</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.VMNicSelection? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.SelectionTypeForFailover { get => this._selectionTypeForFailover; set { {_selectionTypeForFailover = value;} } }

        /// <summary>Internal Acessors for TargetNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.TargetNetworkId { get => this._targetNetworkId; set { {_targetNetworkId = value;} } }

        /// <summary>Internal Acessors for TestNetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20240901.IVMwareToAzStackHciprotectedNicPropertiesInternal.TestNetworkId { get => this._testNetworkId; set { {_testNetworkId = value;} } }
