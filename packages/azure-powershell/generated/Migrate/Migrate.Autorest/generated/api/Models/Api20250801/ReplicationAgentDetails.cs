...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class ReplicationAgentDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for FabricObjectId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.FabricObjectId { get => this._fabricObjectId; set { {_fabricObjectId = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for HealthError</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IHealthError[] Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.HealthError { get => this._healthError; set { {_healthError = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LastHeartbeatUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.LastHeartbeatUtc { get => this._lastHeartbeatUtc; set { {_lastHeartbeatUtc = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IReplicationAgentDetailsInternal.Version { get => this._version; set { {_version = value;} } }
