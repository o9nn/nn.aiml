...
namespace Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801
{
    ...
    public partial class A2AReplicationIntentDetails
    {
        ...
        internal A2AReplicationIntentDetails(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject json)
        {
            ...
            __replicationProtectionIntentProviderSpecificSettings = new Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.ReplicationProtectionIntentProviderSpecificSettings(json);
            {_protectionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("protectionProfile"), out var __jsonProtectionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.ProtectionProfileCustomDetails.FromJson(__jsonProtectionProfile) : ProtectionProfile;}
            {_primaryStagingStorageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("primaryStagingStorageAccount"), out var __jsonPrimaryStagingStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.StorageAccountCustomDetails.FromJson(__jsonPrimaryStagingStorageAccount) : PrimaryStagingStorageAccount;}
            {_recoveryAvailabilitySet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryAvailabilitySet"), out var __jsonRecoveryAvailabilitySet) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryAvailabilitySetCustomDetails.FromJson(__jsonRecoveryAvailabilitySet) : RecoveryAvailabilitySet;}
            {_recoveryVirtualNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryVirtualNetwork"), out var __jsonRecoveryVirtualNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryVirtualNetworkCustomDetails.FromJson(__jsonRecoveryVirtualNetwork) : RecoveryVirtualNetwork;}
            {_recoveryProximityPlacementGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonObject>("recoveryProximityPlacementGroup"), out var __jsonRecoveryProximityPlacementGroup) ? Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.RecoveryProximityPlacementGroupCustomDetails.FromJson(__jsonRecoveryProximityPlacementGroup) : RecoveryProximityPlacementGroup;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AReplicationIntentDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AReplicationIntentDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20250801.IA2AReplicationIntentDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Migrate.Runtime.Json.JsonNode node)
        {
