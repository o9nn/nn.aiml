...
namespace ADT.Runtime.PowerShell
{
    ...
    {
        ADT.Runtime.SendAsyncStep Wrap(ADT.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<ADT.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<ADT.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public ADT.Runtime.SendAsyncStep Wrap(ADT.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<ADT.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<ADT.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);
