...
namespace ADT.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is ADT.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return ADT.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return ADT.Runtime.JsonSerializable.ToJson(dict, null);
            }
