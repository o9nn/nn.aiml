...
namespace ADT.Models
{
    ...
    public partial class ArmPipelineResponse
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ArmPipelineResponse" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ArmPipelineResponse(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_body = If( json?.PropertyT<ADT.Runtime.Json.JsonObject>("body"), out var __jsonBody) ? ADT.Models.Pipeline.FromJson(__jsonBody) : _body;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IArmPipelineResponse.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IArmPipelineResponse.</returns>
        public static ADT.Models.IArmPipelineResponse FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ArmPipelineResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ArmPipelineResponse" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ArmPipelineResponse" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
