...
namespace ADT.Models
{
    ...
    public partial class ConnectionsPatch
    {
        ...
        /// <summary>
        /// Deserializes a ADT.Runtime.Json.JsonObject into a new instance of <see cref="ConnectionsPatch" />.
        /// </summary>
        /// <param name="json">A ADT.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConnectionsPatch(ADT.Runtime.Json.JsonObject json)
        {
            ...
            {_tag = If( json?.PropertyT<ADT.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? ADT.Models.ConnectionsPatchTags.FromJson(__jsonTags) : _tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="ADT.Runtime.Json.JsonNode"/> into an instance of ADT.Models.IConnectionsPatch.
        /// </summary>
        /// <param name="node">a <see cref="ADT.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of ADT.Models.IConnectionsPatch.</returns>
        public static ADT.Models.IConnectionsPatch FromJson(ADT.Runtime.Json.JsonNode node)
        {
            return node is ADT.Runtime.Json.JsonObject json ? new ConnectionsPatch(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectionsPatch" /> into a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectionsPatch" /> as a <see cref="ADT.Runtime.Json.JsonNode" />.
        /// </returns>
