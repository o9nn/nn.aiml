...
namespace Microsoft.Azure.PowerShell.Cmdlets.Portal.Models
{
    ...
    public partial class DashboardProperties
    {
        ...
        internal DashboardProperties(Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject json)
        {
            ...
            {_lens = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonArray>("lenses"), out var __jsonLenses) ? If( __jsonLenses as Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.IDashboardLens>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.IDashboardLens) (Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.DashboardLens.FromJson(__u) )) ))() : null : _lens;}
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.DashboardPropertiesMetadata.FromJson(__jsonMetadata) : _metadata;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.IDashboardProperties.
        /// </summary>
