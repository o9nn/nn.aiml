...
namespace Microsoft.Azure.PowerShell.Cmdlets.Portal.Models
{
    ...
    public partial class DashboardParts
    {
        ...
        internal DashboardParts(Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject json)
        {
            ...
            {_position = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject>("position"), out var __jsonPosition) ? Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.DashboardPartsPosition.FromJson(__jsonPosition) : _position;}
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.DashboardPartMetadata.FromJson(__jsonMetadata) : _metadata;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.IDashboardParts.
        /// </summary>
