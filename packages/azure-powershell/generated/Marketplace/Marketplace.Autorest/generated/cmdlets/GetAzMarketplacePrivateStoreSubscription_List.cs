...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMarketplacePrivateStoreSubscription_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Description(@"List all the subscriptions in the private store context")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Marketplace.HttpPath(Path = "/providers/Microsoft.Marketplace/privateStores/{privateStoreId}/listSubscriptionsContext", ApiVersion = "2023-01-01")]
    public partial class GetAzMarketplacePrivateStoreSubscription_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList">Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMarketplacePrivateStoreSubscription_List" /> cmdlet class.
        /// </summary>
        public GetAzMarketplacePrivateStoreSubscription_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.ISubscriptionsContextList
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / subscriptionsIds / <none>
                if (null != result.SubscriptionsId)
                {
                    if (0 == _responseSize && 1 == result.SubscriptionsId.Count)
                    {
                        _firstResponse = result.SubscriptionsId[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.SubscriptionsId )
                        {
