...
namespace Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models
{
    ...
    public partial class Rule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRule.
        /// </summary>
        ...
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRule.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Models.IRule FromJson(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject json ? new Rule(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject into a new instance of <see cref="Rule" />.
        /// </summary>
        ...
        internal Rule(Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_type = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString>("type"), out var __jsonType) ? (string)__jsonType : (string)_type;}
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _value;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Rule" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Rule" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Marketplace.Runtime.Json.JsonNode" />.
        /// </returns>
