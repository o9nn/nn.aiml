...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class AppServiceCertificateOrderPatchResourceProperties
    {
        ...
        internal AppServiceCertificateOrderPatchResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_signedCertificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("signedCertificate"), out var __jsonSignedCertificate) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CertificateDetails.FromJson(__jsonSignedCertificate) : SignedCertificate;}
            {_intermediate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("intermediate"), out var __jsonIntermediate) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CertificateDetails.FromJson(__jsonIntermediate) : Intermediate;}
            {_root = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("root"), out var __jsonRoot) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CertificateDetails.FromJson(__jsonRoot) : Root;}
            {_contact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("contact"), out var __jsonContact) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.CertificateOrderContact.FromJson(__jsonContact) : Contact;}
            {_certificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("certificates"), out var __jsonCertificates) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.AppServiceCertificateOrderPatchResourcePropertiesCertificates.FromJson(__jsonCertificates) : Certificate;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IAppServiceCertificateOrderPatchResourceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IAppServiceCertificateOrderPatchResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.IAppServiceCertificateOrderPatchResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
