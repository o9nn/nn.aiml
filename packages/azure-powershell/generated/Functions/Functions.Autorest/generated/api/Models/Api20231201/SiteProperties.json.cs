...
namespace Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201
{
    ...
    public partial class SiteProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ISiteProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode node)
        {
        ...
        internal SiteProperties(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject json)
        {
            ...
            {_functionAppConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("functionAppConfig"), out var __jsonFunctionAppConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.FunctionAppConfig.FromJson(__jsonFunctionAppConfig) : FunctionAppConfig;}
            {_daprConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("daprConfig"), out var __jsonDaprConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.DaprConfig.FromJson(__jsonDaprConfig) : DaprConfig;}
            {_resourceConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject>("resourceConfig"), out var __jsonResourceConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Functions.Models.Api20231201.ResourceConfig.FromJson(__jsonResourceConfig) : ResourceConfig;}
            ...
            {_vnetImagePullEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("vnetImagePullEnabled"), out var __jsonVnetImagePullEnabled) ? (bool?)__jsonVnetImagePullEnabled : VnetImagePullEnabled;}
            {_vnetContentShareEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("vnetContentShareEnabled"), out var __jsonVnetContentShareEnabled) ? (bool?)__jsonVnetContentShareEnabled : VnetContentShareEnabled;}
            {_vnetBackupRestoreEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("vnetBackupRestoreEnabled"), out var __jsonVnetBackupRestoreEnabled) ? (bool?)__jsonVnetBackupRestoreEnabled : VnetBackupRestoreEnabled;}
            {_workloadProfileName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("workloadProfileName"), out var __jsonWorkloadProfileName) ? (string)__jsonWorkloadProfileName : (string)WorkloadProfileName;}
            ...
            {_endToEndEncryptionEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean>("endToEndEncryptionEnabled"), out var __jsonEndToEndEncryptionEnabled) ? (bool?)__jsonEndToEndEncryptionEnabled : EndToEndEncryptionEnabled;}
            ...
            {_managedEnvironmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString>("managedEnvironmentId"), out var __jsonManagedEnvironmentId) ? (string)__jsonManagedEnvironmentId : (string)ManagedEnvironmentId;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._functionAppConfig ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) this._functionAppConfig.ToJson(null,serializationMode) : null, "functionAppConfig" ,container.Add );
            AddIf( null != this._daprConfig ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) this._daprConfig.ToJson(null,serializationMode) : null, "daprConfig" ,container.Add );
            AddIf( null != this._resourceConfig ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) this._resourceConfig.ToJson(null,serializationMode) : null, "resourceConfig" ,container.Add );
            ...
            AddIf( null != this._vnetImagePullEnabled ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean((bool)this._vnetImagePullEnabled) : null, "vnetImagePullEnabled" ,container.Add );
            AddIf( null != this._vnetContentShareEnabled ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean((bool)this._vnetContentShareEnabled) : null, "vnetContentShareEnabled" ,container.Add );
            AddIf( null != this._vnetBackupRestoreEnabled ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean((bool)this._vnetBackupRestoreEnabled) : null, "vnetBackupRestoreEnabled" ,container.Add );
            AddIf( null != (((object)this._workloadProfileName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString(this._workloadProfileName.ToString()) : null, "workloadProfileName" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != this._endToEndEncryptionEnabled ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonBoolean((bool)this._endToEndEncryptionEnabled) : null, "endToEndEncryptionEnabled" ,container.Add );
            ...
            AddIf( null != (((object)this._managedEnvironmentId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Functions.Runtime.Json.JsonString(this._managedEnvironmentId.ToString()) : null, "managedEnvironmentId" ,container.Add );
