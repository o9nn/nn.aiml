...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzAppConfigurationStore_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConfigurationStoresGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
