...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support
{
        ...
        System.IEquatable<ParameterType>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType Array = @"array";

        /// <summary>The parameter accepts a boolean value.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType Boolean = @"boolean";

        /// <summary>The parameter accepts an integer value.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType Integer = @"integer";

        /// <summary>The parameter accepts a number value.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType Number = @"number";

        /// <summary>The parameter accepts an object value.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType Object = @"object";

        /// <summary>The parameter accepts a string value.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType String = @"string";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType e1, Microsoft.Azure.PowerShell.Cmdlets.DevCenter.Support.ParameterType e2)
        {
            return !e2.Equals(e1);
        }
