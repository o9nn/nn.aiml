...
namespace Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models
{
    ...
    public partial class LinkableEnvironmentRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.ILinkableEnvironmentRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.ILinkableEnvironmentRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Models.ILinkableEnvironmentRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonNode node)
        {
        ...
        internal LinkableEnvironmentRequest(Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonObject json)
        {
            ...
            {_userPrincipal = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonString>("userPrincipal"), out var __jsonUserPrincipal) ? (string)__jsonUserPrincipal : (string)_userPrincipal;}
            {_region = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DynatraceObservability.Runtime.Json.JsonString>("region"), out var __jsonRegion) ? (string)__jsonRegion : (string)_region;}
            AfterFromJson(json);
        }
