...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models
{
    ...
    public partial class AssignmentReportResourceComplianceReason
    {
        ...
        internal AssignmentReportResourceComplianceReason(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_phrase = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("phrase"), out var __jsonPhrase) ? (string)__jsonPhrase : (string)_phrase;}
            {_code = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("code"), out var __jsonCode) ? (string)__jsonCode : (string)_code;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IAssignmentReportResourceComplianceReason.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IAssignmentReportResourceComplianceReason.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.IAssignmentReportResourceComplianceReason FromJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode node)
        {
