...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class SkypeChannelProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISkypeChannelProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISkypeChannelProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ISkypeChannelProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
        ...
        internal SkypeChannelProperties(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_enableMessaging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableMessaging"), out var __jsonEnableMessaging) ? (bool?)__jsonEnableMessaging : _enableMessaging;}
            {_enableMediaCard = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableMediaCards"), out var __jsonEnableMediaCards) ? (bool?)__jsonEnableMediaCards : _enableMediaCard;}
            {_enableVideo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableVideo"), out var __jsonEnableVideo) ? (bool?)__jsonEnableVideo : _enableVideo;}
            ...
            {_enableScreenSharing = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableScreenSharing"), out var __jsonEnableScreenSharing) ? (bool?)__jsonEnableScreenSharing : _enableScreenSharing;}
            {_enableGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonBoolean>("enableGroups"), out var __jsonEnableGroups) ? (bool?)__jsonEnableGroups : _enableGroup;}
            {_groupsMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("groupsMode"), out var __jsonGroupsMode) ? (string)__jsonGroupsMode : (string)_groupsMode;}
