...
namespace Microsoft.Azure.PowerShell.Cmdlets.BotService.Models
{
    ...
    public partial class ConnectionSettingProperties
    {
        ...
        internal ConnectionSettingProperties(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonObject json)
        {
            ...
            {_settingId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("settingId"), out var __jsonSettingId) ? (string)__jsonSettingId : (string)_settingId;}
            ...
            {_serviceProviderId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("serviceProviderId"), out var __jsonServiceProviderId) ? (string)__jsonServiceProviderId : (string)_serviceProviderId;}
            {_serviceProviderDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonString>("serviceProviderDisplayName"), out var __jsonServiceProviderDisplayName) ? (string)__jsonServiceProviderDisplayName : (string)_serviceProviderDisplayName;}
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonArray>("parameters"), out var __jsonParameters) ? If( __jsonParameters as Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IConnectionSettingParameter>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IConnectionSettingParameter) (Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.ConnectionSettingParameter.FromJson(__u) )) ))() : null : _parameter;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IConnectionSettingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IConnectionSettingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BotService.Models.IConnectionSettingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.BotService.Runtime.Json.JsonNode node)
        {
