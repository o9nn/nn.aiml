...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"update a data network. Must be created in the same location as its parent mobile network.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzMobileNetworkDataNetwork_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.UpdateAzMobileNetworkDataNetwork_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzMobileNetworkDataNetwork_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.DataNetworksGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DataNetworksCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.DataNetworksGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MobileNetworkName ?? null, InputObject.DataNetworkName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DataNetworksCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MobileNetworkName ?? null, InputObject.DataNetworkName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMobileNetworkDataNetwork_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
