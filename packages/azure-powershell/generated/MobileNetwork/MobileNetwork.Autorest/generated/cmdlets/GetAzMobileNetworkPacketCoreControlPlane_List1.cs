...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMobileNetworkPacketCoreControlPlane_List1" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PacketCoreControlPlanesListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
