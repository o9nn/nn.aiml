...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/services/{serviceName}"
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Description(@"update a service. Must be created in the same location as its parent mobile network.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Generated]
    public partial class UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IService _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Service();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The set of data flow policy rules that make up this service.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPccRuleConfiguration[] PccRule { get => _parametersBody.PccRule?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.PccRule = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPccRuleConfiguration>(value) : null); }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A precedence value that is used to decide between services when identifying the QoS values to use for a particular SIM. A lower value means a higher priority. This value should be unique among all services configured in the mobile network.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ServiceQoPolicyPreemptionCapability { get => _parametersBody.QoPolicyPreemptionCapability ?? null; set => _parametersBody.QoPolicyPreemptionCapability = value; }
        ...
        public string ServiceQoPolicyPreemptionVulnerability { get => _parametersBody.QoPolicyPreemptionVulnerability ?? null; set => _parametersBody.QoPolicyPreemptionVulnerability = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Cmdlets.UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded Clone()
        {
            var clone = new UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (MobileNetworkInputObject?.Id != null)
                    {
                        ...
                        _parametersBody = await this.Client.ServicesGetViaIdentityWithResult(MobileNetworkInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ServicesCreateOrUpdateViaIdentity(MobileNetworkInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ServicesGetWithResult(MobileNetworkInputObject.SubscriptionId ?? null, MobileNetworkInputObject.ResourceGroupName ?? null, MobileNetworkInputObject.MobileNetworkName ?? null, Name, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ServicesCreateOrUpdate(MobileNetworkInputObject.SubscriptionId ?? null, MobileNetworkInputObject.ResourceGroupName ?? null, MobileNetworkInputObject.MobileNetworkName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzMobileNetworkService_UpdateViaIdentityMobileNetworkExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServicePrecedence")))
            {
                this.ServicePrecedence = (int)(this.MyInvocation?.BoundParameters["ServicePrecedence"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("PccRule")))
            {
                this.PccRule = (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.IPccRuleConfiguration[])(this.MyInvocation?.BoundParameters["PccRule"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServiceQoPolicyPreemptionCapability")))
            {
                this.ServiceQoPolicyPreemptionCapability = (string)(this.MyInvocation?.BoundParameters["ServiceQoPolicyPreemptionCapability"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServiceQoPolicyPreemptionVulnerability")))
            {
                this.ServiceQoPolicyPreemptionVulnerability = (string)(this.MyInvocation?.BoundParameters["ServiceQoPolicyPreemptionVulnerability"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServiceQoPolicyFiveQi")))
            {
                this.ServiceQoPolicyFiveQi = (int)(this.MyInvocation?.BoundParameters["ServiceQoPolicyFiveQi"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ServiceQoPolicyAllocationAndRetentionPriorityLevel")))
            {
                this.ServiceQoPolicyAllocationAndRetentionPriorityLevel = (int)(this.MyInvocation?.BoundParameters["ServiceQoPolicyAllocationAndRetentionPriorityLevel"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaximumBitRateUplink")))
            {
                this.MaximumBitRateUplink = (string)(this.MyInvocation?.BoundParameters["MaximumBitRateUplink"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaximumBitRateDownlink")))
            {
                this.MaximumBitRateDownlink = (string)(this.MyInvocation?.BoundParameters["MaximumBitRateDownlink"]);
            }
        }
