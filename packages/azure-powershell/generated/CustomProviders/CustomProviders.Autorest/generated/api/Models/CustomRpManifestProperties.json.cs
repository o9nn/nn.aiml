...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models
{
    ...
    public partial class CustomRpManifestProperties
    {
        ...
        internal CustomRpManifestProperties(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonObject json)
        {
            ...
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray>("actions"), out var __jsonActions) ? If( __jsonActions as Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpActionRouteDefinition>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpActionRouteDefinition) (Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.CustomRpActionRouteDefinition.FromJson(__u) )) ))() : null : _action;}
            {_resourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray>("resourceTypes"), out var __jsonResourceTypes) ? If( __jsonResourceTypes as Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpResourceTypeRouteDefinition>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpResourceTypeRouteDefinition) (Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.CustomRpResourceTypeRouteDefinition.FromJson(__p) )) ))() : null : _resourceType;}
            {_validation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray>("validations"), out var __jsonValidations) ? If( __jsonValidations as Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpValidations>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpValidations) (Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.CustomRpValidations.FromJson(__k) )) ))() : null : _validation;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpManifestProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpManifestProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpManifestProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode node)
        {
