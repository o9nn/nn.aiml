...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models
{
    ...
    public partial class CustomRpValidations
    {
        ...
        internal CustomRpValidations(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonObject json)
        {
            ...
            {_validationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonString>("validationType"), out var __jsonValidationType) ? (string)__jsonValidationType : (string)_validationType;}
            {_specification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonString>("specification"), out var __jsonSpecification) ? (string)__jsonSpecification : (string)_specification;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpValidations.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpValidations.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Models.ICustomRpValidations FromJson(Microsoft.Azure.PowerShell.Cmdlets.CustomProviders.Runtime.Json.JsonNode node)
        {
