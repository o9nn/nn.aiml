...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models
{
    ...
    public partial class DeidService
    {
        ...
        internal DeidService(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Runtime.Json.JsonObject json)
        {
            ...
            __trackedResource = new Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.TrackedResource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.DeidServiceProperties.FromJson(__jsonProperties) : _property;}
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.ManagedServiceIdentity.FromJson(__jsonIdentity) : _identity;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.IDeidService.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.IDeidService.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Models.IDeidService FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAIServices.Runtime.Json.JsonNode node)
        {
