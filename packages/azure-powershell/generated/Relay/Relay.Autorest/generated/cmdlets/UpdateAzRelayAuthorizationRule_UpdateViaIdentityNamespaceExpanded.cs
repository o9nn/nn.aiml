...
namespace Microsoft.Azure.PowerShell.Cmdlets.Relay.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRelayAuthorizationRule_UpdateViaIdentityNamespaceExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRelayAuthorizationRule_UpdateViaIdentityNamespaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.NamespaceInputObject.Id += $"/wcfRelays/{(global::System.Uri.EscapeDataString(this.WcfRelay.ToString()))}/authorizationRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _parametersBody = await this.Client.AuthorizationRuleGet2ViaIdentityWithResult(NamespaceInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.AuthorizationRuleCreateOrUpdate2ViaIdentity(NamespaceInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.AuthorizationRuleGet2WithResult(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, WcfRelay, Name, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.AuthorizationRuleCreateOrUpdate2(NamespaceInputObject.SubscriptionId ?? null, NamespaceInputObject.ResourceGroupName ?? null, NamespaceInputObject.NamespaceName ?? null, WcfRelay, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.Relay.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRelayAuthorizationRule_UpdateViaIdentityNamespaceExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzRelayAuthorizationRule_UpdateViaIdentityNamespaceExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Rights")))
            {
                this.Rights = (string[])(this.MyInvocation?.BoundParameters["Rights"]);
            }
        }
