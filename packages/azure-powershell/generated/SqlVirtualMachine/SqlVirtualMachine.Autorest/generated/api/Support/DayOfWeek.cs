...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Everyday = @"Everyday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Friday = @"Friday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Monday = @"Monday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Saturday = @"Saturday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Sunday = @"Sunday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Thursday = @"Thursday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Tuesday = @"Tuesday";

        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek Wednesday = @"Wednesday";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.DayOfWeek e)
        {
            return e._value;
        }
