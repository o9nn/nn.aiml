...
using Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime.JsonSerializable.ToJson(dict, null);
            }
