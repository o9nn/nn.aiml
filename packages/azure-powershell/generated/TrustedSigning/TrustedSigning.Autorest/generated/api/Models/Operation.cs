...
namespace Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models
{
    ...
    public partial class Operation :
        Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperation,
        Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplay _display;

        /// <summary>Localized display information for this particular operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Origin(Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.OperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Description; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Origin(Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Operation; }

        /// <summary>
        /// The localized friendly form of the resource provider name, e.g. "Microsoft Monitoring Insights" or "Microsoft Compute".
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Origin(Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Provider; }

        /// <summary>
        /// The localized friendly name of the resource type related to this operation. E.g. "Virtual Machines" or "Job Schedule Collections".
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Origin(Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Resource; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.ActionType { get => this._actionType; set { {_actionType = value;} } }

        /// <summary>Internal Acessors for Display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.OperationDisplay()); set { {_display = value;} } }

        /// <summary>Internal Acessors for DisplayDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Description = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Provider = value; }

        /// <summary>Internal Acessors for DisplayResource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplayInternal)Display).Resource = value; }

        /// <summary>Internal Acessors for IsDataAction</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.IsDataAction { get => this._isDataAction; set { {_isDataAction = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationInternal.Origin { get => this._origin; set { {_origin = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PSArgumentCompleterAttribute("Internal")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.PSArgumentCompleterAttribute("user", "system", "user,system")]
        string Origin { get;  }
...

    {
        ...
        /// <summary>Localized display information for this particular operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperationDisplay Display { get; set; }
        /// <summary>
        /// The short, localized friendly description of the operation; suitable for tool tips and detailed views.
        /// </summary>
