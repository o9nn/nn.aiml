...
.Link
https://learn.microsoft.com/powershell/module/az.trustedsigning/get-aztrustedsigningoperation
#>
function Get-AzTrustedSigningOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.TrustedSigning.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.TrustedSigning.private\Get-AzTrustedSigningOperation_List';
        }
