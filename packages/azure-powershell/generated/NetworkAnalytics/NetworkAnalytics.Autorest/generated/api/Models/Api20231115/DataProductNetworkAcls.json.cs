...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115
{
    ...
    public partial class DataProductNetworkAcls
    {
        ...
        internal DataProductNetworkAcls(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_virtualNetworkRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray>("virtualNetworkRule"), out var __jsonVirtualNetworkRule) ? If( __jsonVirtualNetworkRule as Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IVirtualNetworkRule[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IVirtualNetworkRule) (Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.VirtualNetworkRule.FromJson(__u) )) ))() : null : VirtualNetworkRule;}
            {_iPRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray>("ipRules"), out var __jsonIPRules) ? If( __jsonIPRules as Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IIPRules[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IIPRules) (Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IPRules.FromJson(__p) )) ))() : null : IPRule;}
            {_allowedQueryIPRangeList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray>("allowedQueryIpRangeList"), out var __jsonAllowedQueryIPRangeList) ? If( __jsonAllowedQueryIPRangeList as Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : AllowedQueryIPRangeList;}
            {_defaultAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonString>("defaultAction"), out var __jsonDefaultAction) ? (string)__jsonDefaultAction : (string)DefaultAction;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IDataProductNetworkAcls.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IDataProductNetworkAcls.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IDataProductNetworkAcls FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonNode node)
        {
