...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Description(@"update a task run for a container registry with the specified parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Generated]
    public partial class UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded Clone()
        {
            var clone = new UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded();
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _taskRunBody?.IdentityType?.Contains("SystemAssigned"));
            ...
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _taskRunBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _taskRunBody.IdentityUserAssignedIdentity = null;
            }
            ...
            {
                _taskRunBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _taskRunBody.IdentityType = "None";
            }
        }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (RegistryInputObject?.Id != null)
                    {
                        ...
                        _taskRunBody = await this.Client.TaskRunsGetViaIdentityWithResult(RegistryInputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_taskRunBody();
                        await this.Client.TaskRunsCreateViaIdentity(RegistryInputObject.Id, _taskRunBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _taskRunBody = await this.Client.TaskRunsGetWithResult(RegistryInputObject.SubscriptionId ?? null, RegistryInputObject.ResourceGroupName ?? null, RegistryInputObject.RegistryName ?? null, Name, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_taskRunBody();
                        await this.Client.TaskRunsCreate(RegistryInputObject.SubscriptionId ?? null, RegistryInputObject.ResourceGroupName ?? null, RegistryInputObject.RegistryName ?? null, Name, _taskRunBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzContainerRegistryTaskRun_UpdateViaIdentityRegistryExpanded()
        {

        }

        private void Update_taskRunBody()
        {
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RunRequestType")))
            {
                this.RunRequestType = (string)(this.MyInvocation?.BoundParameters["RunRequestType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RunRequestLogTemplate")))
            {
                this.RunRequestLogTemplate = (string)(this.MyInvocation?.BoundParameters["RunRequestLogTemplate"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RunRequestIsArchiveEnabled")))
            {
                this.RunRequestIsArchiveEnabled = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["RunRequestIsArchiveEnabled"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RunRequestAgentPoolName")))
            {
                this.RunRequestAgentPoolName = (string)(this.MyInvocation?.BoundParameters["RunRequestAgentPoolName"]);
            }
        }
