...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryIdentity
    {
        ...
        internal ContainerRegistryIdentity(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)_subscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)_resourceGroupName;}
            {_registryName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("registryName"), out var __jsonRegistryName) ? (string)__jsonRegistryName : (string)_registryName;}
            {_cacheRuleName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("cacheRuleName"), out var __jsonCacheRuleName) ? (string)__jsonCacheRuleName : (string)_cacheRuleName;}
            {_connectedRegistryName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("connectedRegistryName"), out var __jsonConnectedRegistryName) ? (string)__jsonConnectedRegistryName : (string)_connectedRegistryName;}
            {_credentialSetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("credentialSetName"), out var __jsonCredentialSetName) ? (string)__jsonCredentialSetName : (string)_credentialSetName;}
            {_exportPipelineName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("exportPipelineName"), out var __jsonExportPipelineName) ? (string)__jsonExportPipelineName : (string)_exportPipelineName;}
            {_groupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("groupName"), out var __jsonGroupName) ? (string)__jsonGroupName : (string)_groupName;}
            {_importPipelineName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("importPipelineName"), out var __jsonImportPipelineName) ? (string)__jsonImportPipelineName : (string)_importPipelineName;}
            {_pipelineRunName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("pipelineRunName"), out var __jsonPipelineRunName) ? (string)__jsonPipelineRunName : (string)_pipelineRunName;}
            {_privateEndpointConnectionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("privateEndpointConnectionName"), out var __jsonPrivateEndpointConnectionName) ? (string)__jsonPrivateEndpointConnectionName : (string)_privateEndpointConnectionName;}
            {_replicationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("replicationName"), out var __jsonReplicationName) ? (string)__jsonReplicationName : (string)_replicationName;}
            {_scopeMapName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("scopeMapName"), out var __jsonScopeMapName) ? (string)__jsonScopeMapName : (string)_scopeMapName;}
            {_tokenName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("tokenName"), out var __jsonTokenName) ? (string)__jsonTokenName : (string)_tokenName;}
            {_webhookName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("webhookName"), out var __jsonWebhookName) ? (string)__jsonWebhookName : (string)_webhookName;}
            ...
            {_taskRunName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("taskRunName"), out var __jsonTaskRunName) ? (string)__jsonTaskRunName : (string)_taskRunName;}
