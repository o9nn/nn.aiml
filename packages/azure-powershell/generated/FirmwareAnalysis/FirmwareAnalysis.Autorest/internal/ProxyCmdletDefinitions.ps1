...
.Link
https://learn.microsoft.com/powershell/module/az.firmwareanalysis/get-azfirmwareanalysisoperation
#>
function Get-AzFirmwareAnalysisOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FirmwareAnalysis.Models.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.FirmwareAnalysis.private\Get-AzFirmwareAnalysisOperation_List';
        }
