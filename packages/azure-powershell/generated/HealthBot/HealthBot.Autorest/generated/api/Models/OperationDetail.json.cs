...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models
{
    ...
    public partial class OperationDetail
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.IOperationDetail.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.IOperationDetail.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.IOperationDetail FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonNode node)
        {
        ...
        internal OperationDetail(Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.OperationDisplay.FromJson(__jsonDisplay) : _display;}
            ...
            {_isDataAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonBoolean>("isDataAction"), out var __jsonIsDataAction) ? (bool?)__jsonIsDataAction : _isDataAction;}
            {_origin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonString>("origin"), out var __jsonOrigin) ? (string)__jsonOrigin : (string)_origin;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.HealthBot.Models.Any.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }
