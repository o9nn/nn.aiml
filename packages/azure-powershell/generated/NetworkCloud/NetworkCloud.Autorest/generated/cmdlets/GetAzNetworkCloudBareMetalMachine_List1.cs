...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNetworkCloudBareMetalMachine_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Get a list of bare metal machines in the provided resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines", ApiVersion = "2025-02-01")]
    public partial class GetAzNetworkCloudBareMetalMachine_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzNetworkCloudBareMetalMachine_List1" /> cmdlet class.
        /// </summary>
        public GetAzNetworkCloudBareMetalMachine_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.BareMetalMachinesListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.BareMetalMachinesListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
