...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/trunkedNetworks/{trunkedNetworkName}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Description(@"Get properties of the provided trunked network.")]
    ...
    public partial class GetAzNetworkCloudTrunkedNetwork_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzNetworkCloudTrunkedNetwork_Get" /> cmdlet class.
        /// </summary>
        public GetAzNetworkCloudTrunkedNetwork_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TrunkedNetworksGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
