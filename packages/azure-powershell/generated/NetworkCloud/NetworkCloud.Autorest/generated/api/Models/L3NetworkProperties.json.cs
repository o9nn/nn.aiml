...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class L3NetworkProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IL3NetworkProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IL3NetworkProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IL3NetworkProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode node)
        {
        ...
        internal L3NetworkProperties(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject json)
        {
            ...
            {_hybridAksIpamEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("hybridAksIpamEnabled"), out var __jsonHybridAksIpamEnabled) ? (string)__jsonHybridAksIpamEnabled : (string)_hybridAksIpamEnabled;}
            ...
            {_iPAllocationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipAllocationType"), out var __jsonIPAllocationType) ? (string)__jsonIPAllocationType : (string)_iPAllocationType;}
            {_ipv4ConnectedPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipv4ConnectedPrefix"), out var __jsonIpv4ConnectedPrefix) ? (string)__jsonIpv4ConnectedPrefix : (string)_ipv4ConnectedPrefix;}
            {_ipv6ConnectedPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("ipv6ConnectedPrefix"), out var __jsonIpv6ConnectedPrefix) ? (string)__jsonIpv6ConnectedPrefix : (string)_ipv6ConnectedPrefix;}
            {_l3IsolationDomainId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonString>("l3IsolationDomainId"), out var __jsonL3IsolationDomainId) ? (string)__jsonL3IsolationDomainId : (string)_l3IsolationDomainId;}
            ...
            {_vlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNumber>("vlan"), out var __jsonVlan) ? (long?)__jsonVlan : _vlan;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeRead)||serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.SerializationMode.IncludeCreate))
            {
                AddIf( null != this._vlan ? (Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Runtime.Json.JsonNumber((long)this._vlan) : null, "vlan" ,container.Add );
            }
