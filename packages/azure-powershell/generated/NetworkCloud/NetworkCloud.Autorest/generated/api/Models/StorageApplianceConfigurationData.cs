...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models
{
    ...
    public partial class StorageApplianceConfigurationData :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceConfigurationDataInternal
    {

        /// <summary>Backing field for <see cref="AdminCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentials _adminCredentials;

        /// <summary>
        /// The credentials of the administrative interface on this storage appliance. The password field is expected to be an Azure
        /// Key Vault key URL. Until the cluster is converted to utilize managed identity by setting the secret archive settings,
        /// the actual password value should be provided instead.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentials AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AdministrativeCredentials()); set => this._adminCredentials = value; }
        ...
        public System.Security.SecureString AdminCredentialsPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentialsInternal)AdminCredentials).Password; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentialsInternal)AdminCredentials).Password = value ; }

        /// <summary>The username of the administrator of the device used during initialization.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Origin(Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.PropertyOrigin.Inlined)]
        public string AdminCredentialsUsername { get => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentialsInternal)AdminCredentials).Username; set => ((Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentialsInternal)AdminCredentials).Username = value ; }

        /// <summary>Internal Acessors for AdminCredentials</summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentials Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IStorageApplianceConfigurationDataInternal.AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.AdministrativeCredentials()); set { {_adminCredentials = value;} } }
...

    {
        ...
        /// the actual password value should be provided instead.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.NetworkCloud.Models.IAdministrativeCredentials AdminCredentials { get; set; }
        /// <summary>The password of the administrator of the device used during initialization.</summary>
        System.Security.SecureString AdminCredentialsPassword { get; set; }
        /// <summary>The username of the administrator of the device used during initialization.</summary>
        string AdminCredentialsUsername { get; set; }
