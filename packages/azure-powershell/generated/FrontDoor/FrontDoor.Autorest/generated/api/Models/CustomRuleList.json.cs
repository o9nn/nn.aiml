...
namespace Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models
{
    ...
    public partial class CustomRuleList
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject into a new instance of <see cref="CustomRuleList" />.
        /// </summary>
        ...
        internal CustomRuleList(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json)
        {
            ...
            {_rule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonArray>("rules"), out var __jsonRules) ? If( __jsonRules as Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ICustomRule>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ICustomRule) (Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.CustomRule.FromJson(__u) )) ))() : null : _rule;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ICustomRuleList.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ICustomRuleList.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ICustomRuleList FromJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json ? new CustomRuleList(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CustomRuleList" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CustomRuleList" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </returns>
