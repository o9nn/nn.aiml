...
namespace Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models
{
    ...
    public partial class RulesEngineRule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRulesEngineRule.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRulesEngineRule.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRulesEngineRule FromJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json ? new RulesEngineRule(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject into a new instance of <see cref="RulesEngineRule" />.
        /// </summary>
        ...
        internal RulesEngineRule(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json)
        {
            ...
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject>("action"), out var __jsonAction) ? Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.RulesEngineAction.FromJson(__jsonAction) : _action;}
            {_matchCondition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonArray>("matchConditions"), out var __jsonMatchConditions) ? If( __jsonMatchConditions as Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRulesEngineMatchCondition>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IRulesEngineMatchCondition) (Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.RulesEngineMatchCondition.FromJson(__u) )) ))() : null : _matchCondition;}
            {_matchProcessingBehavior = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonString>("matchProcessingBehavior"), out var __jsonMatchProcessingBehavior) ? (string)__jsonMatchProcessingBehavior : (string)_matchProcessingBehavior;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RulesEngineRule" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RulesEngineRule" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._action ? (Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode) this._action.ToJson(null,serializationMode) : null, "action" ,container.Add );
            ...
            AddIf( null != (((object)this._matchProcessingBehavior)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonString(this._matchProcessingBehavior.ToString()) : null, "matchProcessingBehavior" ,container.Add );
