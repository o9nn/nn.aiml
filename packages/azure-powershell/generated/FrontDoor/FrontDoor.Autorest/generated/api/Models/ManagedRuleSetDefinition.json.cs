...
namespace Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models
{
    ...
    public partial class ManagedRuleSetDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IManagedRuleSetDefinition.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IManagedRuleSetDefinition.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.IManagedRuleSetDefinition FromJson(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json ? new ManagedRuleSetDefinition(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject into a new instance of <see cref="ManagedRuleSetDefinition" />.
        /// </summary>
        ...
        internal ManagedRuleSetDefinition(Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Models.ManagedRuleSetDefinitionProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ManagedRuleSetDefinition" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ManagedRuleSetDefinition" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FrontDoor.Runtime.Json.JsonNode" />.
        /// </returns>
