...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.StreamAnalytics/streamingjobs", ApiVersion = "2017-04-01-preview")]
    public partial class GetAzStreamAnalyticsJob_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStreamAnalyticsJob_List1" /> cmdlet class.
        /// </summary>
        public GetAzStreamAnalyticsJob_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StreamingJobsList(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.StreamingJobsList_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
