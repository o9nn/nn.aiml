...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models
{
    ...
    public partial class DocumentDbOutputDataSourceProperties
    {
        ...
        internal DocumentDbOutputDataSourceProperties(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_accountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("accountId"), out var __jsonAccountId) ? (string)__jsonAccountId : (string)_accountId;}
            {_accountKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("accountKey"), out var __jsonAccountKey) ? (string)__jsonAccountKey : (string)_accountKey;}
            ...
            {_collectionNamePattern = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("collectionNamePattern"), out var __jsonCollectionNamePattern) ? (string)__jsonCollectionNamePattern : (string)_collectionNamePattern;}
            ...
            {_documentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("documentId"), out var __jsonDocumentId) ? (string)__jsonDocumentId : (string)_documentId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IDocumentDbOutputDataSourceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IDocumentDbOutputDataSourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IDocumentDbOutputDataSourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode node)
        {
