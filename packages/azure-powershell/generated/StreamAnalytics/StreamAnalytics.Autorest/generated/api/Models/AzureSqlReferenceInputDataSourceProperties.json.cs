...
namespace Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models
{
    ...
    public partial class AzureSqlReferenceInputDataSourceProperties
    {
        ...
        internal AzureSqlReferenceInputDataSourceProperties(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_refreshType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("refreshType"), out var __jsonRefreshType) ? (string)__jsonRefreshType : (string)_refreshType;}
            {_refreshRate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("refreshRate"), out var __jsonRefreshRate) ? (string)__jsonRefreshRate : (string)_refreshRate;}
            {_fullSnapshotQuery = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("fullSnapshotQuery"), out var __jsonFullSnapshotQuery) ? (string)__jsonFullSnapshotQuery : (string)_fullSnapshotQuery;}
            {_deltaSnapshotQuery = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonString>("deltaSnapshotQuery"), out var __jsonDeltaSnapshotQuery) ? (string)__jsonDeltaSnapshotQuery : (string)_deltaSnapshotQuery;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IAzureSqlReferenceInputDataSourceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IAzureSqlReferenceInputDataSourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.IAzureSqlReferenceInputDataSourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Runtime.Json.JsonNode node)
        {
