...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class GitLabGroupProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal.FullyQualifiedFriendlyName { get => this._fullyQualifiedFriendlyName; set { {_fullyQualifiedFriendlyName = value;} } }

        /// <summary>Internal Acessors for FullyQualifiedName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal.FullyQualifiedName { get => this._fullyQualifiedName; set { {_fullyQualifiedName = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatusMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal.ProvisioningStatusMessage { get => this._provisioningStatusMessage; set { {_provisioningStatusMessage = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatusUpdateTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal.ProvisioningStatusUpdateTimeUtc { get => this._provisioningStatusUpdateTimeUtc; set { {_provisioningStatusUpdateTimeUtc = value;} } }

        /// <summary>Internal Acessors for Url</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IGitLabGroupPropertiesInternal.Url { get => this._url; set { {_url = value;} } }
