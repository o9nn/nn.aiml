...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class InformationProtectionAwsOffering
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IInformationProtectionAwsOffering.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IInformationProtectionAwsOffering.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IInformationProtectionAwsOffering FromJson(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject json ? new InformationProtectionAwsOffering(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject into a new instance of <see cref="InformationProtectionAwsOffering" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal InformationProtectionAwsOffering(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject json)
        {
            ...
            {_informationProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject>("informationProtection"), out var __jsonInformationProtection) ? Microsoft.Azure.PowerShell.Cmdlets.Security.Models.InformationProtectionAwsOfferingInformationProtection.FromJson(__jsonInformationProtection) : _informationProtection;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="InformationProtectionAwsOffering" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="InformationProtectionAwsOffering" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._informationProtection ? (Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Json.JsonNode) this._informationProtection.ToJson(null,serializationMode) : null, "informationProtection" ,container.Add );
