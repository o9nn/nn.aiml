...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
    ...
    public partial class AzureDevOpsScopeEnvironment :
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsScopeEnvironment,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IAzureDevOpsScopeEnvironmentInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IValidates
    {
        ...
        public string EnvironmentType { get => "AzureDevOpsScope"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Security.Models.ISecurityConnectorEnvironmentInternal)__securityConnectorEnvironment).EnvironmentType = "AzureDevOpsScope"; }

        /// <summary>Creates an new <see cref="AzureDevOpsScopeEnvironment" /> instance.</summary>
        public AzureDevOpsScopeEnvironment()
        {
            this.__securityConnectorEnvironment.EnvironmentType = "AzureDevOpsScope";
        }
    ...
    /// The AzureDevOps scope connector's environment data
    internal partial interface IAzureDevOpsScopeEnvironmentInternal :
