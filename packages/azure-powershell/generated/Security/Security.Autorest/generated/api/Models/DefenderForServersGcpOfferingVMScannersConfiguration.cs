...
namespace Microsoft.Azure.PowerShell.Cmdlets.Security.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersGcpOfferingVMScannersConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersGcpOfferingVMScannersConfigurationExclusionTags _exclusionTag;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersGcpOfferingVMScannersConfigurationExclusionTags ExclusionTag { get => (this._exclusionTag = this._exclusionTag ?? new Microsoft.Azure.PowerShell.Cmdlets.Security.Models.DefenderForServersGcpOfferingVMScannersConfigurationExclusionTags()); set => this._exclusionTag = value; }
        ...
        /// <summary>
        /// Creates an new <see cref="DefenderForServersGcpOfferingVMScannersConfiguration" /> instance.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Security.Models.IDefenderForServersGcpOfferingVMScannersConfigurationExclusionTags ExclusionTag { get; set; }
        /// <summary>The scanning mode for the VM scan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Security.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// configuration for Microsoft Defender for Server VM scanning
    internal partial interface IDefenderForServersGcpOfferingVMScannersConfigurationInternal
