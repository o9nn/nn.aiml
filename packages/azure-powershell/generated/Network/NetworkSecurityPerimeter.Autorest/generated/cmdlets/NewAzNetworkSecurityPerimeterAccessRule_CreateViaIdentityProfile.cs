            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProfileInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NetworkSecurityPerimeterAccessRulesCreateOrUpdateViaIdentity(ProfileInputObject.Id, Parameter, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.NetworkSecurityPerimeter.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
