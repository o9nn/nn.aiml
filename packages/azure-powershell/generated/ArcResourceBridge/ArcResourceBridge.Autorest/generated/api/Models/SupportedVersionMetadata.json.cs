...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models
{
    ...
    public partial class SupportedVersionMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ISupportedVersionMetadata.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ISupportedVersionMetadata.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.ISupportedVersionMetadata FromJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json ? new SupportedVersionMetadata(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject into a new instance of <see cref="SupportedVersionMetadata" />.
        /// </summary>
        ...
        internal SupportedVersionMetadata(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject json)
        {
            ...
            {_catalogVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject>("catalogVersion"), out var __jsonCatalogVersion) ? Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.SupportedVersionCatalogVersion.FromJson(__jsonCatalogVersion) : _catalogVersion;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SupportedVersionMetadata" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SupportedVersionMetadata" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._catalogVersion ? (Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Runtime.Json.JsonNode) this._catalogVersion.ToJson(null,serializationMode) : null, "catalogVersion" ,container.Add );
            }
