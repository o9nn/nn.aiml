...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models
{
    ...
    public partial class HybridConnectionConfig :
        Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfig,
        Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfigInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfigInternal.ExpirationTime { get => this._expirationTime; set { {_expirationTime = value;} } }

        /// <summary>Internal Acessors for HybridConnectionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfigInternal.HybridConnectionName { get => this._hybridConnectionName; set { {_hybridConnectionName = value;} } }

        /// <summary>Internal Acessors for Relay</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfigInternal.Relay { get => this._relay; set { {_relay = value;} } }

        /// <summary>Internal Acessors for Token</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcResourceBridge.Models.IHybridConnectionConfigInternal.Token { get => this._token; set { {_token = value;} } }
