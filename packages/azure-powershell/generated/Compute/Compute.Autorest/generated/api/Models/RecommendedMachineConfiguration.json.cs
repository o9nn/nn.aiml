...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class RecommendedMachineConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRecommendedMachineConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRecommendedMachineConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IRecommendedMachineConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json ? new RecommendedMachineConfiguration(json) : null;
        }
        ...
        internal RecommendedMachineConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_vCpUs = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("vCPUs"), out var __jsonVCpUs) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ResourceRange.FromJson(__jsonVCpUs) : _vCpUs;}
            {_memory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("memory"), out var __jsonMemory) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ResourceRange.FromJson(__jsonMemory) : _memory;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RecommendedMachineConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RecommendedMachineConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._vCpUs ? (Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode) this._vCpUs.ToJson(null,serializationMode) : null, "vCPUs" ,container.Add );
            AddIf( null != this._memory ? (Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode) this._memory.ToJson(null,serializationMode) : null, "memory" ,container.Add );
