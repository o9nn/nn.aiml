...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class GalleryApplicationVersionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IGalleryApplicationVersionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
        ...
        internal GalleryApplicationVersionProperties(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_publishingProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("publishingProfile"), out var __jsonPublishingProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.GalleryApplicationVersionPublishingProfile.FromJson(__jsonPublishingProfile) : _publishingProfile;}
            {_replicationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("replicationStatus"), out var __jsonReplicationStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.ReplicationStatus.FromJson(__jsonReplicationStatus) : _replicationStatus;}
