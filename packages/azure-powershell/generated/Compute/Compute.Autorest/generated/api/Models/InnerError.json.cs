...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class InnerError
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IInnerError.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IInnerError.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IInnerError FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
        ...
        internal InnerError(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_exceptiontype = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("exceptiontype"), out var __jsonExceptiontype) ? (string)__jsonExceptiontype : (string)_exceptiontype;}
            {_errordetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("errordetail"), out var __jsonErrordetail) ? (string)__jsonErrordetail : (string)_errordetail;}
            AfterFromJson(json);
        }
