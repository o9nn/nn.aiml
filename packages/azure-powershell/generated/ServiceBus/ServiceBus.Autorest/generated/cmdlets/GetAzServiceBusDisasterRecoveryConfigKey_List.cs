...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzServiceBusDisasterRecoveryConfigKey_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsListKeys(SubscriptionId, ResourceGroupName, NamespaceName, Alias, AuthorizationRuleName, onOk, onDefault, this, Pipeline);
