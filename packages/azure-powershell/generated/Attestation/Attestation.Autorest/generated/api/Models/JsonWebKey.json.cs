...
namespace Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models
{
    ...
    public partial class JsonWebKey
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IJsonWebKey.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IJsonWebKey.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.IJsonWebKey FromJson(Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode node)
        {
        ...
        internal JsonWebKey(Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject json)
        {
            ...
            {_alg = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("alg"), out var __jsonAlg) ? (string)__jsonAlg : (string)_alg;}
            {_crv = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("crv"), out var __jsonCrv) ? (string)__jsonCrv : (string)_crv;}
            {_d = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("d"), out var __jsonD) ? (string)__jsonD : (string)_d;}
            {_dp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("dp"), out var __jsonDp) ? (string)__jsonDp : (string)_dp;}
            {_dq = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("dq"), out var __jsonDq) ? (string)__jsonDq : (string)_dq;}
            {_e = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("e"), out var __jsonE) ? (string)__jsonE : (string)_e;}
            {_k = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("k"), out var __jsonK) ? (string)__jsonK : (string)_k;}
            {_kid = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("kid"), out var __jsonKid) ? (string)__jsonKid : (string)_kid;}
            {_kty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("kty"), out var __jsonKty) ? (string)__jsonKty : (string)_kty;}
            {_n = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("n"), out var __jsonN) ? (string)__jsonN : (string)_n;}
            {_p = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("p"), out var __jsonP) ? (string)__jsonP : (string)_p;}
            {_q = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("q"), out var __jsonQ) ? (string)__jsonQ : (string)_q;}
            {_qi = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("qi"), out var __jsonQi) ? (string)__jsonQi : (string)_qi;}
            {_use = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("use"), out var __jsonUse) ? (string)__jsonUse : (string)_use;}
            {_x = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("x"), out var __jsonX) ? (string)__jsonX : (string)_x;}
            {_x5C = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonArray>("x5c"), out var __jsonX5C) ? If( __jsonX5C as Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _x5C;}
            {_y = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonString>("y"), out var __jsonY) ? (string)__jsonY : (string)_y;}
            AfterFromJson(json);
        }
