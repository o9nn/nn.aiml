...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    public partial class GetAzMLWorkspaceOnlineDeployment_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMLWorkspaceOnlineDeployment_Get" /> cmdlet class.
        /// </summary>
        public GetAzMLWorkspaceOnlineDeployment_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.OnlineDeploymentsGet(SubscriptionId, ResourceGroupName, WorkspaceName, EndpointName, Name, onOk, onDefault, this, Pipeline);
