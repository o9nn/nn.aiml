...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IFeaturesetVersionBackfillRequest _body;

        /// <summary>Request payload for creating a backfill request for a given feature set version</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request payload for creating a backfill request for a given feature set version", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request payload for creating a backfill request for a given feature set version",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IFeaturesetVersionBackfillRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IFeaturesetVersionBackfillRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets.InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity Clone()
        {
            var clone = new InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzMLWorkspaceBackfillFeaturesetVersion_BackfillViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FeaturesetVersionsBackfillViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FeaturesetVersionsBackfill(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.Name ?? null, InputObject.Version ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
