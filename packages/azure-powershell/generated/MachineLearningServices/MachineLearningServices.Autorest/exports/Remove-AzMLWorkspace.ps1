...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspace_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspace_DeleteViaIdentity';
        }
