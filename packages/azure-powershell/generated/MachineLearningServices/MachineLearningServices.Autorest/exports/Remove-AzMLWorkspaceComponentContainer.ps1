...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceComponentContainer_Delete';
            DeleteViaIdentity = 'Az.MachineLearningServices.private\Remove-AzMLWorkspaceComponentContainer_DeleteViaIdentity';
        }
