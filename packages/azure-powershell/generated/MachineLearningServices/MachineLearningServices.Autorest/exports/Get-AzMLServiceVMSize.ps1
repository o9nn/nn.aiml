...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Api20240401.IVirtualMachineSize])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.MachineLearningServices.private\Get-AzMLServiceVMSize_List';
        }
