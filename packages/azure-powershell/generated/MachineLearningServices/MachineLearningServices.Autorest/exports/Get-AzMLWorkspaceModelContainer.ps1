...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceModelContainer_Get';
            GetViaIdentity = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceModelContainer_GetViaIdentity';
            List = 'Az.MachineLearningServices.private\Get-AzMLWorkspaceModelContainer_List';
        }
