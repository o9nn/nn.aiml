...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models
{
    ...
    public partial class ContactInstanceProperties
    {
        ...
        internal ContactInstanceProperties(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonObject json)
        {
            ...
            {_maximumElevationDegree = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNumber>("maximumElevationDegrees"), out var __jsonMaximumElevationDegrees) ? (float?)__jsonMaximumElevationDegrees : _maximumElevationDegree;}
            {_txStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("txStartTime"), out var __jsonTxStartTime) ? global::System.DateTime.TryParse((string)__jsonTxStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTxStartTimeValue) ? __jsonTxStartTimeValue : _txStartTime : _txStartTime;}
            {_txEndTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("txEndTime"), out var __jsonTxEndTime) ? global::System.DateTime.TryParse((string)__jsonTxEndTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTxEndTimeValue) ? __jsonTxEndTimeValue : _txEndTime : _txEndTime;}
            {_rxStartTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("rxStartTime"), out var __jsonRxStartTime) ? global::System.DateTime.TryParse((string)__jsonRxStartTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonRxStartTimeValue) ? __jsonRxStartTimeValue : _rxStartTime : _rxStartTime;}
            {_rxEndTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("rxEndTime"), out var __jsonRxEndTime) ? global::System.DateTime.TryParse((string)__jsonRxEndTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonRxEndTimeValue) ? __jsonRxEndTimeValue : _rxEndTime : _rxEndTime;}
            {_startAzimuthDegree = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNumber>("startAzimuthDegrees"), out var __jsonStartAzimuthDegrees) ? (float?)__jsonStartAzimuthDegrees : _startAzimuthDegree;}
            {_endAzimuthDegree = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNumber>("endAzimuthDegrees"), out var __jsonEndAzimuthDegrees) ? (float?)__jsonEndAzimuthDegrees : _endAzimuthDegree;}
            {_startElevationDegree = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNumber>("startElevationDegrees"), out var __jsonStartElevationDegrees) ? (float?)__jsonStartElevationDegrees : _startElevationDegree;}
            {_endElevationDegree = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNumber>("endElevationDegrees"), out var __jsonEndElevationDegrees) ? (float?)__jsonEndElevationDegrees : _endElevationDegree;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContactInstanceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContactInstanceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IContactInstanceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode node)
        {
