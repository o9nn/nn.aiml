...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models
{
    ...
    public partial class OperationResult :
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResult,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal
    {
        ...
        public string Code { get => ((Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultErrorPropertiesInternal)Error).Code; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultErrorProperties _error;

        /// <summary>Operation result error properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultErrorProperties Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.OperationResultErrorProperties()); set => this._error = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultErrorProperties Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.OperationResultErrorProperties()); set { {_error = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.NextLink { get => this._nextLink; set { {_nextLink = value;} } }

        /// <summary>Internal Acessors for PercentComplete</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.PercentComplete { get => this._percentComplete; set { {_percentComplete = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny> Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultInternal.Value { get => this._value; set { {_value = value;} } }
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny> _value;

        /// <summary>A list of results when the operation returns multiple results.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Origin(Microsoft.Azure.PowerShell.Cmdlets.Orbital.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny> Value { get => this._value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.PSArgumentCompleterAttribute("Succeeded", "Canceled", "Failed", "Running")]
        string Status { get;  }
        /// <summary>A list of results when the operation returns multiple results.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny> Value { get;  }
...

    {
        ...
        /// <summary>Operation result error properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IOperationResultErrorProperties Error { get; set; }
        /// <summary>ID of the resource.</summary>
        string Id { get; set; }
        /// <summary>The error message.</summary>
        ...
        /// <summary>A list of results when the operation returns multiple results.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.IAny> Value { get; set; }
