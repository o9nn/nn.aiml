...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class EndpointBaseProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject into a new instance of <see cref="EndpointBaseProperties" />.
        /// </summary>
        ...
        internal EndpointBaseProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseProperties.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseProperties interface is polymorphic, and
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("endpointType") )
            {
                ...
                {
                    return new AzureMultiCloudConnectorEndpointProperties(json);
                }
                case "AzureStorageBlobContainer":
                {
                    return new AzureStorageBlobContainerEndpointProperties(json);
                }
                case "AzureStorageNfsFileShare":
                {
                    return new AzureStorageNfsFileShareEndpointProperties(json);
                }
                case "AzureStorageSmbFileShare":
                {
                    return new AzureStorageSmbFileShareEndpointProperties(json);
                }
                case "NfsMount":
                {
            ...
            return new EndpointBaseProperties(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="EndpointBaseProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EndpointBaseProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode" />.
        /// </returns>
