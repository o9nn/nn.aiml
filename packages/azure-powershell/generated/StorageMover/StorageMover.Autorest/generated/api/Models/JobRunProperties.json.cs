...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class JobRunProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobRunProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobRunProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobRunProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode node)
        {
        ...
        internal JobRunProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject json)
        {
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.JobRunError.FromJson(__jsonError) : _error;}
            {_status = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("status"), out var __jsonStatus) ? (string)__jsonStatus : (string)_status;}
            {_scanStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("scanStatus"), out var __jsonScanStatus) ? (string)__jsonScanStatus : (string)_scanStatus;}
            ...
            {_itemsUnsupported = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("itemsUnsupported"), out var __jsonItemsUnsupported) ? (long?)__jsonItemsUnsupported : _itemsUnsupported;}
            {_itemsNoTransferNeeded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("itemsNoTransferNeeded"), out var __jsonItemsNoTransferNeeded) ? (long?)__jsonItemsNoTransferNeeded : _itemsNoTransferNeeded;}
            {_itemsFailed = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("itemsFailed"), out var __jsonItemsFailed) ? (long?)__jsonItemsFailed : _itemsFailed;}
            {_itemsTransferred = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("itemsTransferred"), out var __jsonItemsTransferred) ? (long?)__jsonItemsTransferred : _itemsTransferred;}
            {_bytesScanned = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesScanned"), out var __jsonBytesScanned) ? (long?)__jsonBytesScanned : _bytesScanned;}
            {_bytesExcluded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesExcluded"), out var __jsonBytesExcluded) ? (long?)__jsonBytesExcluded : _bytesExcluded;}
            {_bytesUnsupported = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesUnsupported"), out var __jsonBytesUnsupported) ? (long?)__jsonBytesUnsupported : _bytesUnsupported;}
            {_bytesNoTransferNeeded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesNoTransferNeeded"), out var __jsonBytesNoTransferNeeded) ? (long?)__jsonBytesNoTransferNeeded : _bytesNoTransferNeeded;}
            {_bytesFailed = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesFailed"), out var __jsonBytesFailed) ? (long?)__jsonBytesFailed : _bytesFailed;}
            {_bytesTransferred = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("bytesTransferred"), out var __jsonBytesTransferred) ? (long?)__jsonBytesTransferred : _bytesTransferred;}
            {_sourceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("sourceName"), out var __jsonSourceName) ? (string)__jsonSourceName : (string)_sourceName;}
            {_sourceResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("sourceResourceId"), out var __jsonSourceResourceId) ? (string)__jsonSourceResourceId : (string)_sourceResourceId;}
            {_sourceProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject>("sourceProperties"), out var __jsonSourceProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Any.FromJson(__jsonSourceProperties) : _sourceProperty;}
            {_targetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("targetName"), out var __jsonTargetName) ? (string)__jsonTargetName : (string)_targetName;}
