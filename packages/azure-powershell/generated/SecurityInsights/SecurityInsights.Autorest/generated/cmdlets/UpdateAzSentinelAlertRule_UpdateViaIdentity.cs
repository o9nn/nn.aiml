...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    public partial class UpdateAzSentinelAlertRule_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AlertRulesCreateOrUpdateViaIdentity(InputObject.Id, AlertRule, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AlertRulesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.WorkspaceName ?? null, InputObject.RuleId ?? null, AlertRule, onOk, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=AlertRule})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzSentinelAlertRule_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzSentinelAlertRule_UpdateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AlertRule })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AlertRule })
                    {
