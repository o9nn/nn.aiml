...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models
{
    ...
    public partial class FluxConfigurationPatchProperties
    {
        ...
        internal FluxConfigurationPatchProperties(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_gitRepository = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("gitRepository"), out var __jsonGitRepository) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.GitRepositoryPatchDefinition.FromJson(__jsonGitRepository) : _gitRepository;}
            {_bucket = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("bucket"), out var __jsonBucket) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.BucketPatchDefinition.FromJson(__jsonBucket) : _bucket;}
            {_azureBlob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("azureBlob"), out var __jsonAzureBlob) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.AzureBlobPatchDefinition.FromJson(__jsonAzureBlob) : _azureBlob;}
            ...
            {_kustomization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("kustomizations"), out var __jsonKustomizations) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.FluxConfigurationPatchPropertiesKustomizations.FromJson(__jsonKustomizations) : _kustomization;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationPatchProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationPatchProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IFluxConfigurationPatchProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode node)
        {
