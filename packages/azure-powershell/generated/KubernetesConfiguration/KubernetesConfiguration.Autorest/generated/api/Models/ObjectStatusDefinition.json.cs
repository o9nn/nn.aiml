...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models
{
    ...
    public partial class ObjectStatusDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusDefinition.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusDefinition.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusDefinition FromJson(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        internal ObjectStatusDefinition(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_appliedBy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("appliedBy"), out var __jsonAppliedBy) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ObjectReferenceDefinition.FromJson(__jsonAppliedBy) : _appliedBy;}
            {_helmReleaseProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonObject>("helmReleaseProperties"), out var __jsonHelmReleaseProperties) ? Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.HelmReleasePropertiesDefinition.FromJson(__jsonHelmReleaseProperties) : _helmReleaseProperty;}
            ...
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)_kind;}
            ...
            {_statusCondition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonArray>("statusConditions"), out var __jsonStatusConditions) ? If( __jsonStatusConditions as Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusConditionDefinition>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IObjectStatusConditionDefinition) (Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.ObjectStatusConditionDefinition.FromJson(__u) )) ))() : null : _statusCondition;}
            AfterFromJson(json);
        }
