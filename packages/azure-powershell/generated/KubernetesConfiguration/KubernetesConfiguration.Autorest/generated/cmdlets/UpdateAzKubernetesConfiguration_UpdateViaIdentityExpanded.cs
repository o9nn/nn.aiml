...
namespace Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzKubernetesConfiguration_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Description(@"update a new Kubernetes Source Control Configuration.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Generated]
    public partial class UpdateAzKubernetesConfiguration_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _sourceControlConfigurationBody = await this.Client.SourceControlConfigurationsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_sourceControlConfigurationBody();
                        await this.Client.SourceControlConfigurationsCreateOrUpdateViaIdentity(InputObject.Id, _sourceControlConfigurationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _sourceControlConfigurationBody = await this.Client.SourceControlConfigurationsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterRp ?? null, InputObject.ClusterResourceName ?? null, InputObject.ClusterName ?? null, InputObject.SourceControlConfigurationName ?? null, this, Pipeline);
                        this.Update_sourceControlConfigurationBody();
                        await this.Client.SourceControlConfigurationsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterRp ?? null, InputObject.ClusterResourceName ?? null, InputObject.ClusterName ?? null, InputObject.SourceControlConfigurationName ?? null, _sourceControlConfigurationBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzKubernetesConfiguration_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzKubernetesConfiguration_UpdateViaIdentityExpanded()
        {

        }

        private void Update_sourceControlConfigurationBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorType")))
            {
                this.OperatorType = (string)(this.MyInvocation?.BoundParameters["OperatorType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RepositoryUrl")))
            {
                this.RepositoryUrl = (string)(this.MyInvocation?.BoundParameters["RepositoryUrl"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorNamespace")))
            {
                this.OperatorNamespace = (string)(this.MyInvocation?.BoundParameters["OperatorNamespace"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorInstanceName")))
            {
                this.OperatorInstanceName = (string)(this.MyInvocation?.BoundParameters["OperatorInstanceName"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorParam")))
            {
                this.OperatorParam = (string)(this.MyInvocation?.BoundParameters["OperatorParam"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ConfigurationProtectedSetting")))
            {
                this.ConfigurationProtectedSetting = (Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Models.IConfigurationProtectedSettings)(this.MyInvocation?.BoundParameters["ConfigurationProtectedSetting"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OperatorScope")))
            {
                this.OperatorScope = (string)(this.MyInvocation?.BoundParameters["OperatorScope"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SshKnownHostsContent")))
            {
                this.SshKnownHostsContent = (string)(this.MyInvocation?.BoundParameters["SshKnownHostsContent"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EnableHelmOperator")))
            {
                this.EnableHelmOperator = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["EnableHelmOperator"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("HelmOperatorPropertyChartVersion")))
            {
                this.HelmOperatorPropertyChartVersion = (string)(this.MyInvocation?.BoundParameters["HelmOperatorPropertyChartVersion"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("HelmOperatorPropertyChartValue")))
            {
                this.HelmOperatorPropertyChartValue = (string)(this.MyInvocation?.BoundParameters["HelmOperatorPropertyChartValue"]);
            }
        }
