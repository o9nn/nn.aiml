...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStorageDiscoveryWorkspace_Get")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStorageDiscoveryWorkspace_Get" /> cmdlet class.
        /// </summary>
        public GetAzStorageDiscoveryWorkspace_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StorageDiscoveryWorkspacesGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
