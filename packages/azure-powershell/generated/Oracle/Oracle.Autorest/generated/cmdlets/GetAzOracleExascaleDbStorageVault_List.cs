...
namespace Microsoft.Azure.PowerShell.Cmdlets.Oracle.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Oracle.Database/exascaleDbStorageVaults"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOracleExascaleDbStorageVault_List")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Oracle.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzOracleExascaleDbStorageVault_List" /> cmdlet class.
        /// </summary>
        public GetAzOracleExascaleDbStorageVault_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExascaleDbStorageVaultsListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ExascaleDbStorageVaultsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
