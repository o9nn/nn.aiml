...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEventHubConsumerGroup_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConsumerGroupsGet(SubscriptionId, ResourceGroupName, NamespaceName, EventHubName, Name, onOk, onDefault, this, Pipeline);
