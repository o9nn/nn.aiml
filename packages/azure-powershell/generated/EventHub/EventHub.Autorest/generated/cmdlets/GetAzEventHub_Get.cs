...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzEventHub_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EventHubsGet(SubscriptionId, ResourceGroupName, NamespaceName, Name, onOk, onDefault, this, Pipeline);
