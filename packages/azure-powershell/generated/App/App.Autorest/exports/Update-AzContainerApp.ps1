...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.App.custom\Update-AzContainerApp';
            UpdateViaJsonString = 'Az.App.custom\Update-AzContainerApp';
            UpdateViaJsonFilePath = 'Az.App.custom\Update-AzContainerApp';
