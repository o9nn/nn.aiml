...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerAppAuthConfig_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContainerAppsAuthConfigsGet(SubscriptionId, ResourceGroupName, ContainerAppName, Name, onOk, onDefault, this, Pipeline);
