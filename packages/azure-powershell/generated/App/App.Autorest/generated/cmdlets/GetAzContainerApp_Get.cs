...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Cmdlets
{
    ...
    public partial class GetAzContainerApp_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzContainerApp_Get" /> cmdlet class.
        /// </summary>
        public GetAzContainerApp_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContainerAppsGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
