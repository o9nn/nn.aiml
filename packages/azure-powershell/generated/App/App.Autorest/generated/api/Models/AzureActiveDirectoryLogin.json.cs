...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class AzureActiveDirectoryLogin
    {
        ...
        internal AzureActiveDirectoryLogin(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_loginParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("loginParameters"), out var __jsonLoginParameters) ? If( __jsonLoginParameters as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _loginParameter;}
            {_disableWwwAuthenticate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("disableWWWAuthenticate"), out var __jsonDisableWwwAuthenticate) ? (bool?)__jsonDisableWwwAuthenticate : _disableWwwAuthenticate;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAzureActiveDirectoryLogin.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAzureActiveDirectoryLogin.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAzureActiveDirectoryLogin FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
