...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class Login
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.ILogin.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.ILogin.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.ILogin FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
        ...
        internal Login(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_route = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("routes"), out var __jsonRoutes) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.LoginRoutes.FromJson(__jsonRoutes) : _route;}
            {_cookieExpiration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("cookieExpiration"), out var __jsonCookieExpiration) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.CookieExpiration.FromJson(__jsonCookieExpiration) : _cookieExpiration;}
            {_nonce = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject>("nonce"), out var __jsonNonce) ? Microsoft.Azure.PowerShell.Cmdlets.App.Models.Nonce.FromJson(__jsonNonce) : _nonce;}
            {_preserveUrlFragmentsForLogin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonBoolean>("preserveUrlFragmentsForLogins"), out var __jsonPreserveUrlFragmentsForLogins) ? (bool?)__jsonPreserveUrlFragmentsForLogins : _preserveUrlFragmentsForLogin;}
            {_allowedExternalRedirectUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray>("allowedExternalRedirectUrls"), out var __jsonAllowedExternalRedirectUrls) ? If( __jsonAllowedExternalRedirectUrls as Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _allowedExternalRedirectUrl;}
            AfterFromJson(json);
        }
