...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class HttpSettingsRoutes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IHttpSettingsRoutes.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.App.Models.IHttpSettingsRoutes.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.App.Models.IHttpSettingsRoutes FromJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json ? new HttpSettingsRoutes(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject into a new instance of <see cref="HttpSettingsRoutes" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal HttpSettingsRoutes(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject json)
        {
            ...
            {_apiPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString>("apiPrefix"), out var __jsonApiPrefix) ? (string)__jsonApiPrefix : (string)_apiPrefix;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="HttpSettingsRoutes" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HttpSettingsRoutes" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._apiPrefix)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.App.Runtime.Json.JsonString(this._apiPrefix.ToString()) : null, "apiPrefix" ,container.Add );
