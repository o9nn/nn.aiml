...
namespace Microsoft.Azure.PowerShell.Cmdlets.App.Models
{
    ...
    public partial class Apple :
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IApple,
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.ILoginScopes Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleInternal.Login { get => (this._login = this._login ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.LoginScopes()); set { {_login = value;} } }

        /// <summary>Internal Acessors for Registration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistration Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleInternal.Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.AppleRegistration()); set { {_registration = value;} } }

        /// <summary>Backing field for <see cref="Registration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistration _registration;

        /// <summary>The configuration settings of the Apple registration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistration Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.App.Models.AppleRegistration()); set => this._registration = value; }

        /// <summary>The Client ID of the app used for login.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string RegistrationClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistrationInternal)Registration).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistrationInternal)Registration).ClientId = value ?? null; }

        /// <summary>The app setting name that contains the client secret.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.App.Origin(Microsoft.Azure.PowerShell.Cmdlets.App.PropertyOrigin.Inlined)]
        public string RegistrationClientSecretSettingName { get => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistrationInternal)Registration).ClientSecretSettingName; set => ((Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistrationInternal)Registration).ClientSecretSettingName = value ?? null; }
...

    {
        ...
        System.Collections.Generic.List<string> LoginScope { get; set; }
        /// <summary>The configuration settings of the Apple registration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.App.Models.IAppleRegistration Registration { get; set; }
        /// <summary>The Client ID of the app used for login.</summary>
        string RegistrationClientId { get; set; }
        /// <summary>The app setting name that contains the client secret.</summary>
        string RegistrationClientSecretSettingName { get; set; }
