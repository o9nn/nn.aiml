...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models
{
    ...
    public partial class Dimensions :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensions,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal
    {
        ...
        private string _lengthHeightUnit;

        /// <summary>Unit for the dimensions of length, height and width.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PropertyOrigin.Owned)]
        public string LengthHeightUnit { get => this._lengthHeightUnit; }

        /// <summary>Internal Acessors for Depth</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.Depth { get => this._depth; set { {_depth = value;} } }

        /// <summary>Internal Acessors for Height</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.Height { get => this._height; set { {_height = value;} } }

        /// <summary>Internal Acessors for Length</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.Length { get => this._length; set { {_length = value;} } }

        /// <summary>Internal Acessors for LengthHeightUnit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.LengthHeightUnit { get => this._lengthHeightUnit; set { {_lengthHeightUnit = value;} } }

        /// <summary>Internal Acessors for Weight</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.Weight { get => this._weight; set { {_weight = value;} } }

        /// <summary>Internal Acessors for WeightUnit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.WeightUnit { get => this._weightUnit; set { {_weightUnit = value;} } }

        /// <summary>Internal Acessors for Width</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.IDimensionsInternal.Width { get => this._width; set { {_width = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PropertyOrigin.Owned)]
        public string WeightUnit { get => this._weightUnit; }
...

    {
        ...
        /// <summary>Unit for the dimensions of length, height and width.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PSArgumentCompleterAttribute("IN", "CM")]
        string LengthHeightUnit { get; set; }
        /// <summary>Weight of the device.</summary>
