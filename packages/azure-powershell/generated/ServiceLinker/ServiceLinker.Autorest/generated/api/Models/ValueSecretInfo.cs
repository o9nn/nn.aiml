...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models
{
    ...
    public partial class ValueSecretInfo :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IValueSecretInfo,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.IValueSecretInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IValidates
    {
        ...
        public string SecretType { get => "rawValue"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.ISecretInfoBaseInternal)__secretInfoBase).SecretType = "rawValue"; }
        ...
        {
            this.__secretInfoBase.SecretType = "rawValue";
        }
    }
    /// The secret info when type is rawValue. It's for scenarios that user input the secret.
