...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSupportTicket_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SupportTicketsGet(SubscriptionId, Name, onOk, onDefault, this, Pipeline);
