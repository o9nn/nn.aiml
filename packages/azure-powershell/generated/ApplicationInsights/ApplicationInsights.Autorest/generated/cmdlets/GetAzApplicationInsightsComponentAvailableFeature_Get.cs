...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzApplicationInsightsComponentAvailableFeature_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ComponentAvailableFeaturesGet(SubscriptionId, ResourceGroupName, Name, onOk, this, Pipeline);
