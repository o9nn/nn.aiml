...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzApplicationInsightsContinuousExport_List" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ExportConfigurationsList(SubscriptionId, ResourceGroupName, Name, onOk, this, Pipeline);
