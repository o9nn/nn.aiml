...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.WorkbooksUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("LinkedSourceId") ? LinkedSourceId : null, _workbookUpdateParametersBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LinkedSourceId=this.InvocationInformation.BoundParameters.ContainsKey("LinkedSourceId") ? LinkedSourceId : null})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzApplicationInsightsWorkbook_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
