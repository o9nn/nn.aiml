...
begin {
    try {
        ...
        $mapping = @{
            ...
            CreateViaJsonFilePath = 'Az.CostManagement.private\New-AzCostManagementExport_CreateViaJsonFilePath';
            CreateViaJsonString = 'Az.CostManagement.private\New-AzCostManagementExport_CreateViaJsonString';
        }
