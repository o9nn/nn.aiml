...
namespace Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models
{
    ...
    public partial class ReportManifest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.IReportManifest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.IReportManifest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.IReportManifest FromJson(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNode node)
        {
        ...
        internal ReportManifest(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonObject json)
        {
            ...
            {_requestContext = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonObject>("requestContext"), out var __jsonRequestContext) ? Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.RequestContext.FromJson(__jsonRequestContext) : _requestContext;}
            {_manifestVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("manifestVersion"), out var __jsonManifestVersion) ? (string)__jsonManifestVersion : (string)_manifestVersion;}
            {_dataFormat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonString>("dataFormat"), out var __jsonDataFormat) ? (string)__jsonDataFormat : (string)_dataFormat;}
            ...
            {_blobCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonNumber>("blobCount"), out var __jsonBlobCount) ? (int?)__jsonBlobCount : _blobCount;}
            {_compressData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonBoolean>("compressData"), out var __jsonCompressData) ? (bool?)__jsonCompressData : _compressData;}
            {_blob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonArray>("blobs"), out var __jsonBlobs) ? If( __jsonBlobs as Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.IBlobInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.IBlobInfo) (Microsoft.Azure.PowerShell.Cmdlets.CostManagement.Models.BlobInfo.FromJson(__u) )) ))() : null : _blob;}
            AfterFromJson(json);
        }
