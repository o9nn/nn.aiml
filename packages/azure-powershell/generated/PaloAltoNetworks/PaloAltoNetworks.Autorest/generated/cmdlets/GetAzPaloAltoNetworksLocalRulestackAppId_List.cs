...
namespace Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListAppIds=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/listAppIds"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPaloAltoNetworksLocalRulestackAppId_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Description(@"List of AppIds for LocalRulestack ApiVersion")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/listAppIds", ApiVersion = "2025-10-08")]
    public partial class GetAzPaloAltoNetworksLocalRulestackAppId_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="AppIdVersion" /> property.</summary>
        private string _appIdVersion;
        ...
        public string AppIdVersion { get => this._appIdVersion; set => this._appIdVersion = value; }

        /// <summary>Backing field for <see cref="AppPrefix" /> property.</summary>
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.ParameterCategory.Query)]
        public string AppPrefix { get => this._appPrefix; set => this._appPrefix = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.IListAppIdResponse">Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.IListAppIdResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.IListAppIdResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzPaloAltoNetworksLocalRulestackAppId_List" /> cmdlet class.
        /// </summary>
        public GetAzPaloAltoNetworksLocalRulestackAppId_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LocalRulestacksListAppIds' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LocalRulestacksListAppIds(SubscriptionId, ResourceGroupName, LocalRulestackName, this.InvocationInformation.BoundParameters.ContainsKey("AppIdVersion") ? AppIdVersion : null, this.InvocationInformation.BoundParameters.ContainsKey("AppPrefix") ? AppPrefix : null, this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : null, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LocalRulestackName=LocalRulestackName,AppIdVersion=this.InvocationInformation.BoundParameters.ContainsKey("AppIdVersion") ? AppIdVersion : null,AppPrefix=this.InvocationInformation.BoundParameters.ContainsKey("AppPrefix") ? AppPrefix : null,Skip=this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : null,Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?)})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.IListAppIdResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.PaloAltoNetworks.Models.IListAppIdResponse
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LocalRulestacksListAppIds_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
