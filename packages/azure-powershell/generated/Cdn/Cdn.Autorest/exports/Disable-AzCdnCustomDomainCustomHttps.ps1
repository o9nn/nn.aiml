...
param(
    ...
    [Parameter(ParameterSetName='DisableViaIdentityEndpoint', Mandatory)]
    [Parameter(ParameterSetName='DisableViaIdentityProfile', Mandatory)]
    ...
    [Parameter(ParameterSetName='DisableViaIdentityEndpoint', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${EndpointInputObject},

    [Parameter(ParameterSetName='DisableViaIdentityProfile', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${ProfileInputObject},
