...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Cdn.private\Get-AzCdnCustomDomain_Get';
            GetViaIdentity = 'Az.Cdn.private\Get-AzCdnCustomDomain_GetViaIdentity';
            GetViaIdentityEndpoint = 'Az.Cdn.private\Get-AzCdnCustomDomain_GetViaIdentityEndpoint';
            GetViaIdentityProfile = 'Az.Cdn.private\Get-AzCdnCustomDomain_GetViaIdentityProfile';
