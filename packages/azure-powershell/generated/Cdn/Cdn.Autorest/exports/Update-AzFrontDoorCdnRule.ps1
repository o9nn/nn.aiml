...
param(
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityRuleSet', Mandatory)]
    [Parameter(ParameterSetName='UpdateViaIdentityRuleSetExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityRuleSet', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='UpdateViaIdentityRuleSetExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnIdentity]
    # Identity Parameter
    ${RuleSetInputObject},
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityRuleSetExpanded')]
