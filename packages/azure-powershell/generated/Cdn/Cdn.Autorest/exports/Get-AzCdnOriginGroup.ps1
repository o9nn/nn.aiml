...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Cdn.private\Get-AzCdnOriginGroup_Get';
            GetViaIdentity = 'Az.Cdn.private\Get-AzCdnOriginGroup_GetViaIdentity';
            GetViaIdentityEndpoint = 'Az.Cdn.private\Get-AzCdnOriginGroup_GetViaIdentityEndpoint';
            GetViaIdentityProfile = 'Az.Cdn.private\Get-AzCdnOriginGroup_GetViaIdentityProfile';
            List = 'Az.Cdn.private\Get-AzCdnOriginGroup_List';
        }
