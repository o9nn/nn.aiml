...
begin {
    try {
        ...
        $mapping = @{
            ...
            CheckViaJsonFilePath = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointNameAvailability_CheckViaJsonFilePath';
            CheckViaJsonString = 'Az.Cdn.private\Test-AzFrontDoorCdnEndpointNameAvailability_CheckViaJsonString';
        }
