...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class HttpVersionMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IHttpVersionMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IHttpVersionMatchConditionParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IHttpVersionMatchConditionParametersInternal.Operator { get => this._operator; set { {_operator = value;} } }
        ...
        public string TypeName { get => "DeliveryRuleHttpVersionConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleHttpVersionConditionParameters"; }

        /// <summary>Creates an new <see cref="HttpVersionMatchConditionParameters" /> instance.</summary>
        public HttpVersionMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleHttpVersionConditionParameters";
        }
    ...
    /// Defines the parameters for HttpVersion match conditions
    internal partial interface IHttpVersionMatchConditionParametersInternal :
