...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class CdnManagedHttpsParameters
    {
        ...
        internal CdnManagedHttpsParameters(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            __customDomainHttpsParameters = new Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.CustomDomainHttpsParameters(json);
            {_certificateSourceParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("certificateSourceParameters"), out var __jsonCertificateSourceParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.CdnCertificateSourceParameters.FromJson(__jsonCertificateSourceParameters) : _certificateSourceParameter;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnManagedHttpsParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnManagedHttpsParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICdnManagedHttpsParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
