...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class RequestSchemeMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRequestSchemeMatchConditionParameters,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRequestSchemeMatchConditionParametersInternal.Operator { get => this._operator; set { {_operator = value;} } }
        ...
        public string TypeName { get => "DeliveryRuleRequestSchemeConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleRequestSchemeConditionParameters"; }

        /// <summary>Creates an new <see cref="RequestSchemeMatchConditionParameters" /> instance.</summary>
        public RequestSchemeMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleRequestSchemeConditionParameters";
        }
    ...
    /// Defines the parameters for RequestScheme match conditions
    internal partial interface IRequestSchemeMatchConditionParametersInternal :
