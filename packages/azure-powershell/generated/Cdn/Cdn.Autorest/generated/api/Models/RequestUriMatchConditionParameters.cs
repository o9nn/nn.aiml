...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class RequestUriMatchConditionParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRequestUriMatchConditionParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IRequestUriMatchConditionParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IValidates
    {
        ...
        public string TypeName { get => "DeliveryRuleRequestUriConditionParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.IDeliveryRuleConditionParametersInternal)__deliveryRuleConditionParameters).TypeName = "DeliveryRuleRequestUriConditionParameters"; }

        /// <summary>Creates an new <see cref="RequestUriMatchConditionParameters" /> instance.</summary>
        public RequestUriMatchConditionParameters()
        {
            this.__deliveryRuleConditionParameters.TypeName = "DeliveryRuleRequestUriConditionParameters";
        }
    ...
    /// Defines the parameters for RequestUri match conditions
    internal partial interface IRequestUriMatchConditionParametersInternal :
