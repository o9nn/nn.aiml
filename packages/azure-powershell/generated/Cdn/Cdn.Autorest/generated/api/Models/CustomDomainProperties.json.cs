...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models
{
    ...
    public partial class CustomDomainProperties
    {
        ...
        internal CustomDomainProperties(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject json)
        {
            ...
            {_customHttpsProvisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("customHttpsProvisioningState"), out var __jsonCustomHttpsProvisioningState) ? (string)__jsonCustomHttpsProvisioningState : (string)_customHttpsProvisioningState;}
            {_customHttpsProvisioningSubstate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonString>("customHttpsProvisioningSubstate"), out var __jsonCustomHttpsProvisioningSubstate) ? (string)__jsonCustomHttpsProvisioningSubstate : (string)_customHttpsProvisioningSubstate;}
            {_customHttpsParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonObject>("customHttpsParameters"), out var __jsonCustomHttpsParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.CustomDomainHttpsParameters.FromJson(__jsonCustomHttpsParameters) : _customHttpsParameter;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICustomDomainProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICustomDomainProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cdn.Models.ICustomDomainProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.Json.JsonNode node)
        {
