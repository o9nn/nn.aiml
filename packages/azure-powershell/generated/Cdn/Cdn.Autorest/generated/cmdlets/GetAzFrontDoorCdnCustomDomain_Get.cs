...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cdn.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cdn.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzFrontDoorCdnCustomDomain_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AfdCustomDomainsGet(SubscriptionId, ResourceGroupName, ProfileName, CustomDomainName, onOk, onDefault, this, Pipeline);
