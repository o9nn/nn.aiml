...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models
{
    ...
    public partial class GenerateResourceLimits
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IGenerateResourceLimits.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IGenerateResourceLimits.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.IGenerateResourceLimits FromJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json ? new GenerateResourceLimits(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject into a new instance of <see cref="GenerateResourceLimits" />.
        /// </summary>
        ...
        internal GenerateResourceLimits(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json)
        {
            ...
            {_cpu = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonString>("cpu"), out var __jsonCpu) ? (string)__jsonCpu : (string)_cpu;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GenerateResourceLimits" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GenerateResourceLimits" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._cpu)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonString(this._cpu.ToString()) : null, "cpu" ,container.Add );
