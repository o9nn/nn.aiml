...
namespace Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models
{
    ...
    public partial class SchemaRegistryRef
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.ISchemaRegistryRef.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.ISchemaRegistryRef.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Models.ISchemaRegistryRef FromJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json ? new SchemaRegistryRef(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject into a new instance of <see cref="SchemaRegistryRef" />.
        /// </summary>
        ...
        internal SchemaRegistryRef(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonString>("resourceId"), out var __jsonResourceId) ? (string)__jsonResourceId : (string)_resourceId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SchemaRegistryRef" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SchemaRegistryRef" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._resourceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.IoTOperationsService.Runtime.Json.JsonString(this._resourceId.ToString()) : null, "resourceId" ,container.Add );
