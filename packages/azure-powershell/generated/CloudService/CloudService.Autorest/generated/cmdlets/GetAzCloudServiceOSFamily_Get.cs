...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    public partial class GetAzCloudServiceOSFamily_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IEventListener
    {
        ...
        /// <summary>Name of the location that the OS family pertains to.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the location that the OS family pertains to.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCloudServiceOSFamily_Get" /> cmdlet class.
        /// </summary>
        public GetAzCloudServiceOSFamily_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.CloudServiceOperatingSystemsGetOSFamily(Location, OSFamilyName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Location=Location,OSFamilyName=OSFamilyName,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api10.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Location=Location, OSFamilyName=OSFamilyName, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Location=Location, OSFamilyName=OSFamilyName, SubscriptionId=SubscriptionId })
                    {
