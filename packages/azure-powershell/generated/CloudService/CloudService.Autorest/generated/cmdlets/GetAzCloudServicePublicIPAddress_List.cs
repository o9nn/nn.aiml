...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CloudService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/publicipaddresses", ApiVersion = "2021-03-01")]
    public partial class GetAzCloudServicePublicIPAddress_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IPublicIPAddressListResult">Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.IPublicIPAddressListResult</see>
        /// from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCloudServicePublicIPAddress_List" /> cmdlet class.
        /// </summary>
        public GetAzCloudServicePublicIPAddress_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PublicIPAddressesListByCloudService(ResourceGroupName, CloudServiceName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PublicIPAddressesListByCloudService_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
