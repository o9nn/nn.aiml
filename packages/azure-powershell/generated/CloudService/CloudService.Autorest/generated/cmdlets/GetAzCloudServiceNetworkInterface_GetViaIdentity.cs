...
namespace Microsoft.Azure.PowerShell.Cmdlets.CloudService.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CloudService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/roleInstances/{roleInstanceName}/networkInterfaces/{networkInterfaceName}", ApiVersion = "2021-03-01")]
    public partial class GetAzCloudServiceNetworkInterface_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CloudService.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.INetworkInterface">Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20210301.INetworkInterface</see>
        /// from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCloudServiceNetworkInterface_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzCloudServiceNetworkInterface_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NetworkInterfacesGetByCloudServiceViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NetworkInterfacesGetByCloudService(InputObject.ResourceGroupName ?? null, InputObject.CloudServiceName ?? null, InputObject.RoleInstanceName ?? null, InputObject.NetworkInterfaceName ?? null, InputObject.SubscriptionId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                    }
