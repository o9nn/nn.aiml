...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models
{
    ...
    public partial class Acl
    {
        ...
        internal Acl(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonObject json)
        {
            ...
            {_initiatorIqn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonString>("initiatorIqn"), out var __jsonInitiatorIqn) ? (string)__jsonInitiatorIqn : (string)_initiatorIqn;}
            {_mappedLun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonArray>("mappedLuns"), out var __jsonMappedLuns) ? If( __jsonMappedLuns as Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _mappedLun;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IAcl.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IAcl.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IAcl FromJson(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Json.JsonNode node)
        {
