...
namespace Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models
{
    ...
    public partial class DiskPoolIdentity :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Models.IDiskPoolIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="IscsiTargetName" /> property.</summary>
        private string _iscsiTargetName;

        /// <summary>The name of the iSCSI Target.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Origin(Microsoft.Azure.PowerShell.Cmdlets.DiskPool.PropertyOrigin.Owned)]
        public string IscsiTargetName { get => this._iscsiTargetName; set => this._iscsiTargetName = value; }
        ...
        /// <summary>Creates an new <see cref="DiskPoolIdentity" /> instance.</summary>
        public DiskPoolIdentity()
        {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string IscsiTargetName { get; set; }
        /// <summary>The location of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DiskPool.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IDiskPoolIdentityInternal
