...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models
{
    ...
    public partial class LogRules
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.ILogRules.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.ILogRules.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.ILogRules FromJson(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode node)
        {
        ...
        internal LogRules(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json)
        {
            ...
            {_sendAadLog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonBoolean>("sendAadLogs"), out var __jsonSendAadLogs) ? (bool?)__jsonSendAadLogs : _sendAadLog;}
            {_sendSubscriptionLog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonBoolean>("sendSubscriptionLogs"), out var __jsonSendSubscriptionLogs) ? (bool?)__jsonSendSubscriptionLogs : _sendSubscriptionLog;}
            {_sendResourceLog = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonBoolean>("sendResourceLogs"), out var __jsonSendResourceLogs) ? (bool?)__jsonSendResourceLogs : _sendResourceLog;}
            {_filteringTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonArray>("filteringTags"), out var __jsonFilteringTags) ? If( __jsonFilteringTags as Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IFilteringTag>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.IFilteringTag) (Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.FilteringTag.FromJson(__u) )) ))() : null : _filteringTag;}
            AfterFromJson(json);
        }
