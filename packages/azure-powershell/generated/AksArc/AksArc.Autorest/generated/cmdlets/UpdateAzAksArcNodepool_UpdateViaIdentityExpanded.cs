...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of UpdateAzAksArcNodepool_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Cmdlets.UpdateAzAksArcNodepool_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzAksArcNodepool_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _agentPoolBody = await this.Client.AgentPoolGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_agentPoolBody();
                        await this.Client.AgentPoolCreateOrUpdateViaIdentity(InputObject.Id, _agentPoolBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _agentPoolBody = await this.Client.AgentPoolGetWithResult(InputObject.ConnectedClusterResourceUri ?? null, InputObject.AgentPoolName ?? null, this, Pipeline);
                        this.Update_agentPoolBody();
                        await this.Client.AgentPoolCreateOrUpdate(InputObject.ConnectedClusterResourceUri ?? null, InputObject.AgentPoolName ?? null, _agentPoolBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzAksArcNodepool_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzAksArcNodepool_UpdateViaIdentityExpanded()
        {

        }

        private void Update_agentPoolBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Tag")))
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IAgentPoolTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OSType")))
            {
                this.OSType = (string)(this.MyInvocation?.BoundParameters["OSType"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("OSSku")))
            {
                this.OSSku = (string)(this.MyInvocation?.BoundParameters["OSSku"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("NodeLabel")))
            {
                this.NodeLabel = (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IAgentPoolProfileNodeLabels)(this.MyInvocation?.BoundParameters["NodeLabel"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("NodeTaint")))
            {
                this.NodeTaint = (string[])(this.MyInvocation?.BoundParameters["NodeTaint"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaxCount")))
            {
                this.MaxCount = (int)(this.MyInvocation?.BoundParameters["MaxCount"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MinCount")))
            {
                this.MinCount = (int)(this.MyInvocation?.BoundParameters["MinCount"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EnableAutoScaling")))
            {
                this.EnableAutoScaling = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["EnableAutoScaling"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaxPod")))
            {
                this.MaxPod = (int)(this.MyInvocation?.BoundParameters["MaxPod"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Count")))
            {
                this.Count = (int)(this.MyInvocation?.BoundParameters["Count"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("VMSize")))
            {
                this.VMSize = (string)(this.MyInvocation?.BoundParameters["VMSize"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StatusErrorMessage")))
            {
                this.StatusErrorMessage = (string)(this.MyInvocation?.BoundParameters["StatusErrorMessage"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StatusReadyReplica")))
            {
                this.StatusReadyReplica = (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IAgentPoolUpdateProfile[])(this.MyInvocation?.BoundParameters["StatusReadyReplica"]);
            }
        }
