...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class HybridIdentityMetadataProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IHybridIdentityMetadataProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IHybridIdentityMetadataProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IHybridIdentityMetadataProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new HybridIdentityMetadataProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="HybridIdentityMetadataProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal HybridIdentityMetadataProperties(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceUid = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString>("resourceUid"), out var __jsonResourceUid) ? (string)__jsonResourceUid : (string)_resourceUid;}
            {_publicKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString>("publicKey"), out var __jsonPublicKey) ? (string)__jsonPublicKey : (string)_publicKey;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="HybridIdentityMetadataProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HybridIdentityMetadataProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._resourceUid)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString(this._resourceUid.ToString()) : null, "resourceUid" ,container.Add );
            AddIf( null != (((object)this._publicKey)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString(this._publicKey.ToString()) : null, "publicKey" ,container.Add );
