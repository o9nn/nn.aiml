...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class StorageProfileSmbCsiDriver
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IStorageProfileSmbCsiDriver.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IStorageProfileSmbCsiDriver.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IStorageProfileSmbCsiDriver FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new StorageProfileSmbCsiDriver(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="StorageProfileSmbCsiDriver" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal StorageProfileSmbCsiDriver(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            ...
            {_enabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonBoolean>("enabled"), out var __jsonEnabled) ? (bool?)__jsonEnabled : _enabled;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="StorageProfileSmbCsiDriver" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StorageProfileSmbCsiDriver" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._enabled ? (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonBoolean((bool)this._enabled) : null, "enabled" ,container.Add );
