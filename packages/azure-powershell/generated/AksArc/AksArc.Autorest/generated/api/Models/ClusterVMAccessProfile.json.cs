...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class ClusterVMAccessProfile
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="ClusterVMAccessProfile" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ClusterVMAccessProfile(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            ...
            {_authorizedIPRange = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString>("authorizedIPRanges"), out var __jsonAuthorizedIPRanges) ? (string)__jsonAuthorizedIPRanges : (string)_authorizedIPRange;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IClusterVMAccessProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IClusterVMAccessProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IClusterVMAccessProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new ClusterVMAccessProfile(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ClusterVMAccessProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ClusterVMAccessProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._authorizedIPRange)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString(this._authorizedIPRange.ToString()) : null, "authorizedIPRanges" ,container.Add );
