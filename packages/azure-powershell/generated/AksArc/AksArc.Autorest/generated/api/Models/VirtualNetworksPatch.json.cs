...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class VirtualNetworksPatch
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IVirtualNetworksPatch.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IVirtualNetworksPatch.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IVirtualNetworksPatch FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new VirtualNetworksPatch(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="VirtualNetworksPatch" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="VirtualNetworksPatch" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="VirtualNetworksPatch" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal VirtualNetworksPatch(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.VirtualNetworksPatchTags.FromJson(__jsonTags) : _tag;}
            AfterFromJson(json);
        }
    }
}