...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class NamedAgentPoolProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.INamedAgentPoolProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.INamedAgentPoolProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.INamedAgentPoolProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new NamedAgentPoolProfile(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="NamedAgentPoolProfile" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal NamedAgentPoolProfile(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            ...
            __agentPoolProfile = new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.AgentPoolProfile(json);
            __agentPoolUpdateProfile = new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.AgentPoolUpdateProfile(json);
            __agentPoolName = new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.AgentPoolName(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="NamedAgentPoolProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NamedAgentPoolProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode serializationMode)
        {
            ...
            __agentPoolProfile?.ToJson(container, serializationMode);
            __agentPoolUpdateProfile?.ToJson(container, serializationMode);
            __agentPoolName?.ToJson(container, serializationMode);
