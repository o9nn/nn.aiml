...
namespace Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models
{
    ...
    public partial class ProvisionedClusterLicenseProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IProvisionedClusterLicenseProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IProvisionedClusterLicenseProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AksArc.Models.IProvisionedClusterLicenseProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json ? new ProvisionedClusterLicenseProfile(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject into a new instance of <see cref="ProvisionedClusterLicenseProfile" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ProvisionedClusterLicenseProfile(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject json)
        {
            ...
            {_azureHybridBenefit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString>("azureHybridBenefit"), out var __jsonAzureHybridBenefit) ? (string)__jsonAzureHybridBenefit : (string)_azureHybridBenefit;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ProvisionedClusterLicenseProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ProvisionedClusterLicenseProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._azureHybridBenefit)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AksArc.Runtime.Json.JsonString(this._azureHybridBenefit.ToString()) : null, "azureHybridBenefit" ,container.Add );
