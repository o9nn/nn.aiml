#
# Module manifest for module 'Az.Terraform'
#
...
Description = 'Microsoft Azure PowerShell - Azure Terraform cmdlets for Azure Resource Manager in Windows PowerShell and PowerShell Core.'
...
NestedModules = @('Terraform.Autorest/Az.Terraform.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Export-AzTerraform', 'New-AzTerraformExportQueryObject', 
