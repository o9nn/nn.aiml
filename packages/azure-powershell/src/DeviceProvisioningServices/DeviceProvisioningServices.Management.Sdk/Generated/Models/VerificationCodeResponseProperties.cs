...
namespace Microsoft.Azure.Management.DeviceProvisioningServices.Models
{
    ...
    public partial class VerificationCodeResponseProperties
    {
        ...
        /// <param name="verificationCode">Verification code.
        /// </param>

        /// <param name="subject">Certificate subject.
        /// </param>

        /// <param name="expiry">Code expiry.
        /// </param>

        /// <param name="thumbprint">Certificate thumbprint.
        /// </param>

        /// <param name="isVerified">Indicate if the certificate is verified by owner of private key.
        /// </param>

        /// <param name="created">Certificate created time.
        /// </param>

        /// <param name="updated">Certificate updated time.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets indicate if the certificate is verified by owner of private
        /// key.
        /// </summary>
