...
namespace Microsoft.Azure.Commands.Management.DeviceProvisioningServices
{
    ...
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDeviceProvisioningServiceEnrollment", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [Alias("Remove-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDpsEnrollment")]
    [OutputType(typeof(bool))]
    public class RemoveAzIotDeviceProvisioningServiceEnrollment : IotDpsBaseCmdlet
    {
