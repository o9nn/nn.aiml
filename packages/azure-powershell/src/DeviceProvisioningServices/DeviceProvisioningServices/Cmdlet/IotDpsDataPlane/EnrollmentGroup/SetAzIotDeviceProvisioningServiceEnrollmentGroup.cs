...
namespace Microsoft.Azure.Commands.Management.DeviceProvisioningServices
{
    ...
    [Cmdlet("Set", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDeviceProvisioningServiceEnrollmentGroup", DefaultParameterSetName = ResourceParameterSet, SupportsShouldProcess = true)]
    [Alias("Set-" + ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "IoTDpsEnrollmentGroup")]
    [OutputType(typeof(PSEnrollmentGroup))]
    public class SetAzIotDeviceProvisioningServiceEnrollmentGroup : IotDpsBaseCmdlet
    {
