...
namespace Microsoft.Azure.Management.HDInsight.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(PrivateLinkServiceConnectionState privateLinkServiceConnectionState, PrivateEndpoint privateEndpoint = default(PrivateEndpoint), string linkIdentifier = default(string), string provisioningState = default(string))
