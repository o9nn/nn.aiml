...
namespace Microsoft.Azure.Management.Search.Models
{
    ...
    public partial class SearchServiceUpdate : Resource
    {
        ...
        /// <param name="identity">Details about the search service identity. A null value indicates that the
        ...
        /// </param>
        public SearchServiceUpdate(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), Sku sku = default(Sku), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), Identity identity = default(Identity), HostingMode? hostingMode = default(HostingMode?), string computeType = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string upgradeAvailable = default(string), int? replicaCount = default(int?), int? partitionCount = default(int?), string endpoint = default(string), string publicNetworkAccess = default(string), SearchServiceStatus? status = default(SearchServiceStatus?), string statusDetails = default(string), NetworkRuleSet networkRuleSet = default(NetworkRuleSet), System.Collections.Generic.IList<string> dataExfiltrationProtections = default(System.Collections.Generic.IList<string>), EncryptionWithCmk encryptionWithCmk = default(EncryptionWithCmk), bool? disableLocalAuth = default(bool?), DataPlaneAuthOptions authOptions = default(DataPlaneAuthOptions), string semanticSearch = default(string), System.Collections.Generic.IList<PrivateEndpointConnection> privateEndpointConnections = default(System.Collections.Generic.IList<PrivateEndpointConnection>), System.Collections.Generic.IList<SharedPrivateLinkResource> sharedPrivateLinkResources = default(System.Collections.Generic.IList<SharedPrivateLinkResource>), string eTag = default(string), System.DateTime? serviceUpgradedAt = default(System.DateTime?))
        ...
        /// <summary>
        /// Gets or sets details about the search service identity. A null value
        /// indicates that the search service has no identity assigned.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.computeType")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.upgradeAvailable")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.dataExfiltrationProtections")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.serviceUpgradedAt")]
