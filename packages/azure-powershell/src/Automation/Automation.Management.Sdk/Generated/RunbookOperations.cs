...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class RunbookOperations : Microsoft.Rest.IServiceOperations<AutomationClient>, IRunbookOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<RunbookPublishHeaders> _response = await BeginPublishWithHttpMessagesAsync(resourceGroupName, automationAccountName, runbookName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<RunbookPublishHeaders>> BeginPublishWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, string runbookName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<RunbookPublishHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<RunbookPublishHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
