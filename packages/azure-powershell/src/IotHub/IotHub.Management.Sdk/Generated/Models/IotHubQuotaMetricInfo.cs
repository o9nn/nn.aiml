...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    public partial class IotHubQuotaMetricInfo
    {
        ...
        /// <param name="name">The name of the quota metric.
        /// </param>

        /// <param name="currentValue">The current value for the quota metric.
        /// </param>

        /// <param name="maxValue">The maximum value of the quota metric.
        /// </param>
