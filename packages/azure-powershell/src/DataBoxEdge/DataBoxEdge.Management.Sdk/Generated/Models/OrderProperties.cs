...
namespace Microsoft.Azure.Management.DataBoxEdge.Models
{
    ...
    public partial class OrderProperties
    {
        ...
        /// has an original or a replacement device.
        /// </param>
        public OrderProperties(ContactDetails contactInformation, Address shippingAddress, OrderStatus currentStatus = default(OrderStatus), System.Collections.Generic.IList<OrderStatus> orderHistory = default(System.Collections.Generic.IList<OrderStatus>), string serialNumber = default(string), System.Collections.Generic.IList<TrackingInfo> deliveryTrackingInfo = default(System.Collections.Generic.IList<TrackingInfo>), System.Collections.Generic.IList<TrackingInfo> returnTrackingInfo = default(System.Collections.Generic.IList<TrackingInfo>))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "contactInformation")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "currentStatus")]
        public OrderStatus CurrentStatus {get; set; }

        /// <summary>
        /// Gets list of status changes in the order.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "orderHistory")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "deliveryTrackingInfo")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "returnTrackingInfo")]
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ContactInformation");
            }
            if (this.ShippingAddress == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ShippingAddress");
            }
            if (this.ContactInformation != null)
            {
