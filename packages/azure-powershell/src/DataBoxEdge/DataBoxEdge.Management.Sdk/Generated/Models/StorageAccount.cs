...
namespace Microsoft.Azure.Management.DataBoxEdge.Models
{
    ...
    public partial class StorageAccount : ARMBaseModel
    {
        ...
        /// to Cloud.
        /// </param>
        public StorageAccount(string id = default(string), string name = default(string), string type = default(string), string dataPolicy = default(string), string description = default(string), string storageAccountStatus = default(string), string storageAccountCredentialId = default(string), string blobEndpoint = default(string), int? containerCount = default(int?))
        ...
        /// set to Cloud.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.containerCount")]
