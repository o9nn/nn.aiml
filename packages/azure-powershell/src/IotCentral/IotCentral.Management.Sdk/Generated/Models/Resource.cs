...
namespace Microsoft.Azure.Management.IotCentral.Models
{
    ...
    public partial class Resource : Microsoft.Rest.Azure.IResource
    {
        ...
        public virtual void Validate()
        {
            ...
            if (this.Name != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(this.Name, "^(?![0-9]+$)(?!-)[a-zA-Z0-9-]{2,99}[a-zA-Z0-9]$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "Name", "^(?![0-9]+$)(?!-)[a-zA-Z0-9-]{2,99}[a-zA-Z0-9]$");
                }
            }
