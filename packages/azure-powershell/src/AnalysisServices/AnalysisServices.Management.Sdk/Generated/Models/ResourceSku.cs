...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    public partial class ResourceSku
    {
        ...
        /// <param name="name">Name of the SKU level.
        /// </param>

        /// <param name="tier">The name of the Azure pricing tier to which the SKU applies.
        /// Possible values include: &#39;Development&#39;, &#39;Basic&#39;, &#39;Standard&#39;</param>

        /// <param name="capacity">The number of instances in the read only query pool.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the name of the Azure pricing tier to which the SKU applies. Possible values include: &#39;Development&#39;, &#39;Basic&#39;, &#39;Standard&#39;
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            if (this.Capacity != null)
            {
                if (this.Capacity > 8)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.InclusiveMaximum, "Capacity", 8);
                }
                if (this.Capacity < 1)
                {
