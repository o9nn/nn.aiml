...
namespace Microsoft.Azure.Management.Analysis.Models
{
    ...
    public partial class GatewayDetails
    {
        ...
        /// <param name="gatewayResourceId">Gateway resource to be associated with the server.
        /// </param>

        /// <param name="gatewayObjectId">Gateway object id from in the DMTS cluster for the gateway resource.
        /// </param>

        /// <param name="dmtsClusterUri">Uri of the DMTS cluster.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "gatewayResourceId")]
        public string GatewayResourceId {get; set; }

        /// <summary>
        /// Gets gateway object id from in the DMTS cluster for the gateway resource.
        /// </summary>
