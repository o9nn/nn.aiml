...
{
    /// <summary>
    /// Delete a Cognitive Services Account RaiBlocklist
    /// </summary>
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CognitiveServicesAccountRaiBlocklist", DefaultParameterSetName = DefaultParameterSet, SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveAzureCognitiveServicesAccountRaiBlocklistCommand : CognitiveServicesAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
                ...
                Force.IsPresent)
            {
                RunCmdLet(() =>
                {
                    ...
                    this.CognitiveServicesClient.RaiBlocklists.Delete(ResourceGroupName, AccountName, Name);
