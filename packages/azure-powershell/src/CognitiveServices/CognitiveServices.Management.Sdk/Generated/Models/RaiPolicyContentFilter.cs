...
namespace Microsoft.Azure.Management.CognitiveServices.Models
{
    ...
    public partial class RaiPolicyContentFilter
    {
        ...
        /// <param name="severityThreshold">Level at which content is filtered.
        ...
        public RaiPolicyContentFilter(string name = default(string), bool? enabled = default(bool?), string severityThreshold = default(string), bool? blocking = default(bool?), string source = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "severityThreshold")]
