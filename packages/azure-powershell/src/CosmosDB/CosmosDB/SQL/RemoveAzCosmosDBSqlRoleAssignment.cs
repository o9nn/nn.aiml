...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlRoleAssignment", DefaultParameterSetName = ResourceIdParameterSet, SupportsShouldProcess = true), OutputType(typeof(void))]
    public class RemoveAzCosmosDBSqlRoleAssignment : AzureCosmosDBCmdletBase
    {
