...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDbClientEncryptionKey", DefaultParameterSetName = NameParameterSet), OutputType(typeof(PSSqlClientEncryptionKeyGetResults))]
    public class GetAzCosmosDbClientEncryptionKey  : AzureCosmosDBCmdletBase
    {
