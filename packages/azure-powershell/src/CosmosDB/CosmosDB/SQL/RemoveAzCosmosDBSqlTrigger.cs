...
{
    [Cmdlet(VerbsCommon.Remove, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlTrigger", SupportsShouldProcess = true), OutputType(typeof(void), typeof(bool))]
    public class RemoveAzCosmosDBSqlTrigger : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = true, ParameterSetName = NameParameterSet, HelpMessage = Constants.TriggerNameHelpMessage)]
        [ValidateNotNullOrEmpty]
