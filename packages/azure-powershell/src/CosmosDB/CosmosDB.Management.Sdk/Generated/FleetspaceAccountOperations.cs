...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class FleetspaceAccountOperations : Microsoft.Rest.IServiceOperations<CosmosDBManagementClient>, IFleetspaceAccountOperations
    {
        /// <summary>
        /// Initializes a new instance of the FleetspaceAccountOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal FleetspaceAccountOperations (CosmosDBManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<FleetspaceAccountResource>>> ListWithHttpMessagesAsync(string resourceGroupName, string fleetName, string fleetspaceName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/fleets/{fleetName}/fleetspaces/{fleetspaceName}/fleetspaceAccounts").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<FleetspaceAccountResource>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<FleetspaceAccountResource>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource>> GetWithHttpMessagesAsync(string resourceGroupName, string fleetName, string fleetspaceName, string fleetspaceAccountName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "fleetspaceAccountName");
            }
            if (fleetspaceAccountName != null)
            {
                if (fleetspaceAccountName.Length > 50)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxLength, "fleetspaceAccountName", 50);
                }
                if (fleetspaceAccountName.Length < 3)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MinLength, "fleetspaceAccountName", 3);
                }
                if (!System.Text.RegularExpressions.Regex.IsMatch(fleetspaceAccountName, "^[a-z0-9]+(-[a-z0-9]+)*"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "fleetspaceAccountName", "^[a-z0-9]+(-[a-z0-9]+)*");
                }
            }
            string apiVersion = "2025-10-15";
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("fleetName", fleetName);
                tracingParameters.Add("fleetspaceName", fleetspaceName);
                tracingParameters.Add("fleetspaceAccountName", fleetspaceAccountName);
                tracingParameters.Add("apiVersion", apiVersion);
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/fleets/{fleetName}/fleetspaces/{fleetspaceName}/fleetspaceAccounts/{fleetspaceAccountName}").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(this.Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{fleetName}", System.Uri.EscapeDataString(fleetName));
            _url = _url.Replace("{fleetspaceName}", System.Uri.EscapeDataString(fleetspaceName));
            _url = _url.Replace("{fleetspaceAccountName}", System.Uri.EscapeDataString(fleetspaceAccountName));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<FleetspaceAccountResource>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<FleetspaceAccountResource> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, fleetName, fleetspaceName, fleetspaceAccountName, body, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<FleetspaceAccountDeleteHeaders> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, fleetName, fleetspaceName, fleetspaceAccountName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<FleetspaceAccountDeleteHeaders>> BeginDeleteWithHttpMessagesAsync(string resourceGroupName, string fleetName, string fleetspaceName, string fleetspaceAccountName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<FleetspaceAccountDeleteHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<FleetspaceAccountDeleteHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
