...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateParameters : ARMResourceProperties
    {
        ...
        /// </param>
        public MongoDBCollectionCreateUpdateParameters(MongoDBCollectionResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CreateUpdateOptions options = default(CreateUpdateOptions))
