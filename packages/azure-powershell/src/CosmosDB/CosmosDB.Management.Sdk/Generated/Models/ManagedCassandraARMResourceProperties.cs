...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    /// </summary>
    public partial class ManagedCassandraARMResourceProperties : Microsoft.Rest.Azure.IResource
    {
        /// <summary>
        ...
        /// </param>
        public ManagedCassandraARMResourceProperties(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), ManagedCassandraManagedServiceIdentity identity = default(ManagedCassandraManagedServiceIdentity))
