...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the MongoDBCollectionGetResults class.
        /// </summary>
        ...
        /// <param name="options">
        /// </param>
        public MongoDBCollectionGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), MongoDBCollectionGetPropertiesResource resource = default(MongoDBCollectionGetPropertiesResource), MongoDBCollectionGetPropertiesOptions options = default(MongoDBCollectionGetPropertiesOptions))
