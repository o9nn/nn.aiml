...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SqlTriggerCreateUpdateParameters class.
        /// </summary>
        ...
        /// </param>
        public SqlTriggerCreateUpdateParameters(SqlTriggerResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CreateUpdateOptions options = default(CreateUpdateOptions))
