...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RestorableSqlResourcesGetResult class.
        /// </summary>
        ...
        /// </param>
        public RestorableSqlResourcesGetResult(string id = default(string), string name = default(string), string type = default(string), string databaseName = default(string), System.Collections.Generic.IList<string> collectionNames = default(System.Collections.Generic.IList<string>))
