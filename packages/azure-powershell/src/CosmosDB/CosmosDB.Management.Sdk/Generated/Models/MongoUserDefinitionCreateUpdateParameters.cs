...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the MongoUserDefinitionCreateUpdateParameters class.
        /// </summary>
        ...
        /// SCRAM-SHA-256.
        /// </param>
        public MongoUserDefinitionCreateUpdateParameters(string userName = default(string), string password = default(string), string databaseName = default(string), string customData = default(string), System.Collections.Generic.IList<Role> roles = default(System.Collections.Generic.IList<Role>), string mechanisms = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.customData")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.mechanisms")]
