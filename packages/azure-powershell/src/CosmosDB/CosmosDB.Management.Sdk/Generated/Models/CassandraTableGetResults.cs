...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraTableGetResults : ARMResourceProperties
    {
        ...
        /// <param name="options">
        /// </param>
        public CassandraTableGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), CassandraTableGetPropertiesResource resource = default(CassandraTableGetPropertiesResource), CassandraTableGetPropertiesOptions options = default(CassandraTableGetPropertiesOptions))
