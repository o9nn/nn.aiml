...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class Invitation : ProxyDto
    {
        ...
        /// </param>
        public Invitation(string id = default(string), string name = default(string), string type = default(string), string invitationStatus = default(string), string invitationId = default(string), System.DateTime? respondedAt = default(System.DateTime?), System.DateTime? sentAt = default(System.DateTime?), string targetActiveDirectoryId = default(string), string targetEmail = default(string), string targetObjectId = default(string), string userEmail = default(string), string userName = default(string))
