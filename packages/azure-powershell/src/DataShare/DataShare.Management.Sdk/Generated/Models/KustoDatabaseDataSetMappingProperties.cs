...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the KustoDatabaseDataSetMappingProperties class.
        /// </summary>
        ...
        /// &#39;Failed&#39;</param>
        public KustoDatabaseDataSetMappingProperties(string dataSetId, string kustoClusterResourceId, string dataSetMappingStatus = default(string), string location = default(string), string provisioningState = default(string))
