...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class ScheduledSynchronizationSetting : SynchronizationSetting
    {
        ...
        /// </param>
        public ScheduledSynchronizationSetting(string recurrenceInterval, System.DateTime synchronizationTime, string id = default(string), string name = default(string), string type = default(string), string provisioningState = default(string), System.DateTime? createdAt = default(System.DateTime?), string userName = default(string))
