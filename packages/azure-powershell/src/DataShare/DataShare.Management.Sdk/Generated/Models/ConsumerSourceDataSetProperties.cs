...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ConsumerSourceDataSetProperties class.
        /// </summary>
        ...
        public ConsumerSourceDataSetProperties(string dataSetId = default(string), string dataSetLocation = default(string), string dataSetName = default(string), string dataSetPath = default(string), string dataSetType = default(string))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "dataSetLocation")]
        public string DataSetLocation {get; private set; }

        /// <summary>
        /// Gets dataSet name
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "dataSetName")]
        public string DataSetName {get; private set; }

        /// <summary>
        /// Gets dataSet path
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "dataSetPath")]
