...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class SlimPolicyMetadata
    {
        ...
        /// </param>
        public SlimPolicyMetadata(string id = default(string), string type = default(string), string name = default(string), string metadataId = default(string), string category = default(string), string title = default(string), string owner = default(string), string additionalContentUrl = default(string), object metadata = default(object))
