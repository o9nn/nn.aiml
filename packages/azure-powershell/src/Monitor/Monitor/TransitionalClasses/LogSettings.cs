...
namespace Microsoft.Azure.Management.Monitor.Management.Models
{
    ...
    /// It is identical to the LogSettings, but in the old namespace
    /// </summary>
    public class LogSettings: Monitor.Models.LogSettings
    {
        /// <summary>
        /// Gets or sets the RetentionPolicy of the LogSettings
        /// </summary>
