...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.Network.Models
{
    ...
    public partial class Route : SubResource
    {
        ...
        /// </param>
        public Route(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), string addressPrefix = default(string), string nextHopType = default(string), string nextHopIPAddress = default(string))
