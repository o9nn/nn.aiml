...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.Network.Models
{
    ...
    public partial class ServiceEndpointPolicyDefinition : SubResource
    {
        ...
        /// </param>
        public ServiceEndpointPolicyDefinition(string id = default(string), string name = default(string), string etag = default(string), string provisioningState = default(string), string description = default(string), string service = default(string), System.Collections.Generic.IList<string> serviceResources = default(System.Collections.Generic.IList<string>))
