...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Helper.Network.Models
{
    ...
    public partial class NetworkInterface : Resource
    {
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in this.TapConfigurations)
                {
                    if (element != null)
                    {
                        element.Validate();
