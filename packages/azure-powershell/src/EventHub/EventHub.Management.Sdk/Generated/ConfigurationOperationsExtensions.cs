...
namespace Microsoft.Azure.Management.EventHub
{
    ...
    public static partial class ConfigurationOperationsExtensions
    {
        ...
        {
                return ((IConfigurationOperations)operations).PatchAsync(resourceGroupName, clusterName, parameters).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<ClusterQuotaConfigurationProperties> PatchAsync(this IConfigurationOperations operations, string resourceGroupName, string clusterName, ClusterQuotaConfigurationProperties parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
                return ((IConfigurationOperations)operations).GetAsync(resourceGroupName, clusterName).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<ClusterQuotaConfigurationProperties> GetAsync(this IConfigurationOperations operations, string resourceGroupName, string clusterName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
