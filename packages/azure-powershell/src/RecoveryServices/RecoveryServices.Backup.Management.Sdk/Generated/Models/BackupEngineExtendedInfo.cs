...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class BackupEngineExtendedInfo
    {
        ...
        /// <param name="databaseName">Database name of backup engine.
        /// </param>

        /// <param name="protectedItemsCount">Number of protected items in the backup engine.
        /// </param>

        /// <param name="protectedServersCount">Number of protected servers in the backup engine.
        /// </param>

        /// <param name="diskCount">Number of disks in the backup engine.
        /// </param>

        /// <param name="usedDiskSpace">Disk space used in the backup engine.
        /// </param>

        /// <param name="availableDiskSpace">Disk space currently available in the backup engine.
        /// </param>

        /// <param name="refreshedAt">Last refresh time in the backup engine.
        /// </param>

        /// <param name="azureProtectedInstances">Protected instances in the backup engine.
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "usedDiskSpace")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "refreshedAt")]
