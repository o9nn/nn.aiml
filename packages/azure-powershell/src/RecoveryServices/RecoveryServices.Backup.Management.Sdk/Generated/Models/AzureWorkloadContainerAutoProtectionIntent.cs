...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("AzureWorkloadContainerAutoProtectionIntent")]
    public partial class AzureWorkloadContainerAutoProtectionIntent : ProtectionIntent
    {
        ...
        public AzureWorkloadContainerAutoProtectionIntent(string backupManagementType = default(string), string sourceResourceId = default(string), string itemId = default(string), string policyId = default(string), string protectionState = default(string))
