...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class DPMProtectedItem : ProtectedItem
    {
        ...
        /// </param>
        public DPMProtectedItem(string backupManagementType = default(string), string workloadType = default(string), string containerName = default(string), string sourceResourceId = default(string), string policyId = default(string), System.DateTime? lastRecoveryPoint = default(System.DateTime?), string backupSetName = default(string), string createMode = default(string), System.DateTime? deferredDeleteTimeInUtc = default(System.DateTime?), bool? isScheduledForDeferredDelete = default(bool?), string deferredDeleteTimeRemaining = default(string), bool? isDeferredDeleteScheduleUpcoming = default(bool?), bool? isRehydrate = default(bool?), System.Collections.Generic.IList<string> resourceGuardOperationRequests = default(System.Collections.Generic.IList<string>), string friendlyName = default(string), string backupEngineName = default(string), string protectionState = default(string), DPMProtectedItemExtendedInfo extendedInfo = default(DPMProtectedItemExtendedInfo))
        ...
        /// <summary>
        /// Gets or sets protection state of the backup engine Possible values include: &#39;Invalid&#39;, &#39;IRPending&#39;, &#39;Protected&#39;, &#39;ProtectionError&#39;, &#39;ProtectionStopped&#39;, &#39;ProtectionPaused&#39;
        /// </summary>
