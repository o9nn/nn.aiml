...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class KeyAndSecretDetails
    {
        ...
        /// <param name="kekDetails">KEK is encryption key for BEK.
        /// </param>

        /// <param name="bekDetails">BEK is bitlocker encryption key.
        /// </param>

        /// <param name="encryptionMechanism">Encryption mechanism: None/ SinglePass/ DoublePass
        /// </param>
