    ...
    internal partial class RecoveryPointsOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IRecoveryPointsOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<CrrAccessTokenResource>> GetAccessTokenWithHttpMessagesAsync(string vaultName, string resourceGroupName, string fabricName, string containerName, string protectedItemName, string recoveryPointId, AADPropertiesResource parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "GetAccessToken", tracingParameters);
            }
            // Construct URL
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<CrrAccessTokenResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<CrrAccessTokenResource>(_responseContent, this.Client.DeserializationSettings);
                }
