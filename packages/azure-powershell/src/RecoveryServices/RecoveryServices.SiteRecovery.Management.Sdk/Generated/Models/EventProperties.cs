...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class EventProperties
    {
        ...
        /// <param name="eventCode">The Id of the monitoring event.
        /// </param>

        /// <param name="description">The event name.
        /// </param>

        /// <param name="eventType">The type of the event. for example: VM Health, Server Health, Job Failure
        /// etc.
        /// </param>

        /// <param name="affectedObjectFriendlyName">The friendly name of the source of the event on which it is raised (for
        /// example, VM, VMM etc).
        /// </param>

        /// <param name="affectedObjectCorrelationId">The affected object correlationId for the event.
        /// </param>

        /// <param name="severity">The severity of the event.
        /// </param>

        /// <param name="timeOfOccurrence">The time of occurrence of the event.
        /// </param>

        /// <param name="fabricId">The ARM ID of the fabric.
        /// </param>

        /// <param name="providerSpecificDetails">The provider specific settings.
        /// </param>

        /// <param name="eventSpecificDetails">The event specific settings.
        /// </param>

        /// <param name="healthErrors">The list of errors / warnings capturing details associated with the
        /// issue(s).
        /// </param>
        public EventProperties(string eventCode = default(string), string description = default(string), string eventType = default(string), string affectedObjectFriendlyName = default(string), string affectedObjectCorrelationId = default(string), string severity = default(string), System.DateTime? timeOfOccurrence = default(System.DateTime?), string fabricId = default(string), EventProviderSpecificDetails providerSpecificDetails = default(EventProviderSpecificDetails), EventSpecificDetails eventSpecificDetails = default(EventSpecificDetails), System.Collections.Generic.IList<HealthError> healthErrors = default(System.Collections.Generic.IList<HealthError>))
        ...
        /// <summary>
        /// Gets or sets the type of the event. for example: VM Health, Server Health,
        /// Job Failure etc.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the friendly name of the source of the event on which it is
        /// raised (for example, VM, VMM etc).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the list of errors / warnings capturing details associated
        /// with the issue(s).
        /// </summary>
