...
namespace Microsoft.Azure.Management.ResourceGraph.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        /// <param name="provider">Service provider: Microsoft Resource Graph.
        /// </param>

        /// <param name="resource">Resource on which the operation is performed etc.
        /// </param>

        /// <param name="operation">Type of operation: get, read, delete, etc.
        /// </param>

        /// <param name="description">Description for the operation.
        /// </param>
