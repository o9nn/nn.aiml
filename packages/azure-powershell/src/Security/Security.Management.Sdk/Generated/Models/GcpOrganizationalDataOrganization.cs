...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class GcpOrganizationalDataOrganization : GcpOrganizationalData
    {
        ...
        /// <param name="excludedProjectNumbers">If the multi cloud account is of membership type organization, list of
        /// accounts excluded from offering
        /// </param>

        /// <param name="serviceAccountEmailAddress">The service account email address which represents the organization level
        ...
        /// <summary>
        /// Gets or sets the GCP workload identity provider id which represents the
