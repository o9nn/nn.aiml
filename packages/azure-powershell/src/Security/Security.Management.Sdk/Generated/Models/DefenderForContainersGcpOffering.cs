...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class DefenderForContainersGcpOffering : CloudOffering
    {
        ...
        /// <param name="nativeCloudConnection">The native cloud connection configuration
        /// </param>

        /// <param name="dataPipelineNativeCloudConnection">The native cloud connection configuration
        /// </param>

        /// <param name="auditLogsAutoProvisioningFlag">Is audit logs data collection enabled
        /// </param>

        /// <param name="defenderAgentAutoProvisioningFlag">Is Microsoft Defender for Cloud Kubernetes agent auto provisioning enabled
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "nativeCloudConnection")]
        public DefenderForContainersGcpOfferingNativeCloudConnection NativeCloudConnection {get; set; }

        /// <summary>
        /// Gets or sets the native cloud connection configuration
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "dataPipelineNativeCloudConnection")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "auditLogsAutoProvisioningFlag")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "defenderAgentAutoProvisioningFlag")]
