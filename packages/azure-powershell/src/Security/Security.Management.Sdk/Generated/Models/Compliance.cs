...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class Compliance : Resource
    {
        ...
        /// </param>
        public Compliance(string id = default(string), string name = default(string), string type = default(string), System.DateTime? assessmentTimestampUtcDate = default(System.DateTime?), int? resourceCount = default(int?), System.Collections.Generic.IList<ComplianceSegment> assessmentResult = default(System.Collections.Generic.IList<ComplianceSegment>))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.assessmentTimestampUtcDate")]
