...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class Quota
    {
        ...
        /// <param name="currentValue">The current value of the quota. If null or missing, the current value
        /// cannot be determined in the context of the request.
        /// </param>

        /// <param name="id">The resource ID of the quota object
        /// </param>

        /// <param name="limit">The maximum value of the quota. If null or missing, the quota has no
        /// maximum, in which case it merely tracks usage.
        /// </param>

        /// <param name="name">The name of the quota
        /// </param>

        /// <param name="unit">The unit for the quota, such as Count, Bytes, BytesPerSecond, etc.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the current value of the quota. If null or missing, the
        ...
        /// <summary>
        /// Gets or sets the maximum value of the quota. If null or missing, the quota
        /// has no maximum, in which case it merely tracks usage.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the unit for the quota, such as Count, Bytes, BytesPerSecond,
        /// etc.
        /// </summary>
