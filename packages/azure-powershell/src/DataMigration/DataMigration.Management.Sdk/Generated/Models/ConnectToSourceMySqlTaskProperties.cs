...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToSourceMySqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// </param>
        public ConnectToSourceMySqlTaskProperties(System.Collections.Generic.IList<ODataError> errors = default(System.Collections.Generic.IList<ODataError>), string state = default(string), System.Collections.Generic.IList<CommandProperties> commands = default(System.Collections.Generic.IList<CommandProperties>), System.Collections.Generic.IDictionary<string, string> clientData = default(System.Collections.Generic.IDictionary<string, string>), ConnectToSourceMySqlTaskInput input = default(ConnectToSourceMySqlTaskInput), System.Collections.Generic.IList<ConnectToSourceNonSqlTaskOutput> output = default(System.Collections.Generic.IList<ConnectToSourceNonSqlTaskOutput>))
        ...
        public System.Collections.Generic.IList<ConnectToSourceNonSqlTaskOutput> Output {get; private set; }
        /// <summary>
        /// Validate the object.
        /// </summary>
