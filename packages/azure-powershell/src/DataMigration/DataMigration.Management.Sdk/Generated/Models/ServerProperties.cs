...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ServerProperties
    {
        ...
        /// <param name="serverPlatform">Name of the server platform
        /// </param>

        /// <param name="serverName">Name of the server
        /// </param>

        /// <param name="serverVersion">Version of the database server
        /// </param>

        /// <param name="serverEdition">Edition of the database server
        /// </param>

        /// <param name="serverOperatingSystemVersion">Version of the operating system
        /// </param>

        /// <param name="serverDatabaseCount">Number of databases in the server
        /// </param>
...

        {
            ...
            this.ServerDatabaseCount = serverDatabaseCount;
            CustomInit();
        }
