...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ProjectFileProperties
    {
        ...
        /// <param name="extension">Optional File extension. If submitted it should not have a leading period
        /// and must match the extension from filePath.
        /// </param>

        /// <param name="filePath">Relative path of this file resource. This property can be set when creating
        /// or updating the file resource.
        /// </param>

        /// <param name="lastModified">Modification DateTime.
        /// </param>

        /// <param name="mediaType">File content type. This property can be modified to reflect the file
        /// content type.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets optional File extension. If submitted it should not have a
        /// leading period and must match the extension from filePath.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "extension")]
        public string Extension {get; set; }

        /// <summary>
        /// Gets or sets relative path of this file resource. This property can be set
        /// when creating or updating the file resource.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "mediaType")]
