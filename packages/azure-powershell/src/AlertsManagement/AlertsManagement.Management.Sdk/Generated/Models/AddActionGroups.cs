...
namespace Microsoft.Azure.Management.AlertsManagement.Models
{
    ...
    public partial class AddActionGroups : Action
    {
        ...
        /// <param name="actionGroupIds">List of action group Ids to add to alert processing rule.
        /// </param>
        public AddActionGroups(System.Collections.Generic.IList<string> actionGroupIds)
        ...
        /// <summary>
        /// Gets or sets list of action group Ids to add to alert processing rule.
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ActionGroupIds");
            }
