...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class EncryptionIdentity
    {
        ...
        /// <param name="encryptionUserAssignedIdentity">Resource identifier of the UserAssigned identity to be associated with
        /// server-side encryption on the storage account.
        /// </param>

        /// <param name="encryptionFederatedIdentityClientId">ClientId of the multi-tenant application to be used in conjunction with the
        /// user-assigned identity for cross-tenant customer-managed-keys server-side
