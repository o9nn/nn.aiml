...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class ImmutableStorageAccount
    {
        ...
        /// <param name="enabled">A boolean flag which enables account-level immutability. All the containers
        /// under such an account have object-level immutability enabled by default.
        /// </param>

        /// <param name="immutabilityPolicy">Specifies the default account-level immutability policy which is inherited
        /// and applied to objects that do not possess an explicit immutability policy
        /// at the object level. The object-level immutability policy has higher
        /// precedence than the container-level immutability policy, which has a higher
        ...
        /// <summary>
        /// Gets or sets a boolean flag which enables account-level immutability. All
        /// the containers under such an account have object-level immutability enabled
        /// by default.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specifies the default account-level immutability policy which
        /// is inherited and applied to objects that do not possess an explicit
        /// immutability policy at the object level. The object-level immutability
        /// policy has higher precedence than the container-level immutability policy,
