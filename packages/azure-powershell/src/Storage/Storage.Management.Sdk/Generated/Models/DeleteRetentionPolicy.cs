...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class DeleteRetentionPolicy
    {
        ...
        /// <param name="enabled">Indicates whether DeleteRetentionPolicy is enabled.
        /// </param>

        /// <param name="days">Indicates the number of days that the deleted item should be retained. The
        /// minimum specified value can be 1 and the maximum value can be 365.
        /// </param>

        /// <param name="allowPermanentDelete">This property when set to true allows deletion of the soft deleted blob
        ...
        /// <summary>
        /// Gets or sets indicates the number of days that the deleted item should be
        /// retained. The minimum specified value can be 1 and the maximum value can be
        /// 365.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets this property when set to true allows deletion of the soft
        /// deleted blob versions and snapshots. This property cannot be used blob
        /// restore policy. This property only applies to blob service and does not
        /// apply to containers or file share.
        /// </summary>
