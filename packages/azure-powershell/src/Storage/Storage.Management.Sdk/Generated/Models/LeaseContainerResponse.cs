...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class LeaseContainerResponse
    {
        ...
        /// <param name="leaseId">Returned unique lease ID that must be included with any request to delete
        /// the container, or to renew, change, or release the lease.
        /// </param>

        /// <param name="leaseTimeSeconds">Approximate time remaining in the lease period, in seconds.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets returned unique lease ID that must be included with any
        /// request to delete the container, or to renew, change, or release the lease.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "leaseId")]
        public string LeaseId {get; set; }

        /// <summary>
        /// Gets or sets approximate time remaining in the lease period, in seconds.
        /// </summary>
