...
RequiredAssemblies = 'PaloAltoNetworks.Autorest/bin/Az.PaloAltoNetworks.private.dll'
...
FormatsToProcess = 'PaloAltoNetworks.Autorest/Az.PaloAltoNetworks.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('PaloAltoNetworks.Autorest/Az.PaloAltoNetworks.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for firewall metrics
