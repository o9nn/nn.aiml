...
{
    public class ContainerRegistryTagUpdateOperation : ContainerRegistryDataPlaneOperationBase<PSTagAttribute>
    {
        ...
        public override PSTagAttribute SendRequest()
        {
            _client.GetClient()
                   .Tag
                   .UpdateAttributesAsync(_repositoryName, _tag, _attribute.GetAttribute())
                   .GetAwaiter()
                   .GetResult();
            return new PSTagAttribute();
        }
    }
}