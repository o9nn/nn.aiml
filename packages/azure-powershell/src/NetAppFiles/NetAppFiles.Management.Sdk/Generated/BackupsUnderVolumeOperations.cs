...
namespace Microsoft.Azure.Management.NetApp
{
    ...
    /// </summary>
    internal partial class BackupsUnderVolumeOperations : Microsoft.Rest.IServiceOperations<NetAppManagementClient>, IBackupsUnderVolumeOperations
    {
        /// <summary>
        /// Initializes a new instance of the BackupsUnderVolumeOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal BackupsUnderVolumeOperations (NetAppManagementClient client)
        {
            if (client == null) 
            {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationHeaderResponse<BackupsUnderVolumeMigrateBackupsHeaders> _response = await BeginMigrateBackupsWithHttpMessagesAsync(resourceGroupName, accountName, poolName, volumeName, body, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationHeaderResponse<BackupsUnderVolumeMigrateBackupsHeaders>> BeginMigrateBackupsWithHttpMessagesAsync(string resourceGroupName, string accountName, string poolName, string volumeName, BackupsMigrationRequest body, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "BeginMigrateBackups", tracingParameters);
            }
            // Construct URL

            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/migrateBackups").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationHeaderResponse<BackupsUnderVolumeMigrateBackupsHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<BackupsUnderVolumeMigrateBackupsHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
