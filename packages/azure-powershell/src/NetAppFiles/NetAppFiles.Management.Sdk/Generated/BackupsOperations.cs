...
namespace Microsoft.Azure.Management.NetApp
{
    ...
    internal partial class BackupsOperations : Microsoft.Rest.IServiceOperations<NetAppManagementClient>, IBackupsOperations
    {
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<Backup,BackupsCreateHeaders> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, accountName, backupVaultName, backupName, body, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Backup,BackupsCreateHeaders>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string accountName, string backupVaultName, string backupName, Backup body, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Backup,BackupsCreateHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<BackupsCreateHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
