...
namespace Microsoft.Azure.Management.NetApp.Models
{
    ...
    public partial class Backup : ProxyResource
    {
        ...
        /// </param>
        public Backup(string volumeResourceId, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string backupType = default(string), string backupId = default(string), System.DateTime? creationDate = default(System.DateTime?), System.DateTime? snapshotCreationDate = default(System.DateTime?), System.DateTime? completionDate = default(System.DateTime?), string provisioningState = default(string), long? size = default(long?), string label = default(string), string failureReason = default(string), bool? useExistingSnapshot = default(bool?), string snapshotName = default(string), string backupPolicyResourceId = default(string), bool? isLargeVolume = default(bool?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.snapshotCreationDate")]
        public System.DateTime? SnapshotCreationDate {get; private set; }

        /// <summary>
        /// Gets the completion date of the backup
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.completionDate")]
