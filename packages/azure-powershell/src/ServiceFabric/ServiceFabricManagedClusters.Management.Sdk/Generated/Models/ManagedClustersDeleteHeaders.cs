...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedClustersDeleteHeaders
    {
        /// <summary>
        ...
        /// <param name="location">
        /// </param>
        public ManagedClustersDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
