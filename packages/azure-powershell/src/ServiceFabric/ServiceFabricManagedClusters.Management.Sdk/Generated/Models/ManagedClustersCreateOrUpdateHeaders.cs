...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedClustersCreateOrUpdateHeaders
    {
        /// <summary>
        ...
        /// <param name="location">
        /// </param>
        public ManagedClustersCreateOrUpdateHeaders(string azureAsyncOperation = default(string), string location = default(string))
