...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ApplicationTypeResource : ProxyResource
    {
        ...
        /// response.
        /// </param>
        public ApplicationTypeResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string etag = default(string), SystemData systemData = default(SystemData), string provisioningState = default(string))
