...
namespace Microsoft.Azure.Commands.Sql.ServerActiveDirectoryOnlyAuthentication.Cmdlet
{
    ...
    /// </summary>
    [Cmdlet("Enable", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SqlServerActiveDirectoryOnlyAuthentication", DefaultParameterSetName = UseResourceGroupAndServerNameParameterSet, SupportsShouldProcess = true)]
