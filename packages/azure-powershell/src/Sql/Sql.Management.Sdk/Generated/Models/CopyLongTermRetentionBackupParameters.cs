...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class CopyLongTermRetentionBackupParameters
    {
        ...
        /// <param name="targetSubscriptionId">The subscription that owns the target server
        /// </param>

        /// <param name="targetResourceGroup">The resource group that owns the target server
        /// </param>

        /// <param name="targetServerResourceId">The resource Id of the target server that owns the database
        /// </param>

        /// <param name="targetServerFullyQualifiedDomainName">The fully qualified domain name of the target server
        /// </param>

        /// <param name="targetDatabaseName">The name of the database owns the copied backup.
        /// </param>
