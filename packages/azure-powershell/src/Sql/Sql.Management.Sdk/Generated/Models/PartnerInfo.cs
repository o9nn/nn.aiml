...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class PartnerInfo
    {
        ...
        /// <param name="id">Resource identifier of the partner server.
        /// </param>

        /// <param name="location">Geo location of the partner server.
        /// </param>

        /// <param name="replicationRole">Replication role of the partner server.
