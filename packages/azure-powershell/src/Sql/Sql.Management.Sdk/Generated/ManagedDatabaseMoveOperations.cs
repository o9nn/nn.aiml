...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ManagedDatabaseMoveOperations : Microsoft.Rest.IServiceOperations<SqlManagementClient>, IManagedDatabaseMoveOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ManagedDatabaseMoveOperationResult>>> ListByLocationWithHttpMessagesAsync(string resourceGroupName, string locationName, Microsoft.Rest.Azure.OData.ODataQuery<ManagedDatabaseMoveOperationResult> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<ManagedDatabaseMoveOperationResult>), bool? onlyLatestPerDatabase = default(bool?), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _managedDatabaseMoveOperationResult = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_managedDatabaseMoveOperationResult))
                {
                    _queryParameters.Add(_managedDatabaseMoveOperationResult);
                }
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ManagedDatabaseMoveOperationResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<ManagedDatabaseMoveOperationResult>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ManagedDatabaseMoveOperationResult>> GetWithHttpMessagesAsync(string resourceGroupName, string locationName, System.Guid operationId, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ManagedDatabaseMoveOperationResult>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ManagedDatabaseMoveOperationResult>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
