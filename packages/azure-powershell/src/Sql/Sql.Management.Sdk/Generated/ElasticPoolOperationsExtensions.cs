...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class ElasticPoolOperationsExtensions
    {
        ...
        {
                ((IElasticPoolOperations)operations).CancelAsync(resourceGroupName, serverName, elasticPoolName, operationId).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ElasticPoolOperation> ListByElasticPoolNext(this IElasticPoolOperations operations, string nextPageLink)
        {
                return ((IElasticPoolOperations)operations).ListByElasticPoolNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ElasticPoolOperation>> ListByElasticPoolNextAsync(this IElasticPoolOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
