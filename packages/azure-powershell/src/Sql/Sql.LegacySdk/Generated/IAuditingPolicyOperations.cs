...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    public partial interface IAuditingPolicyOperations
    {
        ...
        /// request ID.
        /// </returns>
        Task<AzureOperationResponse> CreateOrUpdateServerPolicyAsync(string resourceGroupName, string serverName, ServerAuditingPolicyCreateOrUpdateParameters parameters, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<DatabaseAuditingPolicyGetResponse> GetDatabasePolicyAsync(string resourceGroupName, string serverName, string databaseName, CancellationToken cancellationToken);
        ...
        /// Represents the response to a get database auditing policy request.
        /// </returns>
        Task<ServerAuditingPolicyGetResponse> GetServerPolicyAsync(string resourceGroupName, string serverName, CancellationToken cancellationToken);
    }
}
