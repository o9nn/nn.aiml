...
namespace Microsoft.Azure.Management.Sql.LegacySdk
{
    ...
    /// update its state.
    /// </summary>
    public partial interface IDatabaseRecommendedActionOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<RecommendedActionGetResponse> GetAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, string recommendedActionName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<RecommendedActionListResponse> ListAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<RecommendedActionUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, string recommendedActionName, RecommendedActionUpdateParameters parameters, CancellationToken cancellationToken);
    }
}
