...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    /// </summary>
    internal partial class SecretsOperations : Microsoft.Rest.IServiceOperations<DevTestLabsClient>, ISecretsOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<Secret>>> ListWithHttpMessagesAsync(string labName, string userName, Microsoft.Rest.Azure.OData.ODataQuery<Secret> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<Secret>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _secret = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_secret))
                {
                    _queryParameters.Add(_secret);
                }
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<Secret>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<Secret>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Secret>> GetWithHttpMessagesAsync(string labName, string userName, string name, string expand = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Secret>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Secret>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Secret>> CreateOrUpdateWithHttpMessagesAsync(string labName, string userName, string name, Secret secret, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if(secret != null)
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(secret, this.Client.SerializationSettings);
