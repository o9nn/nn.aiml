...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    /// </summary>
    internal partial class ArmTemplatesOperations : Microsoft.Rest.IServiceOperations<DevTestLabsClient>, IArmTemplatesOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ArmTemplate>>> ListWithHttpMessagesAsync(string labName, string artifactSourceName, Microsoft.Rest.Azure.OData.ODataQuery<ArmTemplate> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<ArmTemplate>), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (odataQuery != null)
            {
                var _armTemplate = odataQuery.ToString();
                if (!string.IsNullOrEmpty(_armTemplate))
                {
                    _queryParameters.Add(_armTemplate);
                }
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ArmTemplate>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ArmTemplate>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ArmTemplate>> GetWithHttpMessagesAsync(string labName, string artifactSourceName, string name, string expand = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ArmTemplate>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ArmTemplate>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
