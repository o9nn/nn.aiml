...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.HybridConnectivity.Models
{
    ...
    public partial class ManagedProxyRequest
    {
        ...
        /// <param name="service">The name of the service.
        /// </param>

        /// <param name="hostname">The target host name.
        /// </param>

        /// <param name="serviceName">The name of the service. It is an optional property, if not provided,
        /// service configuration tokens issue code would be by passed.
        ...
        /// <summary>
        /// Gets or sets the name of the service. It is an optional property, if not
        /// provided, service configuration tokens issue code would be by passed. Possible values include: &#39;SSH&#39;, &#39;WAC&#39;
        /// </summary>
