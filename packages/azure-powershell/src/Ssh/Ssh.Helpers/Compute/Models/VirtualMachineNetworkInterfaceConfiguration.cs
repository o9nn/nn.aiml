...
namespace Microsoft.Azure.PowerShell.Ssh.Helpers.Compute.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceConfiguration
    {
        ...
        /// <param name="name">The network interface configuration name.
        /// </param>
        ...
        /// </param>
        public VirtualMachineNetworkInterfaceConfiguration(string name, bool? primary = default(bool?), string deleteOption = default(string), bool? enableAcceleratedNetworking = default(bool?), bool? disableTcpStateTracking = default(bool?), bool? enableFpga = default(bool?), bool? enableIPForwarding = default(bool?), SubResource networkSecurityGroup = default(SubResource), VirtualMachineNetworkInterfaceDnsSettingsConfiguration dnsSettings = default(VirtualMachineNetworkInterfaceDnsSettingsConfiguration), System.Collections.Generic.IList<VirtualMachineNetworkInterfaceIPConfiguration> ipConfigurations = default(System.Collections.Generic.IList<VirtualMachineNetworkInterfaceIPConfiguration>), SubResource dscpConfiguration = default(SubResource))
