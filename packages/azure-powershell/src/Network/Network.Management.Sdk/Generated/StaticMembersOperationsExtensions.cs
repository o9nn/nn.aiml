...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class StaticMembersOperationsExtensions
    {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<StaticMember> List(this IStaticMembersOperations operations, string resourceGroupName, string networkManagerName, string networkGroupName, int? top = default(int?), string skipToken = default(string))
        {
                return ((IStaticMembersOperations)operations).ListAsync(resourceGroupName, networkManagerName, networkGroupName, top, skipToken).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<StaticMember> ListNext(this IStaticMembersOperations operations, string nextPageLink)
        {
                return ((IStaticMembersOperations)operations).ListNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<StaticMember>> ListNextAsync(this IStaticMembersOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
