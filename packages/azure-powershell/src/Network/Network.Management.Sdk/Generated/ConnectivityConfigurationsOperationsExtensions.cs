...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class ConnectivityConfigurationsOperationsExtensions
    {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ConnectivityConfiguration> List(this IConnectivityConfigurationsOperations operations, string resourceGroupName, string networkManagerName, int? top = default(int?), string skipToken = default(string))
        {
                return ((IConnectivityConfigurationsOperations)operations).ListAsync(resourceGroupName, networkManagerName, top, skipToken).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ConnectivityConfiguration>> ListAsync(this IConnectivityConfigurationsOperations operations, string resourceGroupName, string networkManagerName, int? top = default(int?), string skipToken = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<ConnectivityConfiguration> ListNext(this IConnectivityConfigurationsOperations operations, string nextPageLink)
        {
                return ((IConnectivityConfigurationsOperations)operations).ListNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<ConnectivityConfiguration>> ListNextAsync(this IConnectivityConfigurationsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
