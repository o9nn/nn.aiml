...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class NetworkGroupsOperationsExtensions
    {
        ...
        {
                return ((INetworkGroupsOperations)operations).GetAsync(resourceGroupName, networkManagerName, networkGroupName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<NetworkGroup> GetAsync(this INetworkGroupsOperations operations, string resourceGroupName, string networkManagerName, string networkGroupName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// </param>
        public static NetworkGroup CreateOrUpdate(this INetworkGroupsOperations operations, string resourceGroupName, string networkManagerName, string networkGroupName, NetworkGroup parameters, string ifMatch = default(string))
        {
                return ((INetworkGroupsOperations)operations).CreateOrUpdateAsync(resourceGroupName, networkManagerName, networkGroupName, parameters, ifMatch).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<NetworkGroup> CreateOrUpdateAsync(this INetworkGroupsOperations operations, string resourceGroupName, string networkManagerName, string networkGroupName, NetworkGroup parameters, string ifMatch = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, networkManagerName, networkGroupName, parameters, ifMatch, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
        ...
        /// </param>
        public static Microsoft.Rest.Azure.IPage<NetworkGroup> ListNext(this INetworkGroupsOperations operations, string nextPageLink)
        {
                return ((INetworkGroupsOperations)operations).ListNextAsync(nextPageLink).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Rest.Azure.IPage<NetworkGroup>> ListNextAsync(this INetworkGroupsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
