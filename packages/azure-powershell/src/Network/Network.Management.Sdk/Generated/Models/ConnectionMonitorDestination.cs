...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ConnectionMonitorDestination
    {
        ...
        /// <param name="resourceId">The ID of the resource used as the destination by connection monitor.
        /// </param>

        /// <param name="address">Address of the connection monitor destination (IP or domain name).
        /// </param>

        /// <param name="port">The destination port used by connection monitor.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the ID of the resource used as the destination by connection
        /// monitor.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets address of the connection monitor destination (IP or domain
        /// name).
        /// </summary>
