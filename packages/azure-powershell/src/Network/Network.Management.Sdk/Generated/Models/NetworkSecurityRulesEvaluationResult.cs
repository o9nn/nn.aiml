...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class NetworkSecurityRulesEvaluationResult
    {
        ...
        /// <param name="name">Name of the network security rule.
        /// </param>

        /// <param name="protocolMatched">Value indicating whether protocol is matched.
        /// </param>

        /// <param name="sourceMatched">Value indicating whether source is matched.
        /// </param>

        /// <param name="sourcePortMatched">Value indicating whether source port is matched.
        /// </param>

        /// <param name="destinationMatched">Value indicating whether destination is matched.
        /// </param>

        /// <param name="destinationPortMatched">Value indicating whether destination port is matched.
        /// </param>
