...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class EffectiveBaseSecurityAdminRule
    {
        ...
        /// </param>
        public EffectiveBaseSecurityAdminRule(string id = default(string), string configurationDescription = default(string), string ruleCollectionDescription = default(string), System.Collections.Generic.IList<NetworkManagerSecurityGroupItem> ruleCollectionAppliesToGroups = default(System.Collections.Generic.IList<NetworkManagerSecurityGroupItem>), System.Collections.Generic.IList<ConfigurationGroup> ruleGroups = default(System.Collections.Generic.IList<ConfigurationGroup>))
