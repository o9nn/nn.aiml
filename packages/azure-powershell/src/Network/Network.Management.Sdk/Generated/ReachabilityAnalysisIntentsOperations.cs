...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class ReachabilityAnalysisIntentsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IReachabilityAnalysisIntentsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ReachabilityAnalysisIntentsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ReachabilityAnalysisIntentsOperations (NetworkManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ReachabilityAnalysisIntent>>> ListWithHttpMessagesAsync(string resourceGroupName, string networkManagerName, string workspaceName, string skipToken = default(string), int? skip = default(int?), int? top = default(int?), string sortKey = default(string), string sortValue = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/verifierWorkspaces/{workspaceName}/reachabilityAnalysisIntents").ToString();
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<ReachabilityAnalysisIntent>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ReachabilityAnalysisIntent>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ReachabilityAnalysisIntent>> GetWithHttpMessagesAsync(string resourceGroupName, string networkManagerName, string workspaceName, string reachabilityAnalysisIntentName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "reachabilityAnalysisIntentName");
            }
            if (reachabilityAnalysisIntentName != null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("networkManagerName", networkManagerName);
                tracingParameters.Add("workspaceName", workspaceName);
                tracingParameters.Add("reachabilityAnalysisIntentName", reachabilityAnalysisIntentName);
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/verifierWorkspaces/{workspaceName}/reachabilityAnalysisIntents/{reachabilityAnalysisIntentName}").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(this.Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{networkManagerName}", System.Uri.EscapeDataString(networkManagerName));
            _url = _url.Replace("{workspaceName}", System.Uri.EscapeDataString(workspaceName));
            _url = _url.Replace("{reachabilityAnalysisIntentName}", System.Uri.EscapeDataString(reachabilityAnalysisIntentName));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ReachabilityAnalysisIntent>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ReachabilityAnalysisIntent>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
