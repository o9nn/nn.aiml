...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class ManagementGroupNetworkManagerConnectionsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IManagementGroupNetworkManagerConnectionsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagementGroupNetworkManagerConnectionsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagementGroupNetworkManagerConnectionsOperations (NetworkManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<NetworkManagerConnection>> CreateOrUpdateWithHttpMessagesAsync(string managementGroupId, string networkManagerConnectionName, NetworkManagerConnection parameters, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("networkManagerConnectionName", networkManagerConnectionName);
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Network/networkManagerConnections/{networkManagerConnectionName}").ToString();
            _url = _url.Replace("{managementGroupId}", System.Uri.EscapeDataString(managementGroupId));
            _url = _url.Replace("{networkManagerConnectionName}", System.Uri.EscapeDataString(networkManagerConnectionName));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<NetworkManagerConnection>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<NetworkManagerConnection>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<NetworkManagerConnection>>> ListWithHttpMessagesAsync(string managementGroupId, int? top = default(int?), string skipToken = default(string), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Network/networkManagerConnections").ToString();
            _url = _url.Replace("{managementGroupId}", System.Uri.EscapeDataString(managementGroupId));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Rest.Azure.IPage<NetworkManagerConnection>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<NetworkManagerConnection>>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
