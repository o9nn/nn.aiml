        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    ...
                    this.NetworkManagerSecurityAdminRuleCollectionClient.Delete(this.ResourceGroupName, this.NetworkManagerName, this.SecurityAdminConfigurationName, this.Name, forceDelete);
