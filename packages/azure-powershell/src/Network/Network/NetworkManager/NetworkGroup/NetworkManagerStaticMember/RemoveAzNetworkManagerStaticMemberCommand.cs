...
{
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "NetworkManagerStaticMember", SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveAzNetworkManagerStaticMemberCommand : NetworkManagerStaticMemberBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
