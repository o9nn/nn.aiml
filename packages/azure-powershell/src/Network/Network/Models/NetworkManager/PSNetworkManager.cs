...
namespace Microsoft.Azure.Commands.Network.Models.NetworkManager
{
    ...
    public class PSNetworkManager : PSNetworkManagerBaseResource
    {
        ...
        {
            get { return JsonConvert.SerializeObject(NetworkManagerScopeAccesses, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }
