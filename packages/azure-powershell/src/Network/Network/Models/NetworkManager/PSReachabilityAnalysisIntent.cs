...
namespace Microsoft.Azure.Commands.Network.Models.NetworkManager
{
    ...
    public class PSReachabilityAnalysisIntent : PSResourceId
    {
        [Ps1Xml(Label = "Name", Target = ViewControl.Table, Position = 3)]
        public string Name { get; set; }

        [Ps1Xml(Label = "VerifierWorkspaceName", Target = ViewControl.Table, Position = 2)]
        ...
        public PSReachabilityAnalysisIntentProperties Properties { get; set; }
