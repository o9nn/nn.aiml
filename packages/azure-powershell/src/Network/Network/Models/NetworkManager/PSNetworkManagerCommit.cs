...
namespace Microsoft.Azure.Commands.Network.Models.NetworkManager
{
    ...
    public class PSNetworkManagerCommit
    {
        ...
        [JsonIgnore]
        public string TargetLocationsText
        {
            get { return JsonConvert.SerializeObject(TargetLocations, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }
