...
namespace Microsoft.Azure.Commands.Network.Models
{
    ...
    public class PSApplicationGatewaySslProfile : PSChildResource
    {
        ...
        public List<PSResourceId> TrustedClientCertificates { get; set; }
        ...
        [JsonIgnore]
        public string ClientAuthConfigurationText
        {
            get { return JsonConvert.SerializeObject(ClientAuthConfiguration, Formatting.Indented, new JsonSerializerSettings() { NullValueHandling = NullValueHandling.Ignore }); }
        }
