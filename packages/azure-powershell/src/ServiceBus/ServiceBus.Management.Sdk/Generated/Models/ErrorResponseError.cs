...
namespace Microsoft.Azure.Management.ServiceBus.Models
{
    ...
    public partial class ErrorResponseError
    {
        ...
        /// </param>
        public ErrorResponseError(string code = default(string), string message = default(string), string target = default(string), System.Collections.Generic.IList<ErrorResponse> details = default(System.Collections.Generic.IList<ErrorResponse>), System.Collections.Generic.IList<ErrorAdditionalInfo> additionalInfo = default(System.Collections.Generic.IList<ErrorAdditionalInfo>))
