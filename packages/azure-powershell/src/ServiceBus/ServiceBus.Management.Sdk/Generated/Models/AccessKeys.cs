...
namespace Microsoft.Azure.Management.ServiceBus.Models
{
    ...
    public partial class AccessKeys
    {
        ...
        /// <param name="primaryConnectionString">Primary connection string of the created namespace authorization rule.
        /// </param>

        /// <param name="secondaryConnectionString">Secondary connection string of the created namespace authorization rule.
        /// </param>

        /// <param name="aliasPrimaryConnectionString">Primary connection string of the alias if GEO DR is enabled
        /// </param>

        /// <param name="aliasSecondaryConnectionString">Secondary  connection string of the alias if GEO DR is enabled
        /// </param>

        /// <param name="primaryKey">A base64-encoded 256-bit primary key for signing and validating the SAS
        /// token.
        /// </param>

        /// <param name="secondaryKey">A base64-encoded 256-bit primary key for signing and validating the SAS
        /// token.
        /// </param>

        /// <param name="keyName">A string that describes the authorization rule.
        /// </param>
        ...
        /// <summary>
        /// Gets secondary connection string of the created namespace authorization
        /// rule.
        /// </summary>
        ...
        /// <summary>
        /// Gets a base64-encoded 256-bit primary key for signing and validating the
        /// SAS token.
        /// </summary>
