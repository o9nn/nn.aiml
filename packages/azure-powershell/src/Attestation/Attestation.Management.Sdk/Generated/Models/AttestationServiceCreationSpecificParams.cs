...
namespace Microsoft.Azure.Management.Attestation.Models
{
    ...
    public partial class AttestationServiceCreationSpecificParams
    {
        ...
        /// <param name="attestationPolicy">Name of attestation policy.
        /// </param>

        /// <param name="policySigningCertificates">JSON Web Key Set defining a set of X.509 Certificates that will represent
