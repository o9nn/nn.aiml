...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class StorageSyncServicesUpdateHeaders
    {
        ...
        /// </param>
        public StorageSyncServicesUpdateHeaders(string xmsRequestId = default(string), string xmsCorrelationRequestId = default(string), string azureAsyncOperation = default(string), string location = default(string), string retryAfter = default(string))
