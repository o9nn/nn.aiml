...
namespace Microsoft.Azure.Management.SignalR
{
    ...
    /// </summary>
    internal partial class SignalRCustomDomainsOperations : Microsoft.Rest.IServiceOperations<SignalRManagementClient>, ISignalRCustomDomainsOperations
    {
        /// <summary>
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse<CustomDomain> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, resourceName, name, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        {
                // Send Request
                Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, resourceName, name, customHeaders, cancellationToken).ConfigureAwait(false);
