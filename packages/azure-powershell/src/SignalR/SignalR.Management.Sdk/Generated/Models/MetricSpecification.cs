...
namespace Microsoft.Azure.Management.SignalR.Models
{
    ...
    public partial class MetricSpecification
    {
        ...
        /// <param name="displayName">Localized friendly display name of the metric.
        /// </param>

        /// <param name="displayDescription">Localized friendly description of the metric.
        /// </param>

        /// <param name="unit">The unit that makes sense for the metric.
        /// </param>

        /// <param name="aggregationType">Only provide one value for this field. Valid values: Average, Minimum,
        /// Maximum, Total, Count.
        /// </param>

        /// <param name="fillGapWithZero">Optional. If set to true, then zero will be returned for time duration
        ...
        /// <param name="category">The name of the metric category that the metric belongs to. A metric can
        /// only belong to a single category.
        /// </param>

        /// <param name="dimensions">The dimensions of the metrics.
        /// </param>
        public MetricSpecification(string name = default(string), string displayName = default(string), string displayDescription = default(string), string unit = default(string), string aggregationType = default(string), string fillGapWithZero = default(string), string category = default(string), System.Collections.Generic.IList<Dimension> dimensions = default(System.Collections.Generic.IList<Dimension>))
