...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class WorkloadClassifier : ProxyResource
    {
        ...
        /// </param>
        public WorkloadClassifier(string id = default(string), string name = default(string), string type = default(string), string memberName = default(string), string label = default(string), string context = default(string), string startTime = default(string), string endTime = default(string), string importance = default(string))
