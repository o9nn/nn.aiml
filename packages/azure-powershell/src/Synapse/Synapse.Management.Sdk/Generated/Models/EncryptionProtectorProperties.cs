...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class EncryptionProtectorProperties
    {
        ...
        /// </param>
        public EncryptionProtectorProperties(string serverKeyType, string subregion = default(string), string serverKeyName = default(string), string uri = default(string), string thumbprint = default(string))
