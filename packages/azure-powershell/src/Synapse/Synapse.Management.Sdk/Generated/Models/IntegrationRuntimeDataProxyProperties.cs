...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class IntegrationRuntimeDataProxyProperties
    {
        ...
        /// <param name="connectVia">The self-hosted integration runtime reference.
        /// </param>

        /// <param name="stagingLinkedService">The staging linked service reference.
        /// </param>

        /// <param name="path">The path to contain the staged data in the Blob storage.
        /// </param>
