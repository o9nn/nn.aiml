...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class WorkspaceRepositoryConfiguration
    {
        ...
        /// <param name="type">Type of workspace repositoryID configuration. Example
        ...
        /// <param name="rootFolder">Root folder to use in the repository
        /// </param>

        /// <param name="lastCommitId">The last commit ID
        /// </param>

        /// <param name="tenantId">The VSTS tenant ID
        /// </param>
