...
{
    [Cmdlet(VerbsLifecycle.Disable, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.Sql + SynapseConstants.AdvancedDataSecurity,
           DefaultParameterSetName = DisableByNameParameterSet, SupportsShouldProcess = true)]
    [Alias("Disable-AzSynapseSqlAdvancedThreatProtection")]
    [OutputType(typeof(WorkspaceAdvancedDataSecurityPolicy))]
    public class DisableAzureSynapseSqlAdvancedDataSecurity : SynapseManagementCmdletBase
    {
        ...
        [Parameter(ParameterSetName = DisableByNameParameterSet, Mandatory = false,
            HelpMessage = HelpMessages.ResourceGroupName)]
        [ResourceGroupCompleter()]
        [ValidateNotNullOrEmpty]
        public string ResourceGroupName { get; set; }

        [Parameter(ParameterSetName = DisableByNameParameterSet,
            Mandatory = true, HelpMessage = HelpMessages.WorkspaceName)]
        [ResourceNameCompleter(ResourceTypes.Workspace, nameof(ResourceGroupName))]
        [ValidateNotNullOrEmpty]
        public string WorkspaceName { get; set; }

        [Parameter(ValueFromPipeline = true, ParameterSetName = DisableByInputObjectParameterSet,
