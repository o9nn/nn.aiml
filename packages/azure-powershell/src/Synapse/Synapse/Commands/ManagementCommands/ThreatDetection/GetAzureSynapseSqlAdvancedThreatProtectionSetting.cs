...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + SynapseConstants.SynapsePrefix + SynapseConstants.Sql + SynapseConstants.AdvancedThreatProtectionSetting, DefaultParameterSetName = GetByNameParameterSet)]
    [OutputType(typeof(PSServerSecurityAlertPolicy))]
    public class GetAzureSynapseSqlAdvancedThreatProtectionSetting : SynapseManagementCmdletBase
    {
