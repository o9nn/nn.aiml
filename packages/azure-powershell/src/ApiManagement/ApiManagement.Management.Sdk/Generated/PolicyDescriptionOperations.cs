...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class PolicyDescriptionOperations : Microsoft.Rest.IServiceOperations<ApiManagementClient>, IPolicyDescriptionOperations
    {
        /// <summary>
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<PolicyDescriptionCollection>> ListByServiceWithHttpMessagesAsync(string resourceGroupName, string serviceName, PolicyScopeContract? scope = default(PolicyScopeContract?), System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (scope != null)
            {
                _queryParameters.Add(string.Format("scope={0}", System.Uri.EscapeDataString(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(scope, this.Client.SerializationSettings).Trim('"'))));
            }
            if (this.Client.ApiVersion != null)
            {
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<PolicyDescriptionCollection>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<PolicyDescriptionCollection>(_responseContent, this.Client.DeserializationSettings);
                }
