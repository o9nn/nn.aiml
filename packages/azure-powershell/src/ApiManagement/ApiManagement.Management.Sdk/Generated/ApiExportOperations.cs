...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class ApiExportOperations : Microsoft.Rest.IServiceOperations<ApiManagementClient>, IApiExportOperations
    {
        /// <summary>
        /// Initializes a new instance of the ApiExportOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ApiExportOperations (ApiManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ApiExportResult>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, string apiId, string format, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("export", export);
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ApiExportResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ApiExportResult>(_responseContent, this.Client.DeserializationSettings);
                }
