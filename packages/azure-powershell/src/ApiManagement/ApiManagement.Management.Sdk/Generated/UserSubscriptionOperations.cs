...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class UserSubscriptionOperations : Microsoft.Rest.IServiceOperations<ApiManagementClient>, IUserSubscriptionOperations
    {
        /// <summary>
        /// Initializes a new instance of the UserSubscriptionOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal UserSubscriptionOperations (ApiManagementClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<SubscriptionContract,UserSubscriptionGetHeaders>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, string userId, string sid, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/subscriptions/{sid}").ToString();
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{serviceName}", System.Uri.EscapeDataString(serviceName));
            _url = _url.Replace("{userId}", System.Uri.EscapeDataString(userId));
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<SubscriptionContract,UserSubscriptionGetHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<UserSubscriptionGetHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
