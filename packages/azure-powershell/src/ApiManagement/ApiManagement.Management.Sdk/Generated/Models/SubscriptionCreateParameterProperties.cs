...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SubscriptionCreateParameterProperties class.
        /// </summary>
        ...
        /// </param>
        public SubscriptionCreateParameterProperties(string scope, string displayName, string ownerId = default(string), string primaryKey = default(string), string secondaryKey = default(string), SubscriptionState? state = default(SubscriptionState?), bool? allowTracing = default(bool?))
