...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class IssueUpdateContract
    {
        ...
        /// </param>
        public IssueUpdateContract(string state = default(string), System.DateTime? createdDate = default(System.DateTime?), string apiId = default(string), string title = default(string), string description = default(string), string userId = default(string))
