...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class IssueUpdateContractProperties : IssueContractBaseProperties
    {
        /// <summary>
        /// Initializes a new instance of the IssueUpdateContractProperties class.
        /// </summary>
        ...
        /// </param>
        public IssueUpdateContractProperties(System.DateTime? createdDate = default(System.DateTime?), string state = default(string), string apiId = default(string), string title = default(string), string description = default(string), string userId = default(string))
