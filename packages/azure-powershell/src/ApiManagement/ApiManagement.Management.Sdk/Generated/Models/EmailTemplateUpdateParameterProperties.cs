...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the EmailTemplateUpdateParameterProperties class.
        /// </summary>
        ...
        /// </param>
        public EmailTemplateUpdateParameterProperties(string subject = default(string), string title = default(string), string description = default(string), string body = default(string), System.Collections.Generic.IList<EmailTemplateParametersContractProperties> parameters = default(System.Collections.Generic.IList<EmailTemplateParametersContractProperties>))
