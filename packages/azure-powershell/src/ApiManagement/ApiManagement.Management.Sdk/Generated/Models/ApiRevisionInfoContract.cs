...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ApiRevisionInfoContract
    {
        ...
        /// <param name="sourceApiId">Resource identifier of API to be used to create the revision from.
        /// </param>

        /// <param name="apiVersionName">Version identifier for the new API Version.
        /// </param>

        /// <param name="apiRevisionDescription">Description of new API Revision.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets resource identifier of API to be used to create the revision
        /// from.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "apiVersionSet")]
        ...
        public virtual void Validate()
        {
            ...
            if (this.ApiVersionName != null)
            {
                if (this.ApiVersionName.Length > 100)
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxLength, "ApiVersionName", 100);
                }
            }
