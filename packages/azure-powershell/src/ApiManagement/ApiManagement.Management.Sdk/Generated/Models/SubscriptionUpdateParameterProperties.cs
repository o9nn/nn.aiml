...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SubscriptionUpdateParameterProperties class.
        /// </summary>
        ...
        /// </param>
        public SubscriptionUpdateParameterProperties(string ownerId = default(string), string scope = default(string), System.DateTime? expirationDate = default(System.DateTime?), string displayName = default(string), string primaryKey = default(string), string secondaryKey = default(string), SubscriptionState? state = default(SubscriptionState?), string stateComment = default(string), bool? allowTracing = default(bool?))
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "stateComment")]
        public string StateComment {get; set; }

        /// <summary>
        /// Gets or sets determines whether tracing can be enabled
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "allowTracing")]
