...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class CacheUpdateProperties
    {
        ...
        /// </param>
        public CacheUpdateProperties(string description = default(string), string connectionString = default(string), string useFromLocation = default(string), string resourceId = default(string))
