...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ApiCreateOrUpdatePropertiesWsdlSelector
    {
        ...
        /// <param name="wsdlServiceName">Name of service to import from WSDL
        /// </param>

        /// <param name="wsdlEndpointName">Name of endpoint(port) to import from WSDL
        /// </param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "wsdlServiceName")]
        public string WsdlServiceName {get; set; }

        /// <summary>
        /// Gets or sets name of endpoint(port) to import from WSDL
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "wsdlEndpointName")]
