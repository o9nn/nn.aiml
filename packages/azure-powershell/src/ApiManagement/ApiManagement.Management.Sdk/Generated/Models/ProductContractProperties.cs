...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// Product profile.
    /// </summary>
    public partial class ProductContractProperties : ProductEntityBaseParameters
    {
        /// <summary>
        /// Initializes a new instance of the ProductContractProperties class.
        /// </summary>
        ...
        /// </param>
        public ProductContractProperties(string displayName, string description = default(string), string terms = default(string), bool? subscriptionRequired = default(bool?), bool? approvalRequired = default(bool?), int? subscriptionsLimit = default(int?), ProductState? state = default(ProductState?))
