...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ApiVersionSetUpdateParameters
    {
        ...
        /// </param>
        public ApiVersionSetUpdateParameters(string versioningScheme = default(string), string description = default(string), string versionQueryName = default(string), string versionHeaderName = default(string), string displayName = default(string))
