...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public enum PrivateEndpointConnectionProvisioningState
    {
        ...
        Creating,
        /// <summary>
        /// The user has requested that the connection status be updated, but the
        /// update operation has not yet completed. You may not reference the
        /// connection when connecting the Batch account.
        /// </summary>
        ...
        Succeeded,
        /// <summary>
        /// The user requested that the connection be updated and it failed. You may
