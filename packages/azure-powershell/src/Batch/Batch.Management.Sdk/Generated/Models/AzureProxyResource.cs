...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class AzureProxyResource : Microsoft.Rest.Azure.IResource
    {
        ...
        /// </param>
        public AzureProxyResource(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>))
