...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SqlDWSource : TabularSource
    {
        ...
        /// <param name="sqlReaderQuery">SQL Data Warehouse reader query. Type: string (or Expression with
        /// resultType string).
        /// </param>

        /// <param name="sqlReaderStoredProcedureName">Name of the stored procedure for a SQL Data Warehouse source. This cannot
        ...
        /// &#34;{Parameter1: {value: &#34;1&#34;, type: &#34;int&#34;}}&#34;. Type: object (or Expression with
        /// resultType object), itemType: StoredProcedureParameter.
        /// </param>
        ...
        /// </param>
        public SqlDWSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object queryTimeout = default(object), object additionalColumns = default(object), object sqlReaderQuery = default(object), object sqlReaderStoredProcedureName = default(object), object storedProcedureParameters = default(object), object isolationLevel = default(object), object partitionOption = default(object), SqlPartitionSettings partitionSettings = default(SqlPartitionSettings))
        ...
        /// <summary>
        /// Gets or sets sQL Data Warehouse reader query. Type: string (or Expression
        /// with resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets name of the stored procedure for a SQL Data Warehouse source.
