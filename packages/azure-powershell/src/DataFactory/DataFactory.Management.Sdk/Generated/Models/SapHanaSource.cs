...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SapHanaSource : TabularSource
    {
        ...
        /// <param name="query">SAP HANA Sql query. Type: string (or Expression with resultType string).
        /// </param>

        /// <param name="packetSize">The packet size of data read from SAP HANA. Type: integer(or Expression
        /// with resultType integer).
        /// </param>

        /// <param name="partitionOption">The partition mechanism that will be used for SAP HANA read in parallel.
        ...
        /// <summary>
        /// Gets or sets the packet size of data read from SAP HANA. Type: integer(or
        ...
        /// <summary>
        /// Gets or sets the partition mechanism that will be used for SAP HANA read in
        ...
        /// <summary>
        /// Gets or sets the settings that will be leveraged for SAP HANA source
        /// partitioning.
        /// </summary>
