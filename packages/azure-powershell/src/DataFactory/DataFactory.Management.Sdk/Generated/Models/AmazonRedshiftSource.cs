...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AmazonRedshiftSource : TabularSource
    {
        ...
        /// <param name="redshiftUnloadSettings">The Amazon S3 settings needed for the interim Amazon S3 when copying from
        ...
        /// <summary>
        /// Gets or sets the Amazon S3 settings needed for the interim Amazon S3 when
        /// copying from Amazon Redshift with unload. With this, data from Amazon
        /// Redshift source will be unloaded into S3 first and then copied into the
