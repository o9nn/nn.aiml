...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("MySqlTable")]
    [Microsoft.Rest.Serialization.JsonTransformation]
    public partial class MySqlTableDataset : Dataset
    {
        /// <summary>
        /// Initializes a new instance of the MySqlTableDataset class.
        /// </summary>
        ...
        /// <param name="tableName">The MySQL table name. Type: string (or Expression with resultType string).
        /// </param>
        public MySqlTableDataset(LinkedServiceReference linkedServiceName, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object))
        ...
        /// <summary>
        /// Gets or sets the MySQL table name. Type: string (or Expression with
        /// resultType string).
        /// </summary>
