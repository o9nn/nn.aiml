...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("OracleTable")]
    ...
    public partial class OracleTableDataset : Dataset
    {
        ...
        /// <param name="typePropertiesSchema">The schema name of the on-premises Oracle database. Type: string (or
        /// Expression with resultType string).
        /// </param>

        /// <param name="table">The table name of the on-premises Oracle database. Type: string (or
        /// Expression with resultType string).
        /// </param>
        public OracleTableDataset(LinkedServiceReference linkedServiceName, System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), System.Collections.Generic.IDictionary<string, ParameterSpecification> parameters = default(System.Collections.Generic.IDictionary<string, ParameterSpecification>), System.Collections.Generic.IList<object> annotations = default(System.Collections.Generic.IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object), object typePropertiesSchema = default(object), object table = default(object))
        ...
        /// <summary>
        /// Gets or sets the schema name of the on-premises Oracle database. Type:
        ...
        /// <summary>
        /// Gets or sets the table name of the on-premises Oracle database. Type:
        /// string (or Expression with resultType string).
        /// </summary>
