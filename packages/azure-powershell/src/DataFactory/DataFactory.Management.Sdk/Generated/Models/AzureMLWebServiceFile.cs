...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class AzureMLWebServiceFile
    {
        ...
        /// <param name="filePath">The relative file path, including container name, in the Azure Blob Storage
        /// specified by the LinkedService. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="linkedServiceName">Reference to an Azure Storage LinkedService, where Azure ML WebService
        ...
        /// <summary>
        /// Gets or sets the relative file path, including container name, in the Azure
        /// Blob Storage specified by the LinkedService. Type: string (or Expression
        ...
        /// <summary>
        /// Gets or sets reference to an Azure Storage LinkedService, where Azure ML
        /// WebService Input/Output file located.
        /// </summary>
