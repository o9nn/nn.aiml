...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class SkipErrorFile
    {
        ...
        /// <param name="fileMissing">Skip if file is deleted by other client during copy. Default is true. Type:
        /// boolean (or Expression with resultType boolean).
        /// </param>

        /// <param name="dataInconsistency">Skip if source/sink file changed by other concurrent write. Default is
        ...
        /// <summary>
        /// Gets or sets skip if file is deleted by other client during copy. Default
        ...
        /// <summary>
        /// Gets or sets skip if source/sink file changed by other concurrent write.
