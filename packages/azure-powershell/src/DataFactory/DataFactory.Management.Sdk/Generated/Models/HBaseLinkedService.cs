...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class HBaseLinkedService : LinkedService
    {
        ...
        /// <param name="host">The IP address or host name of the HBase server. (i.e. 192.168.222.160)
        /// </param>

        /// <param name="port">The TCP port that the HBase instance uses to listen for client connections.
        /// The default value is 9090.
        /// </param>

        /// <param name="httpPath">The partial URL corresponding to the HBase server. (i.e.
        /// /gateway/sandbox/hbase/version)
        /// </param>

        /// <param name="authenticationType">The authentication mechanism to use to connect to the HBase server.
        /// Possible values include: &#39;Anonymous&#39;, &#39;Basic&#39;</param>

        /// <param name="username">The user name used to connect to the HBase instance.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the TCP port that the HBase instance uses to listen for client
        ...
        /// <summary>
        /// Gets or sets the partial URL corresponding to the HBase server. (i.e.
        /// /gateway/sandbox/hbase/version)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the authentication mechanism to use to connect to the HBase
        /// server. Possible values include: &#39;Anonymous&#39;, &#39;Basic&#39;
        /// </summary>
