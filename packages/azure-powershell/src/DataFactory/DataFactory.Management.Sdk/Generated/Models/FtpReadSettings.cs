...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class FtpReadSettings : StoreReadSettings
    {
        ...
        /// <param name="wildcardFolderPath">Ftp wildcardFolderPath. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="wildcardFileName">Ftp wildcardFileName. Type: string (or Expression with resultType string).
        /// </param>
        ...
        /// <param name="useBinaryTransfer">Specify whether to use binary transfer mode for FTP stores. Type: boolean
        /// (or Expression with resultType boolean).
        /// </param>

        /// <param name="disableChunking">If true, disable parallel reading within each file. Default is false. Type:
        /// boolean (or Expression with resultType boolean).
        /// </param>
        public FtpReadSettings(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object recursive = default(object), object wildcardFolderPath = default(object), object wildcardFileName = default(object), object enablePartitionDiscovery = default(object), object partitionRootPath = default(object), object deleteFilesAfterCompletion = default(object), object fileListPath = default(object), object useBinaryTransfer = default(object), object disableChunking = default(object))
        ...
        /// <summary>
        /// Gets or sets ftp wildcardFolderPath. Type: string (or Expression with
        /// resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specify whether to use binary transfer mode for FTP stores.
        /// Type: boolean (or Expression with resultType boolean).
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "useBinaryTransfer")]
        public object UseBinaryTransfer {get; set; }

        /// <summary>
        /// Gets or sets if true, disable parallel reading within each file. Default is
