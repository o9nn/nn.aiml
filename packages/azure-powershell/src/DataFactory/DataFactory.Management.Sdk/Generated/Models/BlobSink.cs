...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class BlobSink : CopySink
    {
        ...
        /// <param name="blobWriterOverwriteFiles">Blob writer overwrite files. Type: boolean (or Expression with resultType
        /// boolean).
        /// </param>

        /// <param name="blobWriterDateTimeFormat">Blob writer date time format. Type: string (or Expression with resultType
        /// string).
        /// </param>

        /// <param name="blobWriterAddHeader">Blob writer add header. Type: boolean (or Expression with resultType
        /// boolean).
        /// </param>
        ...
        /// </param>
        public BlobSink(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object writeBatchSize = default(object), object writeBatchTimeout = default(object), object sinkRetryCount = default(object), object sinkRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object blobWriterOverwriteFiles = default(object), object blobWriterDateTimeFormat = default(object), object blobWriterAddHeader = default(object), object copyBehavior = default(object), System.Collections.Generic.IList<MetadataItem> metadata = default(System.Collections.Generic.IList<MetadataItem>))
        ...
        /// <summary>
        /// Gets or sets blob writer overwrite files. Type: boolean (or Expression with
        /// resultType boolean).
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "blobWriterOverwriteFiles")]
        public object BlobWriterOverwriteFiles {get; set; }

        /// <summary>
        /// Gets or sets blob writer date time format. Type: string (or Expression with
        /// resultType string).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets blob writer add header. Type: boolean (or Expression with
        /// resultType boolean).
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "blobWriterAddHeader")]
