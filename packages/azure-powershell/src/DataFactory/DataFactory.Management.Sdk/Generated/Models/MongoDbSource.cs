...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class MongoDbSource : CopySource
    {
        ...
        /// <param name="query">Database query. Should be a SQL-92 query expression. Type: string (or
        ...
        /// objects).
        /// </param>
        public MongoDbSource(System.Collections.Generic.IDictionary<string, object> additionalProperties = default(System.Collections.Generic.IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object disableMetricsCollection = default(object), object query = default(object), object additionalColumns = default(object))
        ...
        /// <summary>
        /// Gets or sets database query. Should be a SQL-92 query expression. Type:
