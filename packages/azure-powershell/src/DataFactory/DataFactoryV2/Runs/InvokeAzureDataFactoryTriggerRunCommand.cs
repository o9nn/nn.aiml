...
{
    [Cmdlet("Invoke", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "DataFactoryV2TriggerRun", DefaultParameterSetName = ParameterSetNames.ByFactoryNameByParameterFile,SupportsShouldProcess = true), OutputType(typeof(PSPipeline))]
    public class InvokeAzureDataFactoryTriggerRunCommand : DataFactoryContextBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                DataFactoryClient.RerunTriggerRun(ResourceGroupName, DataFactoryName, TriggerName, TriggerRunId);
            }
