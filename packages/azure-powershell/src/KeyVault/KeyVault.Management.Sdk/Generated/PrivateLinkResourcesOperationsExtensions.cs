...
namespace Microsoft.Azure.Management.KeyVault
{
    ...
    public static partial class PrivateLinkResourcesOperationsExtensions
    {
        ...
        {
                return ((IPrivateLinkResourcesOperations)operations).ListByVaultAsync(resourceGroupName, vaultName).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async System.Threading.Tasks.Task<PrivateLinkResourceListResult> ListByVaultAsync(this IPrivateLinkResourcesOperations operations, string resourceGroupName, string vaultName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
