#
# Module manifest for module 'Az.IoTOperationsService'
#
...
RequiredAssemblies = 
               'IoTOperationsService.Autorest/bin/Az.IoTOperationsService.private.dll'
...
FormatsToProcess = 
               'IoTOperationsService.Autorest/Az.IoTOperationsService.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('IoTOperationsService.Autorest/Az.IoTOperationsService.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzIoTOperationsServiceBroker', 
               ...
               'Remove-AzIoTOperationsServiceBrokerListener', 
