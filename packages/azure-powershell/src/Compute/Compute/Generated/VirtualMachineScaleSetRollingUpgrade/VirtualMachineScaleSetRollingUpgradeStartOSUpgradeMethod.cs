...
{
    [Cmdlet(VerbsLifecycle.Start, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "VmssRollingOSUpgrade", DefaultParameterSetName = "DefaultParameter", SupportsShouldProcess = true)]
