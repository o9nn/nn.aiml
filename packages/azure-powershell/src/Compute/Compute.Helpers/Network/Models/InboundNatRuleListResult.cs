...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Helpers.Network.Models
{
    ...
    public partial class InboundNatRuleListResult
    {
        ...
        /// Initializes a new instance of the InboundNatRuleListResult class.
        /// </summary>
        /// <param name="value">A list of inbound nat rules in a load
        /// balancer.</param>
        /// <param name="nextLink">The URL to get the next set of
        /// results.</param>
        public InboundNatRuleListResult(IList<InboundNatRule> value = default(IList<InboundNatRule>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<InboundNatRule> Value { get; set; }
