...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Helpers.Network.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the LoadBalancerProbeListResult
        /// class.
        /// </summary>
        ...
        /// results.</param>
        public LoadBalancerProbeListResult(IList<Probe> value = default(IList<Probe>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        /// <summary>
        /// Gets or sets a list of probes in a load balancer.
        /// </summary>
        [JsonProperty(PropertyName = "value")]
        public IList<Probe> Value { get; set; }
