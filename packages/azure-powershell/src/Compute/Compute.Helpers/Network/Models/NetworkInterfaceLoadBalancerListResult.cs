...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Helpers.Network.Models
{
    ...
    public partial class NetworkInterfaceLoadBalancerListResult
    {
        ...
        /// NetworkInterfaceLoadBalancerListResult class.
        /// </summary>
        ...
        /// results.</param>
        public NetworkInterfaceLoadBalancerListResult(IList<LoadBalancer> value = default(IList<LoadBalancer>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
