...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryImagesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleryImagesUpdateHeaders class.
        /// </summary>
        public GalleryImagesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryImagesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
