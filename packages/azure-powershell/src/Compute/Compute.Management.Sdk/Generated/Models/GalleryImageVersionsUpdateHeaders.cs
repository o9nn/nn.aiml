...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryImageVersionsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GalleryImageVersionsUpdateHeaders
        /// class.
        /// </summary>
        public GalleryImageVersionsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryImageVersionsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
