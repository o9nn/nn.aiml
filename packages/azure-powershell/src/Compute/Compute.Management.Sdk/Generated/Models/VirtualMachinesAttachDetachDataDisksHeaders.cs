...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// <summary>
    /// Defines headers for AttachDetachDataDisks operation.
    /// </summary>
    public partial class VirtualMachinesAttachDetachDataDisksHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachinesAttachDetachDataDisksHeaders class.
        /// </summary>
        public VirtualMachinesAttachDetachDataDisksHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesAttachDetachDataDisksHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
