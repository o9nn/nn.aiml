...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryApplicationsCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryApplicationsCreateOrUpdateHeaders class.
        /// </summary>
        public GalleryApplicationsCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryApplicationsCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
