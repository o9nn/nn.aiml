...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class DedicatedHostsRestartHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DedicatedHostsRestartHeaders
        /// class.
        /// </summary>
        public DedicatedHostsRestartHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public DedicatedHostsRestartHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
