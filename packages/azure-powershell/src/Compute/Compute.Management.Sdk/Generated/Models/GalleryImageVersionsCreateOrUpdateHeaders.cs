...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryImageVersionsCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryImageVersionsCreateOrUpdateHeaders class.
        /// </summary>
        public GalleryImageVersionsCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryImageVersionsCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
