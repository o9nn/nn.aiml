...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryInVMAccessControlProfileVersionsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryInVMAccessControlProfileVersionsUpdateHeaders class.
        /// </summary>
        public GalleryInVMAccessControlProfileVersionsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryInVMAccessControlProfileVersionsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
