...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVMRunCommandsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetVMRunCommandsUpdateHeaders class.
        /// </summary>
        public VirtualMachineScaleSetVMRunCommandsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineScaleSetVMRunCommandsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
