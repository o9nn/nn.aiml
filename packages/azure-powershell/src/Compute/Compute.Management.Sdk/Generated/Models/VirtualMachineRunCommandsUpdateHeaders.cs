...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineRunCommandsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineRunCommandsUpdateHeaders class.
        /// </summary>
        public VirtualMachineRunCommandsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachineRunCommandsUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
