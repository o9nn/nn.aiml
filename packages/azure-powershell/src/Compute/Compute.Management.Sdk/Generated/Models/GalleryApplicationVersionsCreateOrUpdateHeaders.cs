...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class GalleryApplicationVersionsCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GalleryApplicationVersionsCreateOrUpdateHeaders class.
        /// </summary>
        public GalleryApplicationVersionsCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public GalleryApplicationVersionsCreateOrUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
