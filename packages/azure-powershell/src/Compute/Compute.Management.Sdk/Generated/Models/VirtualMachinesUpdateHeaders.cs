...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    /// </summary>
    public partial class VirtualMachinesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VirtualMachinesUpdateHeaders
        /// class.
        /// </summary>
        public VirtualMachinesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VirtualMachinesUpdateHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
