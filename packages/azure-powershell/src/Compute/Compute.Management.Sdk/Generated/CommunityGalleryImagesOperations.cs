...
namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class CommunityGalleryImagesOperations : IServiceOperations<ComputeManagementClient>, ICommunityGalleryImagesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<CommunityGalleryImage>>> ListWithHttpMessagesAsync(string location, string publicGalleryName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/communityGalleries/{publicGalleryName}/images").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<CommunityGalleryImage>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<CommunityGalleryImage>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<CommunityGalleryImage>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
