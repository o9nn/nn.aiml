...
Jednostavan u upotrebi, istovremeno moćan i prilagodljiv, GnuCash 
omogućava praćenje bankovnih računa, dionica, prihoda i rashoda. 
...
Često postavljena pitanja: https://wiki.gnucash.org/wiki/FAQ
Pretplatničke liste: https://wiki.gnucash.org/wiki/Mailing_Lists
IRC (Chat): Kanal #gnucash na poslužitelju irc.gnome.org, vidi također 
https://wiki.gnucash.org/wiki/IRC

Prijavi greške na našoj „Bugzilla”-stranici za praćenje grešaka:
...
Karakteristike: 
    ...
    * konta dionica, obveznica i uzajamnih fondova
    * QIF/OFX uvoz
    * OFX/HBCI internet bankarstvo
    * izvještaji, dijagrami
    * računovodstvo za mala poduzeća
    * kupci, dobavljači, poslovi, IRA/URA računi, konta dugovanja i potraživanja
    * terminirane transakcije
    * financijske kalkulacije

Pregledaj detaljne informacije i upute za rad s GnuCashom u izborniku 
„Pomoć → Vježbe i koncepti”.
...
dvanaestero osoba iz više od šest zemalja.
